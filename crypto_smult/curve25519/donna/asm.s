...
.extern crypto_smult_curve25519_donna_fmonty

.globl crypto_smult_curve25519_donna_fmul
.globl crypto_smult_curve25519_donna_fsquare
.globl crypto_smult_curve25519_donna_fexpand
.globl crypto_smult_curve25519_donna_fcontract
.globl crypto_smult_curve25519_donna_freduce_coefficients
.globl crypto_smult_curve25519_donna_fscalar
.globl crypto_smult_curve25519_donna_fdifference_backwards
.globl crypto_smult_curve25519_donna_cmult
...
################################################################################
crypto_smult_curve25519_donna_fmul:
...
crypto_smult_curve25519_donna_fsquare:
...
crypto_smult_curve25519_donna_fdifference_backwards:
...
################################################################################
crypto_smult_curve25519_donna_fscalar:
...
################################################################################
crypto_smult_curve25519_donna_freduce_coefficients:
...
################################################################################
crypto_smult_curve25519_donna_fexpand:
...
################################################################################
crypto_smult_curve25519_donna_fcontract:
...
################################################################################
crypto_smult_curve25519_donna_cmult:
...
add $80,%rdx
mov %r14,%r8
call crypto_smult_curve25519_donna_fmonty
