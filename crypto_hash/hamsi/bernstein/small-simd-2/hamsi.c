...
#define tl(m, i) (_mm_load_si128((__m128i*)(t16[i][15 & (m)[i]] + 0)) ^ _mm_load_si128((__m128i*)(t16x[i][(m)[i] >> 4] + 0)))
#define th(m, i) (_mm_load_si128((__m128i*)(t16[i][15 & (m)[i]] + 4)) ^ _mm_load_si128((__m128i*)(t16x[i][(m)[i] >> 4] + 4)))
