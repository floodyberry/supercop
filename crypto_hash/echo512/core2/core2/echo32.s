...
.L157:
	...
	movl	%esi, -324(%ebp)
.L152:
	movl	SHA3_S(,%edx,8), %ebx
	movl	SHA3_S+4(,%edx,8), %esi
	movl	%ebx, (%ecx,%edx,8)
...
.L158:
	...
	.size	T.41, .-T.41
	.p2align 4,,15
.globl crypto_hash_echo512_core2_core2
	.type	crypto_hash_echo512_core2_core2, @function
crypto_hash_echo512_core2_core2:
	pushl	%ebp
	movl	%esp, %ebp
	subl	$24, %esp
	movl	8(%ebp), %eax
	...
	notl	%eax
	ret
	.size	crypto_hash_echo512_core2_core2, .-crypto_hash_echo512_core2_core2
	.p2align 4,,15
.globl Hash
	.type	Hash, @function
Hash:
