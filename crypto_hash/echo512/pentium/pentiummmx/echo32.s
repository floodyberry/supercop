...
.L109:
	...
	.size	T.34, .-T.34
	.p2align 4,,15
.globl crypto_hash_echo512_pentium_pentiummmx
	.type	crypto_hash_echo512_pentium_pentiummmx, @function
crypto_hash_echo512_pentium_pentiummmx:
	pushl	%ebp
	movl	%esp, %ebp
	subl	$24, %esp
	movl	8(%ebp), %eax
	...
	notl	%eax
	ret
	.size	crypto_hash_echo512_pentium_pentiummmx, .-crypto_hash_echo512_pentium_pentiummmx
	.p2align 4,,15
.globl Hash
	.type	Hash, @function
Hash:
