...

{
    ...
    0[(uint64 *) out] = ctx.X[0];
    1[(uint64 *) out] = ctx.X[1];
    2[(uint64 *) out] = ctx.X[2];
    3[(uint64 *) out] = ctx.X[3];
    4[(uint64 *) out] = ctx.X[4];
    5[(uint64 *) out] = ctx.X[5];
    6[(uint64 *) out] = ctx.X[6];
    7[(uint64 *) out] = ctx.X[7];
