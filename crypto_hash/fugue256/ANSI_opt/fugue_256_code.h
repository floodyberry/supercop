...
#define write_back_to_state(p,type) \
  write_back_to_state_listed##type(p,0, 0,1,2,3); rotate_regs##type;\
   write_back_to_state_listed##type(p,1, 1,2,3,0); rotate_regs##type;\
    write_back_to_state_listed##type(p,2, 2,3,0,1); rotate_regs##type;\
