...
#define brot64(x,n)   (((crypto_uint64)(x) <<  ((64 - n) & 63)) | ((crypto_uint64)(x) >> n))
#define shift_right64(x,n) ((crypto_uint64)(x) >> n)
#define shift_left64(x,n) ((crypto_uint64)(x) << n)
...
#else
#ifdef ODD_PARITY
static const crypto_uint64 aes_style_table[4][256] = {{sbox(u01)}, {sbox(u12)}, {sbox(u23)}, {sbox(u30)} };
#else
static const crypto_uint64 aes_style_table[4][256] = {{sbox(u02)}, {sbox(u13)}, {sbox(u20)}, {sbox(u31)} };
#endif
#endif
