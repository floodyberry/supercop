...
/* #define roundAES(const u32 input[4], u32 output[4], const u32 key [4]) */
...
{\
   output0 = Table0[input0 >> 24] ^ Table1[(input1 >> 16) & 0xff] ^ \
	       Table2[(input2 >> 8) & 0xff] ^ Table3[input3 & 0xff]^key0;\
   output1 = Table0[input1 >> 24] ^ Table1[(input2 >> 16) & 0xff] ^ \
	       Table2[(input3 >> 8) & 0xff] ^ Table3[input0 & 0xff]^key1;\
   output2 = Table0[input2 >> 24] ^ Table1[(input3 >> 16) & 0xff] ^ \
	       Table2[(input0 >> 8) & 0xff] ^ Table3[input1 & 0xff]^key2;\
   output3 = Table0[input3 >> 24] ^ Table1[(input0 >> 16) & 0xff] ^ \
	       Table2[(input1 >> 8) & 0xff] ^ Table3[input2 & 0xff]^key3;\
}
...
/* #define roundAESkeyfirst(u32 input[4], u32 output[4], const u32 key [4]) */
#define roundAESkeyfirst(input0,input1,input2,input3,output0,output1,output2,output3,key0,key1,key2,key3)\
{\
   ...
   output0 = Table0[temp0 >> 24] ^ Table1[(temp1 >> 16) & 0xff] ^ \
	       Table2[(temp2 >> 8) & 0xff] ^ Table3[temp3 & 0xff];\
   output1 = Table0[temp1 >> 24] ^ Table1[(temp2 >> 16) & 0xff] ^ \
	       Table2[(temp3 >> 8) & 0xff] ^ Table3[temp0 & 0xff];\
   output2 = Table0[temp2 >> 24] ^ Table1[(temp3 >> 16) & 0xff] ^ \
	       Table2[(temp0 >> 8) & 0xff] ^ Table3[temp1 & 0xff];\
   output3 = Table0[temp3 >> 24] ^ Table1[(temp0 >> 16) & 0xff] ^ \
	       Table2[(temp1 >> 8) & 0xff] ^ Table3[temp2 & 0xff];\
}
