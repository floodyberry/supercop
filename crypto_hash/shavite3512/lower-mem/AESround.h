...
{\
   ...
   temp2=input2;\
   temp3=input3;\
   output0 = Table0[temp0 & 0xff ] ^ Table1[(temp1 >> 8) & 0xff] ^ \
             Table2[(temp2 >> 16) & 0xff] ^ Table3[temp3 >> 24] ^ key0;\
   output1 = Table0[temp1 & 0xff] ^ Table1[(temp2 >> 8) & 0xff] ^ \
             Table2[(temp3 >> 16) & 0xff] ^ Table3[temp0 >> 24] ^ key1;\
   output2 = Table0[temp2 & 0xff] ^ Table1[(temp3 >> 8) & 0xff] ^ \
             Table2[(temp0 >> 16) & 0xff] ^ Table3[temp1 >> 24] ^ key2;\
   output3 = Table0[temp3 & 0xff] ^ Table1[(temp0 >> 8) & 0xff] ^ \
             Table2[(temp1 >> 16) & 0xff] ^ Table3[temp2 >> 24] ^ key3;\
}
...
{\
   output0 = Table0[input0 & 0xff] ^ Table1[(input1 >> 8) & 0xff] ^ \
             Table2[(input2 >> 16) & 0xff] ^ Table3[input3 >> 24];\
   output1 = Table0[input1 & 0xff] ^ Table1[(input2 >> 8) & 0xff] ^ \
             Table2[(input3 >> 16) & 0xff] ^ Table3[input0 >> 24];\
   output2 = Table0[input2 & 0xff] ^ Table1[(input3 >> 8) & 0xff] ^ \
             Table2[(input0 >> 16) & 0xff] ^ Table3[input1 >> 24];\
   output3 = Table0[input3 & 0xff] ^ Table1[(input0 >> 8) & 0xff] ^ \
             Table2[(input1 >> 16) & 0xff] ^ Table3[input2 >> 24];\
}
