...
# qhasm: enter crypto_hash_cubehash512_amd64_32
.text
.p2align 5
.globl _crypto_hash_cubehash512_amd64_32
.globl crypto_hash_cubehash512_amd64_32
_crypto_hash_cubehash512_amd64_32:
crypto_hash_cubehash512_amd64_32:
mov %rsp,%r11
and $31,%r11
add $256,%r11
sub %r11,%rsp
...
# asm 1: mov  $0x9dc06f0a,>x08=int64#1
# asm 2: mov  $0x9dc06f0a,>x08=%rdi
mov  $0x9dc06f0a,%rdi

# qhasm:   x09 = 0x4d197eb5
# asm 1: mov  $0x4d197eb5,>x09=int64#3
# asm 2: mov  $0x4d197eb5,>x09=%rdx
mov  $0x4d197eb5,%rdx

# qhasm:   x0a = 0xb6e17224
# asm 1: mov  $0xb6e17224,>x0a=int64#4
# asm 2: mov  $0xb6e17224,>x0a=%rcx
mov  $0xb6e17224,%rcx

# qhasm:   x0b = 0x912e1aca
# asm 1: mov  $0x912e1aca,>x0b=int64#5
# asm 2: mov  $0x912e1aca,>x0b=%r8
mov  $0x912e1aca,%r8

# qhasm:   x0c = 0x5270f5e1
# asm 1: mov  $0x5270f5e1,>x0c=int64#6
# asm 2: mov  $0x5270f5e1,>x0c=%r9
mov  $0x5270f5e1,%r9

# qhasm:   x0d = 0xd9efd0ec
# asm 1: mov  $0xd9efd0ec,>x0d=int64#7
# asm 2: mov  $0xd9efd0ec,>x0d=%rax
mov  $0xd9efd0ec,%rax

# qhasm:   x0e = 0xf0fcf7c8
# asm 1: mov  $0xf0fcf7c8,>x0e=int64#8
# asm 2: mov  $0xf0fcf7c8,>x0e=%r10
mov  $0xf0fcf7c8,%r10

# qhasm:   x0f = 0x20d4074f
# asm 1: mov  $0x20d4074f,>x0f=int64#9
# asm 2: mov  $0x20d4074f,>x0f=%r11
mov  $0x20d4074f,%r11
...
# asm 1: mov  $0x15547fee,>x10=int64#1
# asm 2: mov  $0x15547fee,>x10=%rdi
mov  $0x15547fee,%rdi

# qhasm:   x11 = 0xf4839313
# asm 1: mov  $0xf4839313,>x11=int64#3
# asm 2: mov  $0xf4839313,>x11=%rdx
mov  $0xf4839313,%rdx

# qhasm:   x12 = 0x017c189c
# asm 1: mov  $0x017c189c,>x12=int64#4
# asm 2: mov  $0x017c189c,>x12=%rcx
mov  $0x017c189c,%rcx

# qhasm:   x13 = 0xaf1c332a
# asm 1: mov  $0xaf1c332a,>x13=int64#5
# asm 2: mov  $0xaf1c332a,>x13=%r8
mov  $0xaf1c332a,%r8

# qhasm:   x14 = 0xde4d7c8c
# asm 1: mov  $0xde4d7c8c,>x14=int64#10
# asm 2: mov  $0xde4d7c8c,>x14=%r12
mov  $0xde4d7c8c,%r12

# qhasm:   x15 = 0x84997eec
# asm 1: mov  $0x84997eec,>x15=int64#11
# asm 2: mov  $0x84997eec,>x15=%r13
mov  $0x84997eec,%r13

# qhasm:   x16 = 0x5bd87a43
# asm 1: mov  $0x5bd87a43,>x16=int64#12
# asm 2: mov  $0x5bd87a43,>x16=%r14
mov  $0x5bd87a43,%r14

# qhasm:   x17 = 0xb6d3d055
# asm 1: mov  $0xb6d3d055,>x17=int64#13
# asm 2: mov  $0xb6d3d055,>x17=%r15
mov  $0xb6d3d055,%r15
...
# asm 1: mov  $0x3ae247b0,>x18=int64#1
# asm 2: mov  $0x3ae247b0,>x18=%rdi
mov  $0x3ae247b0,%rdi

# qhasm:   x19 = 0x2b8cb0a6
# asm 1: mov  $0x2b8cb0a6,>x19=int64#3
# asm 2: mov  $0x2b8cb0a6,>x19=%rdx
mov  $0x2b8cb0a6,%rdx

# qhasm:   x1a = 0xd9d6ca35
# asm 1: mov  $0xd9d6ca35,>x1a=int64#4
# asm 2: mov  $0xd9d6ca35,>x1a=%rcx
mov  $0xd9d6ca35,%rcx

# qhasm:   x1b = 0x4bf12b94
# asm 1: mov  $0x4bf12b94,>x1b=int64#5
# asm 2: mov  $0x4bf12b94,>x1b=%r8
mov  $0x4bf12b94,%r8

# qhasm:   x1c = 0x97f33a51
# asm 1: mov  $0x97f33a51,>x1c=int64#10
# asm 2: mov  $0x97f33a51,>x1c=%r12
mov  $0x97f33a51,%r12

# qhasm:   x1d = 0x62fb84ad
# asm 1: mov  $0x62fb84ad,>x1d=int64#11
# asm 2: mov  $0x62fb84ad,>x1d=%r13
mov  $0x62fb84ad,%r13

# qhasm:   x1e = 0x7e70e613
# asm 1: mov  $0x7e70e613,>x1e=int64#12
# asm 2: mov  $0x7e70e613,>x1e=%r14
mov  $0x7e70e613,%r14

# qhasm:   x1f = 0x520c709b
# asm 1: mov  $0x520c709b,>x1f=int64#13
# asm 2: mov  $0x520c709b,>x1f=%r15
mov  $0x520c709b,%r15
...
# asm 1: mov  $0x781f814f,>x00=int64#3
# asm 2: mov  $0x781f814f,>x00=%rdx
mov  $0x781f814f,%rdx

# qhasm:   x01 = 0x18f45926
# asm 1: mov  $0x18f45926,>x01=int64#5
# asm 2: mov  $0x18f45926,>x01=%r8
mov  $0x18f45926,%r8

# qhasm:   x02 = 0x992b7520
# asm 1: mov  $0x992b7520,>x02=int64#10
# asm 2: mov  $0x992b7520,>x02=%r12
mov  $0x992b7520,%r12

# qhasm:   x03 = 0xc8237df7
# asm 1: mov  $0xc8237df7,>x03=int64#11
# asm 2: mov  $0xc8237df7,>x03=%r13
mov  $0xc8237df7,%r13

# qhasm:   x04 = 0xe4e3ba88
# asm 1: mov  $0xe4e3ba88,>x04=int64#12
# asm 2: mov  $0xe4e3ba88,>x04=%r14
mov  $0xe4e3ba88,%r14

# qhasm:   x05 = 0x7b0075ff
# asm 1: mov  $0x7b0075ff,>x05=int64#13
# asm 2: mov  $0x7b0075ff,>x05=%r15
mov  $0x7b0075ff,%r15

# qhasm:   x06 = 0x51916982
# asm 1: mov  $0x51916982,>x06=int64#14
# asm 2: mov  $0x51916982,>x06=%rbx
mov  $0x51916982,%rbx

# qhasm:   x07 = 0x947c6147
# asm 1: mov  $0x947c6147,>x07=int64#1
# asm 2: mov  $0x947c6147,>x07=%rdi
mov  $0x947c6147,%rdi
