...
# qhasm: enter crypto_hash_cubehash512_x86
.text
.p2align 5
.globl _crypto_hash_cubehash512_x86
.globl crypto_hash_cubehash512_x86
_crypto_hash_cubehash512_x86:
crypto_hash_cubehash512_x86:
mov %esp,%eax
and $31,%eax
add $192,%eax
sub %eax,%esp
...
# asm 1: mov  $0x9dc06f0a,>x08=int32#1
# asm 2: mov  $0x9dc06f0a,>x08=%eax
mov  $0x9dc06f0a,%eax

# qhasm:   x09 = 0x4d197eb5
# asm 1: mov  $0x4d197eb5,>x09=int32#2
# asm 2: mov  $0x4d197eb5,>x09=%ecx
mov  $0x4d197eb5,%ecx

# qhasm:   x0a = 0xb6e17224
# asm 1: mov  $0xb6e17224,>x0a=int32#3
# asm 2: mov  $0xb6e17224,>x0a=%edx
mov  $0xb6e17224,%edx

# qhasm:   x0b = 0x912e1aca
# asm 1: mov  $0x912e1aca,>x0b=int32#4
# asm 2: mov  $0x912e1aca,>x0b=%ebx
mov  $0x912e1aca,%ebx
...
# asm 1: mov  $0x5270f5e1,>x0c=int32#1
# asm 2: mov  $0x5270f5e1,>x0c=%eax
mov  $0x5270f5e1,%eax

# qhasm:   x0d = 0xd9efd0ec
# asm 1: mov  $0xd9efd0ec,>x0d=int32#2
# asm 2: mov  $0xd9efd0ec,>x0d=%ecx
mov  $0xd9efd0ec,%ecx

# qhasm:   x0e = 0xf0fcf7c8
# asm 1: mov  $0xf0fcf7c8,>x0e=int32#3
# asm 2: mov  $0xf0fcf7c8,>x0e=%edx
mov  $0xf0fcf7c8,%edx

# qhasm:   x0f = 0x20d4074f
# asm 1: mov  $0x20d4074f,>x0f=int32#4
# asm 2: mov  $0x20d4074f,>x0f=%ebx
mov  $0x20d4074f,%ebx
...
# asm 1: mov  $0x15547fee,>x10=int32#1
# asm 2: mov  $0x15547fee,>x10=%eax
mov  $0x15547fee,%eax

# qhasm:   x11 = 0xf4839313
# asm 1: mov  $0xf4839313,>x11=int32#2
# asm 2: mov  $0xf4839313,>x11=%ecx
mov  $0xf4839313,%ecx

# qhasm:   x12 = 0x017c189c
# asm 1: mov  $0x017c189c,>x12=int32#3
# asm 2: mov  $0x017c189c,>x12=%edx
mov  $0x017c189c,%edx

# qhasm:   x13 = 0xaf1c332a
# asm 1: mov  $0xaf1c332a,>x13=int32#4
# asm 2: mov  $0xaf1c332a,>x13=%ebx
mov  $0xaf1c332a,%ebx
...
# asm 1: mov  $0xde4d7c8c,>x14=int32#1
# asm 2: mov  $0xde4d7c8c,>x14=%eax
mov  $0xde4d7c8c,%eax

# qhasm:   x15 = 0x84997eec
# asm 1: mov  $0x84997eec,>x15=int32#2
# asm 2: mov  $0x84997eec,>x15=%ecx
mov  $0x84997eec,%ecx

# qhasm:   x16 = 0x5bd87a43
# asm 1: mov  $0x5bd87a43,>x16=int32#3
# asm 2: mov  $0x5bd87a43,>x16=%edx
mov  $0x5bd87a43,%edx

# qhasm:   x17 = 0xb6d3d055
# asm 1: mov  $0xb6d3d055,>x17=int32#4
# asm 2: mov  $0xb6d3d055,>x17=%ebx
mov  $0xb6d3d055,%ebx
...
# asm 1: mov  $0x3ae247b0,>x18=int32#1
# asm 2: mov  $0x3ae247b0,>x18=%eax
mov  $0x3ae247b0,%eax

# qhasm:   x19 = 0x2b8cb0a6
# asm 1: mov  $0x2b8cb0a6,>x19=int32#2
# asm 2: mov  $0x2b8cb0a6,>x19=%ecx
mov  $0x2b8cb0a6,%ecx

# qhasm:   x1a = 0xd9d6ca35
# asm 1: mov  $0xd9d6ca35,>x1a=int32#3
# asm 2: mov  $0xd9d6ca35,>x1a=%edx
mov  $0xd9d6ca35,%edx

# qhasm:   x1b = 0x4bf12b94
# asm 1: mov  $0x4bf12b94,>x1b=int32#4
# asm 2: mov  $0x4bf12b94,>x1b=%ebx
mov  $0x4bf12b94,%ebx
...
# asm 1: mov  $0x97f33a51,>x1c=int32#1
# asm 2: mov  $0x97f33a51,>x1c=%eax
mov  $0x97f33a51,%eax

# qhasm:   x1d = 0x62fb84ad
# asm 1: mov  $0x62fb84ad,>x1d=int32#2
# asm 2: mov  $0x62fb84ad,>x1d=%ecx
mov  $0x62fb84ad,%ecx

# qhasm:   x1e = 0x7e70e613
# asm 1: mov  $0x7e70e613,>x1e=int32#3
# asm 2: mov  $0x7e70e613,>x1e=%edx
mov  $0x7e70e613,%edx

# qhasm:   x1f = 0x520c709b
# asm 1: mov  $0x520c709b,>x1f=int32#4
# asm 2: mov  $0x520c709b,>x1f=%ebx
mov  $0x520c709b,%ebx
...
# asm 1: mov  $0x781f814f,>x00=int32#3
# asm 2: mov  $0x781f814f,>x00=%edx
mov  $0x781f814f,%edx

# qhasm:   x01 = 0x18f45926
# asm 1: mov  $0x18f45926,>x01=int32#4
# asm 2: mov  $0x18f45926,>x01=%ebx
mov  $0x18f45926,%ebx

# qhasm:   x02 = 0x992b7520
# asm 1: mov  $0x992b7520,>x02=int32#1
# asm 2: mov  $0x992b7520,>x02=%eax
mov  $0x992b7520,%eax

# qhasm:   x03 = 0xc8237df7
# asm 1: mov  $0xc8237df7,>x03=int32#2
# asm 2: mov  $0xc8237df7,>x03=%ecx
mov  $0xc8237df7,%ecx
...
# asm 1: mov  $0xe4e3ba88,>x04=int32#1
# asm 2: mov  $0xe4e3ba88,>x04=%eax
mov  $0xe4e3ba88,%eax

# qhasm:   x05 = 0x7b0075ff
# asm 1: mov  $0x7b0075ff,>x05=int32#2
# asm 2: mov  $0x7b0075ff,>x05=%ecx
mov  $0x7b0075ff,%ecx

# qhasm:   x06 = 0x51916982
# asm 1: mov  $0x51916982,>x06=int32#6
# asm 2: mov  $0x51916982,>x06=%edi
mov  $0x51916982,%edi

# qhasm:   x07 = 0x947c6147
# asm 1: mov  $0x947c6147,>x07=int32#7
# asm 2: mov  $0x947c6147,>x07=%ebp
mov  $0x947c6147,%ebp
