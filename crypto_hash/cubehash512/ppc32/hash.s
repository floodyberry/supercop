...
# qhasm: enter crypto_hash_cubehash512_ppc32
.text
.align 3
.globl .crypto_hash_cubehash512_ppc32
.globl _crypto_hash_cubehash512_ppc32
.globl crypto_hash_cubehash512_ppc32
.crypto_hash_cubehash512_ppc32:
_crypto_hash_cubehash512_ppc32:
crypto_hash_cubehash512_ppc32:
stwu 1,-320(1)
...
# asm 1: lis >x08=int32#1,0x9dc0
# asm 2: lis >x08=3,0x9dc0
lis 3,0x9dc0

# qhasm:   x09 = 65536 * 0x4d19
# asm 1: lis >x09=int32#5,0x4d19
# asm 2: lis >x09=7,0x4d19
lis 7,0x4d19

# qhasm:   x0a = 65536 * 0xb6e1
# asm 1: lis >x0a=int32#6,0xb6e1
# asm 2: lis >x0a=8,0xb6e1
lis 8,0xb6e1

# qhasm:   x0b = 65536 * 0x912e
# asm 1: lis >x0b=int32#7,0x912e
# asm 2: lis >x0b=9,0x912e
lis 9,0x912e

# qhasm:   x0c = 65536 * 0x5270
# asm 1: lis >x0c=int32#8,0x5270
# asm 2: lis >x0c=10,0x5270
lis 10,0x5270

# qhasm:   x0d = 65536 * 0xd9ef
# asm 1: lis >x0d=int32#9,0xd9ef
# asm 2: lis >x0d=11,0xd9ef
lis 11,0xd9ef

# qhasm:   x0e = 65536 * 0xf0fc
# asm 1: lis >x0e=int32#10,0xf0fc
# asm 2: lis >x0e=12,0xf0fc
lis 12,0xf0fc

# qhasm:   x0f = 65536 * 0x20d4
# asm 1: lis >x0f=int32#11,0x20d4
# asm 2: lis >x0f=13,0x20d4
lis 13,0x20d4
...
# asm 2: ori >x0e=12,<x0e=12,0xf7c8
ori 12,12,0xf7c8

# qhasm:   x0f |= 0x074f
# asm 1: ori >x0f=int32#11,<x0f=int32#11,0x074f
# asm 2: ori >x0f=13,<x0f=13,0x074f
ori 13,13,0x074f
...
# asm 1: lis >x10=int32#7,0x1554
# asm 2: lis >x10=9,0x1554
lis 9,0x1554

# qhasm:   x11 = 65536 * 0xf483
# asm 1: lis >x11=int32#12,0xf483
# asm 2: lis >x11=14,0xf483
lis 14,0xf483

# qhasm:   x12 = 65536 * 0x017c
# asm 1: lis >x12=int32#13,0x017c
# asm 2: lis >x12=15,0x017c
lis 15,0x017c

# qhasm:   x13 = 65536 * 0xaf1c
# asm 1: lis >x13=int32#14,0xaf1c
# asm 2: lis >x13=16,0xaf1c
lis 16,0xaf1c

# qhasm:   x14 = 65536 * 0xde4d
# asm 1: lis >x14=int32#15,0xde4d
# asm 2: lis >x14=17,0xde4d
lis 17,0xde4d

# qhasm:   x15 = 65536 * 0x8499
# asm 1: lis >x15=int32#16,0x8499
# asm 2: lis >x15=18,0x8499
lis 18,0x8499

# qhasm:   x16 = 65536 * 0x5bd8
# asm 1: lis >x16=int32#17,0x5bd8
# asm 2: lis >x16=19,0x5bd8
lis 19,0x5bd8

# qhasm:   x17 = 65536 * 0xb6d3
# asm 1: lis >x17=int32#18,0xb6d3
# asm 2: lis >x17=20,0xb6d3
lis 20,0xb6d3
...
# qhasm:   x11 |= 0x9313
# asm 1: ori >x11=int32#12,<x11=int32#12,0x9313
# asm 2: ori >x11=14,<x11=14,0x9313
ori 14,14,0x9313

# qhasm:   x12 |= 0x189c
# asm 1: ori >x12=int32#13,<x12=int32#13,0x189c
# asm 2: ori >x12=15,<x12=15,0x189c
ori 15,15,0x189c

# qhasm:   x13 |= 0x332a
# asm 1: ori >x13=int32#14,<x13=int32#14,0x332a
# asm 2: ori >x13=16,<x13=16,0x332a
ori 16,16,0x332a

# qhasm:   x14 |= 0x7c8c
# asm 1: ori >x14=int32#15,<x14=int32#15,0x7c8c
# asm 2: ori >x14=17,<x14=17,0x7c8c
ori 17,17,0x7c8c

# qhasm:   x15 |= 0x7eec
# asm 1: ori >x15=int32#16,<x15=int32#16,0x7eec
# asm 2: ori >x15=18,<x15=18,0x7eec
ori 18,18,0x7eec

# qhasm:   x16 |= 0x7a43
# asm 1: ori >x16=int32#17,<x16=int32#17,0x7a43
# asm 2: ori >x16=19,<x16=19,0x7a43
ori 19,19,0x7a43

# qhasm:   x17 |= 0xd055
# asm 1: ori >x17=int32#18,<x17=int32#18,0xd055
# asm 2: ori >x17=20,<x17=20,0xd055
ori 20,20,0xd055
...
# asm 1: lis >x18=int32#15,0x3ae2
# asm 2: lis >x18=17,0x3ae2
lis 17,0x3ae2

# qhasm:   x19 = 65536 * 0x2b8c
# asm 1: lis >x19=int32#16,0x2b8c
# asm 2: lis >x19=18,0x2b8c
lis 18,0x2b8c

# qhasm:   x1a = 65536 * 0xd9d6
# asm 1: lis >x1a=int32#17,0xd9d6
# asm 2: lis >x1a=19,0xd9d6
lis 19,0xd9d6

# qhasm:   x1b = 65536 * 0x4bf1
# asm 1: lis >x1b=int32#18,0x4bf1
# asm 2: lis >x1b=20,0x4bf1
lis 20,0x4bf1

# qhasm:   x1c = 65536 * 0x97f3
# asm 1: lis >x1c=int32#19,0x97f3
# asm 2: lis >x1c=21,0x97f3
lis 21,0x97f3

# qhasm:   x1d = 65536 * 0x62fb
# asm 1: lis >x1d=int32#20,0x62fb
# asm 2: lis >x1d=22,0x62fb
lis 22,0x62fb

# qhasm:   x1e = 65536 * 0x7e70
# asm 1: lis >x1e=int32#21,0x7e70
# asm 2: lis >x1e=23,0x7e70
lis 23,0x7e70

# qhasm:   x1f = 65536 * 0x520c
# asm 1: lis >x1f=int32#22,0x520c
# asm 2: lis >x1f=24,0x520c
lis 24,0x520c

# qhasm:   x18 |= 0x47b0
# asm 1: ori >x18=int32#15,<x18=int32#15,0x47b0
# asm 2: ori >x18=17,<x18=17,0x47b0
ori 17,17,0x47b0

# qhasm:   x19 |= 0xb0a6
# asm 1: ori >x19=int32#16,<x19=int32#16,0xb0a6
# asm 2: ori >x19=18,<x19=18,0xb0a6
ori 18,18,0xb0a6

# qhasm:   x1a |= 0xca35
# asm 1: ori >x1a=int32#17,<x1a=int32#17,0xca35
# asm 2: ori >x1a=19,<x1a=19,0xca35
ori 19,19,0xca35

# qhasm:   x1b |= 0x2b94
# asm 1: ori >x1b=int32#18,<x1b=int32#18,0x2b94
# asm 2: ori >x1b=20,<x1b=20,0x2b94
ori 20,20,0x2b94

# qhasm:   x1c |= 0x3a51
# asm 1: ori >x1c=int32#19,<x1c=int32#19,0x3a51
# asm 2: ori >x1c=21,<x1c=21,0x3a51
ori 21,21,0x3a51

# qhasm:   x1d |= 0x84ad
# asm 1: ori >x1d=int32#20,<x1d=int32#20,0x84ad
# asm 2: ori >x1d=22,<x1d=22,0x84ad
ori 22,22,0x84ad

# qhasm:   x1e |= 0xe613
# asm 1: ori >x1e=int32#21,<x1e=int32#21,0xe613
# asm 2: ori >x1e=23,<x1e=23,0xe613
ori 23,23,0xe613

# qhasm:   x1f |= 0x709b
# asm 1: ori >x1f=int32#22,<x1f=int32#22,0x709b
# asm 2: ori >x1f=24,<x1f=24,0x709b
ori 24,24,0x709b
...
# asm 1: lis >x00=int32#19,0x781f
# asm 2: lis >x00=21,0x781f
lis 21,0x781f

# qhasm:   x01 = 65536 * 0x18f4
# asm 1: lis >x01=int32#20,0x18f4
# asm 2: lis >x01=22,0x18f4
lis 22,0x18f4

# qhasm:   x02 = 65536 * 0x992b
# asm 1: lis >x02=int32#21,0x992b
# asm 2: lis >x02=23,0x992b
lis 23,0x992b

# qhasm:   x03 = 65536 * 0xc823
# asm 1: lis >x03=int32#22,0xc823
# asm 2: lis >x03=24,0xc823
lis 24,0xc823

# qhasm:   x04 = 65536 * 0xe4e3
# asm 1: lis >x04=int32#23,0xe4e3
# asm 2: lis >x04=25,0xe4e3
lis 25,0xe4e3

# qhasm:   x05 = 65536 * 0x7b00
# asm 1: lis >x05=int32#24,0x7b00
# asm 2: lis >x05=26,0x7b00
lis 26,0x7b00

# qhasm:   x06 = 65536 * 0x5191
# asm 1: lis >x06=int32#25,0x5191
# asm 2: lis >x06=27,0x5191
lis 27,0x5191

# qhasm:   x07 = 65536 * 0x947c
# asm 1: lis >x07=int32#26,0x947c
# asm 2: lis >x07=28,0x947c
lis 28,0x947c

# qhasm:   x00 |= 0x814f
# asm 1: ori >x00=int32#19,<x00=int32#19,0x814f
# asm 2: ori >x00=21,<x00=21,0x814f
ori 21,21,0x814f

# qhasm:   x01 |= 0x5926
# asm 1: ori >x01=int32#20,<x01=int32#20,0x5926
# asm 2: ori >x01=22,<x01=22,0x5926
ori 22,22,0x5926

# qhasm:   x02 |= 0x7520
# asm 1: ori >x02=int32#21,<x02=int32#21,0x7520
# asm 2: ori >x02=23,<x02=23,0x7520
ori 23,23,0x7520

# qhasm:   x03 |= 0x7df7
# asm 1: ori >x03=int32#22,<x03=int32#22,0x7df7
# asm 2: ori >x03=24,<x03=24,0x7df7
ori 24,24,0x7df7

# qhasm:   x04 |= 0xba88
# asm 1: ori >x04=int32#23,<x04=int32#23,0xba88
# asm 2: ori >x04=25,<x04=25,0xba88
ori 25,25,0xba88

# qhasm:   x05 |= 0x75ff
# asm 1: ori >x05=int32#24,<x05=int32#24,0x75ff
# asm 2: ori >x05=26,<x05=26,0x75ff
ori 26,26,0x75ff

# qhasm:   x06 |= 0x6982
# asm 1: ori >x06=int32#25,<x06=int32#25,0x6982
# asm 2: ori >x06=27,<x06=27,0x6982
ori 27,27,0x6982

# qhasm:   x07 |= 0x6147
# asm 1: ori >x07=int32#26,<x07=int32#26,0x6147
# asm 2: ori >x07=28,<x07=28,0x6147
ori 28,28,0x6147
