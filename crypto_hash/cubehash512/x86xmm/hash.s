...
# qhasm: enter crypto_hash_cubehash512_x86xmm
.text
.p2align 5
.globl _crypto_hash_cubehash512_x86xmm
.globl crypto_hash_cubehash512_x86xmm
_crypto_hash_cubehash512_x86xmm:
crypto_hash_cubehash512_x86xmm:
mov %esp,%eax
and $31,%eax
add $128,%eax
sub %eax,%esp
...
# qhasm:   constants = &crypto_hash_cubehash512_x86xmm_constants
# asm 1: lea  crypto_hash_cubehash512_x86xmm_constants,>constants=int32#3
# asm 2: lea  crypto_hash_cubehash512_x86xmm_constants,>constants=%edx
lea  crypto_hash_cubehash512_x86xmm_constants,%edx
