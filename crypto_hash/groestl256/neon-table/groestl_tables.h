...
__attribute__((aligned(64))) unsigned long long RC_Q[20*4] = {
...
__attribute__((aligned(64))) unsigned long long RC_P[20*4] = {
  0x0000000000000000ULL,
...
static const unsigned long long* tables[] = {T0, T1, T2, T3, T4, T5, T6, T7, RC_P, RC_Q};
