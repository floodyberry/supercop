...
tmp5 = _mm_blend_epi16(tmp3, tmp4, 0xCC);
...
tmp1 = _mm_blend_epi16(m2, m1, 0x30);
...
tmp5 = _mm_blend_epi16(m0, m2, 0x33);
...
tmp0 = _mm_unpacklo_epi32(m1,m2); // m9 m8 m5 m4
tmp1 = _mm_unpackhi_epi32(m0,m2); // m11 m10 m3 m2
...
buf1 = _mm_blend_epi16(tmp0,tmp1,0x0C);
...
buf1 = _mm_shuffle_epi32(tmp1,_MM_SHUFFLE(1,3,0,2));
