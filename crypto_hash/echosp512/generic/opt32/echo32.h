...
#ifdef ECHO_SP 
#define BLOCK256 1792
#define BLOCK512 1536
#endif
#ifdef ECHO_DP
#define BLOCK256 1536
#define BLOCK512 1024
#endif
...
/*		Initialisation of the hash function						*/
HashReturn Init(hashState *state, unsigned int hashbitlen);

/*		Update of the compression function						*/
HashReturn Compress(hashState *state);
HashReturn Update(hashState *state, const BitSequence *data, DataLength databitlen);

/*		Processing of the final block							*/
HashReturn Final(hashState *state, BitSequence *hashval);

/*		The global hash functions								*/
