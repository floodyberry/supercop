...
.L130:
	...
	.size	T.57, .-T.57
	.p2align 4,,15
.globl crypto_hash_echosp512_aes_aes32
	.type	crypto_hash_echosp512_aes_aes32, @function
crypto_hash_echosp512_aes_aes32:
	pushl	%ebp
	movl	%esp, %ebp
	subl	$24, %esp
	movl	8(%ebp), %eax
	...
	notl	%eax
	ret
	.size	crypto_hash_echosp512_aes_aes32, .-crypto_hash_echosp512_aes_aes32
	.p2align 4,,15
.globl Hash
	.type	Hash, @function
Hash:
