...
# Optimized for Intel Core2, 64-bit mode                                              #
#                                                                                     #
# Date:     2010-07-23                                                                #
#                                                                                     #
...
# 0 "" 2
# 652 "echo64.c" 1
	movaps  xmm2, [rdi+10*16]
# 0 "" 2
# 652 "echo64.c" 1
	movaps  xmm3, [rdi+15*16]
# 0 "" 2
# 652 "echo64.c" 1
	pxor     xmm0, xmm1
# 0 "" 2
...
# 0 "" 2
# 652 "echo64.c" 1
	movaps  xmm5, [rdi+9*16]
# 0 "" 2
# 652 "echo64.c" 1
	movaps  xmm6, [rdi+14*16]
# 0 "" 2
# 652 "echo64.c" 1
...
# 0 "" 2
# 652 "echo64.c" 1
	movaps   xmm13, [rdi+1*16]
# 0 "" 2
# 652 "echo64.c" 1
	movaps   xmm14, [rdi+6*16]
# 0 "" 2
# 652 "echo64.c" 1
	pxor     xmm10, [rdi+2*16]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-64], rax
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-56], rbx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rcx, [r10+r9-48]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-48], rcx
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-40], rdx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rax, [r10+r9-32]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-32], rax
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-24], rbx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rcx, [r10+r9-16]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-16], rcx
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*4)+r9-8],  rdx
# 0 "" 2
# 745 "echo64.c" 1
	sub   r9, 8*8
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   dl, byte ptr [r10+r9-1]
# 0 "" 2
# 745 "echo64.c" 1
	mov   byte ptr [rbp+(16*4)+r9-1], dl
# 0 "" 2
# 745 "echo64.c" 1
	sub   r9, 1
# 0 "" 2
...
# 0 "" 2
# 810 "echo64.c" 1
	mov  dword ptr [rdi+16*2*8+8], r11d
# 0 "" 2
# 812 "echo64.c" 1
	cmp  r14, 0
# 0 "" 2
...
# 0 "" 2
# 815 "echo64.c" 1
	mov  cl, byte ptr [Tm+r14-1]
# 0 "" 2
# 816 "echo64.c" 1
	add  dword ptr [rdi+16*2*8+8], r14d
# 0 "" 2
# 817 "echo64.c" 1
	and  cl, byte ptr [r10]
# 0 "" 2
# 818 "echo64.c" 1
	mov  byte ptr [rdi+(16*4)+r12], cl
# 0 "" 2
# 820 "echo64.c" 1
	U_RETURN:
# 0 "" 2
...
.LFE545:
	.size	T.38, .-T.38
	.p2align 4,,15
.globl crypto_hash_echosp512_core2_core2v64
	.type	crypto_hash_echosp512_core2_core2v64, @function
crypto_hash_echosp512_core2_core2v64:
.LFB544:
	.cfi_startproc
	movq	%rdi, %rax
	movq	%rsi, %rdi
	...
	.cfi_endproc
.LFE544:
	.size	crypto_hash_echosp512_core2_core2v64, .-crypto_hash_echosp512_core2_core2v64
	.p2align 4,,15
.globl Hash
	.type	Hash, @function
Hash:
