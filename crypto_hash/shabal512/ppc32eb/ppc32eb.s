# Implementation of Shabal-512: PowerPC, big-endian, 32-bit.
#
...
# crypto_hash_shabal512_ppc32eb(out, in, len)
#    out   output buffer
#    in    input data
#    len   input data length (in bytes, 64-bit value)
	.align  2
	.globl  crypto_hash_shabal512_ppc32eb
	.type   crypto_hash_shabal512_ppc32eb, @function
crypto_hash_shabal512_ppc32eb:
	stwu    1, -288(1)
	mflr    0
	stw     28, 8(1)
	stw     29, 12(1)
...
.L0h4:
	...
	mtlr    0
	blr
	.size   crypto_hash_shabal512_ppc32eb, .-crypto_hash_shabal512_ppc32eb
