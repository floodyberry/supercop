# Implementation of Shabal-512: amd64
#
...
# crypto_hash_shabal512_amd64(out, in, len)
#    out   output buffer
#    in    input data
#    len   input data length (in bytes, 64-bit value)
	.globl  crypto_hash_shabal512_amd64
	.type   crypto_hash_shabal512_amd64, @function
crypto_hash_shabal512_amd64:
	pushq   %rbp
	pushq   %rbx
...
Lz3:
	...
	popq    %rbp
	ret
	.size   crypto_hash_shabal512_amd64, .-crypto_hash_shabal512_amd64
