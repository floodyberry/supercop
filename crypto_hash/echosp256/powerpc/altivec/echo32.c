...
#define LOADmessage(s, data) do {\
	if(state->hashbitlen <= 256){\
	  	register vector unsigned char s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15, s16, s17;\
  		s4  = vec_ld(zero, ((unsigned char*)(data))+0*16);\
  		s5  = vec_ld(zero, ((unsigned char*)(data))+1*16);\
  		s6  = vec_ld(zero, ((unsigned char*)(data))+2*16);\
  		s7  = vec_ld(zero, ((unsigned char*)(data))+3*16);\
  		...
  		s14 = vec_ld(zero, ((unsigned char*)(data))+10*16);\
        	s15 = vec_ld(zero, ((unsigned char*)(data))+11*16);\
  		s16 = vec_ld(zero, ((unsigned char*)(data))+12*16);\
        	s17 = vec_ld(zero, ((unsigned char*)(data))+13*16);\
 		\
  		vec_st(s4, zero, ((unsigned char*)(s->state))+2*16);\
  		vec_st(s5, zero, ((unsigned char*)(s->state))+3*16);\
  		vec_st(s6, zero, ((unsigned char*)(s->state))+4*16);\
  		vec_st(s7, zero, ((unsigned char*)(s->state))+5*16);\
  		vec_st(s8, zero, ((unsigned char*)(s->state))+6*16);\
  		vec_st(s9, zero, ((unsigned char*)(s->state))+7*16);\
  		vec_st(s10, zero, ((unsigned char*)(s->state))+8*16);\
  		vec_st(s11, zero, ((unsigned char*)(s->state))+9*16);\
  		vec_st(s12, zero, ((unsigned char*)(s->state))+10*16);\
  		vec_st(s13, zero, ((unsigned char*)(s->state))+11*16);\
  		vec_st(s14, zero, ((unsigned char*)(s->state))+12*16);\
  		vec_st(s15, zero, ((unsigned char*)(s->state))+13*16);\
  		vec_st(s16, zero, ((unsigned char*)(s->state))+14*16);\
  		vec_st(s17, zero, ((unsigned char*)(s->state))+15*16);\
	}\
	else{\
	  	register vector unsigned char s4, s5, s6, s7, s8, s9, s10, s11, s12, s13, s14, s15;\
  		s4  = vec_ld(zero, ((unsigned char*)(data))+0*16);\
...
int crypto_hash_echosp256_powerpc_altivec(unsigned char *out,const unsigned char *in,unsigned long long inlen)
{
