...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-64], rax
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-56], rbx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rcx, [r10+r9-48]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-48], rcx
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-40], rdx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rax, [r10+r9-32]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-32], rax
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-24], rbx
# 0 "" 2
# 745 "echo64.c" 1
	mov   rcx, [r10+r9-16]
# 0 "" 2
...
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-16], rcx
# 0 "" 2
# 745 "echo64.c" 1
	mov   [rbp+(16*2)+r9-8],  rdx
# 0 "" 2
# 745 "echo64.c" 1
	sub   r9, 8*8
# 0 "" 2
...
.LFE545:
	.size	T.38, .-T.38
	.p2align 4,,15
.globl crypto_hash_echosp256_core2_core2v64
	.type	crypto_hash_echosp256_core2_core2v64, @function
crypto_hash_echosp256_core2_core2v64:
.LFB544:
	.cfi_startproc
	movq	%rdi, %rax
	movq	%rsi, %rdi
	...
	.cfi_endproc
.LFE544:
	.size	crypto_hash_echosp256_core2_core2v64, .-crypto_hash_echosp256_core2_core2v64
	.p2align 4,,15
.globl Hash
	.type	Hash, @function
Hash:
