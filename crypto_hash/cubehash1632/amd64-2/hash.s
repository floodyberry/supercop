...
# qhasm: enter crypto_hash_cubehash1632_amd64_2
.text
.p2align 5
.globl _crypto_hash_cubehash1632_amd64_2
.globl crypto_hash_cubehash1632_amd64_2
_crypto_hash_cubehash1632_amd64_2:
crypto_hash_cubehash1632_amd64_2:
mov %rsp,%r11
and $31,%r11
add $32,%r11
sub %r11,%rsp
...
# qhasm:   constants = &crypto_hash_cubehash1632_amd64_2_constants
# asm 1: movq  crypto_hash_cubehash1632_amd64_2_constants@GOTPCREL(%rip),>constants=int64#3
# asm 2: movq  crypto_hash_cubehash1632_amd64_2_constants@GOTPCREL(%rip),>constants=%rdx
movq  crypto_hash_cubehash1632_amd64_2_constants@GOTPCREL(%rip),%rdx
...
# qhasm:   y0 = x2
# asm 1: movdqa <x2=int6464#7,>y0=int6464#9
# asm 2: movdqa <x2=%xmm6,>y0=%xmm8
movdqa %xmm6,%xmm8
...
# qhasm:   y2 = x0
# asm 1: movdqa <x0=int6464#5,>y2=int6464#10
# asm 2: movdqa <x0=%xmm4,>y2=%xmm9
movdqa %xmm4,%xmm9

# qhasm:   uint32323232 y2 <<= 7
# asm 1: pslld $7,<y2=int6464#10
# asm 2: pslld $7,<y2=%xmm9
pslld $7,%xmm9
...
# qhasm:   x3 = y2
# asm 1: movdqa <y2=int6464#10,>x3=int6464#8
# asm 2: movdqa <y2=%xmm9,>x3=%xmm7
movdqa %xmm9,%xmm7
...
# qhasm:   x0 = y1
# asm 1: movdqa <y1=int6464#5,>x0=int6464#7
# asm 2: movdqa <y1=%xmm4,>x0=%xmm6
movdqa %xmm4,%xmm6

# qhasm:   x1 = y0
# asm 1: movdqa <y0=int6464#9,>x1=int6464#10
# asm 2: movdqa <y0=%xmm8,>x1=%xmm9
movdqa %xmm8,%xmm9

# qhasm:   uint32323232 x0 <<= 11
# asm 1: pslld $11,<x0=int6464#7
# asm 2: pslld $11,<x0=%xmm6
pslld $11,%xmm6

# qhasm:   uint32323232 x1 <<= 11
# asm 1: pslld $11,<x1=int6464#10
# asm 2: pslld $11,<x1=%xmm9
pslld $11,%xmm9
...
# qhasm:   y0 = x2
# asm 1: movdqa <x2=int6464#6,>y0=int6464#9
# asm 2: movdqa <x2=%xmm5,>y0=%xmm8
movdqa %xmm5,%xmm8
...
# qhasm:   y2 = x0
# asm 1: movdqa <x0=int6464#7,>y2=int6464#5
# asm 2: movdqa <x0=%xmm6,>y2=%xmm4
movdqa %xmm6,%xmm4
...
# qhasm:   y1 = x3
# asm 1: movdqa <x3=int6464#8,>y1=int6464#11
# asm 2: movdqa <x3=%xmm7,>y1=%xmm10
movdqa %xmm7,%xmm10

# qhasm:   uint32323232 y1 <<= 7
# asm 1: pslld $7,<y1=int6464#11
# asm 2: pslld $7,<y1=%xmm10
pslld $7,%xmm10
...
# qhasm:   y3 = x1
# asm 1: movdqa <x1=int6464#10,>y3=int6464#6
# asm 2: movdqa <x1=%xmm9,>y3=%xmm5
movdqa %xmm9,%xmm5
...
# qhasm:   x0 = y1
# asm 1: movdqa <y1=int6464#11,>x0=int6464#5
# asm 2: movdqa <y1=%xmm10,>x0=%xmm4
movdqa %xmm10,%xmm4

# qhasm:   x1 = y0
# asm 1: movdqa <y0=int6464#9,>x1=int6464#6
# asm 2: movdqa <y0=%xmm8,>x1=%xmm5
movdqa %xmm8,%xmm5
