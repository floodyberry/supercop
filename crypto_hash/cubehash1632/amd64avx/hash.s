...
# qhasm:   x0 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init0
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init0,>x0=int6464#1
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init0,>x0=%xmm0
movdqa crypto_hash_cubehash1632_amd64avx_init0,%xmm0

# qhasm:   x1 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init1
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init1,>x1=int6464#2
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init1,>x1=%xmm1
movdqa crypto_hash_cubehash1632_amd64avx_init1,%xmm1

# qhasm:   x2 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init2
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init2,>x2=int6464#3
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init2,>x2=%xmm2
movdqa crypto_hash_cubehash1632_amd64avx_init2,%xmm2

# qhasm:   x3 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init3
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init3,>x3=int6464#4
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init3,>x3=%xmm3
movdqa crypto_hash_cubehash1632_amd64avx_init3,%xmm3

# qhasm:   x4 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init4
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init4,>x4=int6464#5
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init4,>x4=%xmm4
movdqa crypto_hash_cubehash1632_amd64avx_init4,%xmm4

# qhasm:   x5 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init5
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init5,>x5=int6464#6
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init5,>x5=%xmm5
movdqa crypto_hash_cubehash1632_amd64avx_init5,%xmm5

# qhasm:   x6 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init6
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init6,>x6=int6464#7
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init6,>x6=%xmm6
movdqa crypto_hash_cubehash1632_amd64avx_init6,%xmm6

# qhasm:   x7 = *(int128 *) crypto_hash_cubehash1632_amd64avx_init7
# asm 1: movdqa crypto_hash_cubehash1632_amd64avx_init7,>x7=int6464#8
# asm 2: movdqa crypto_hash_cubehash1632_amd64avx_init7,>x7=%xmm7
movdqa crypto_hash_cubehash1632_amd64avx_init7,%xmm7
...
# asm 1: vpslld $7,<x2=int6464#3,>y0=int6464#9
# asm 2: vpslld $7,<x2=%xmm2,>y0=%xmm8
vpslld $7,%xmm2,%xmm8

# qhasm:   uint32323232 y1 = x3 << 7
# asm 1: vpslld $7,<x3=int6464#4,>y1=int6464#10
# asm 2: vpslld $7,<x3=%xmm3,>y1=%xmm9
vpslld $7,%xmm3,%xmm9

# qhasm:   uint32323232 y2 = x0 << 7
# asm 1: vpslld $7,<x0=int6464#1,>y2=int6464#11
# asm 2: vpslld $7,<x0=%xmm0,>y2=%xmm10
vpslld $7,%xmm0,%xmm10

# qhasm:   uint32323232 y3 = x1 << 7
# asm 1: vpslld $7,<x1=int6464#2,>y3=int6464#12
# asm 2: vpslld $7,<x1=%xmm1,>y3=%xmm11
vpslld $7,%xmm1,%xmm11
...
# asm 1: vpslld $11,<y1=int6464#10,>x0=int6464#1
# asm 2: vpslld $11,<y1=%xmm9,>x0=%xmm0
vpslld $11,%xmm9,%xmm0

# qhasm:   uint32323232 x1 = y0 << 11
# asm 1: vpslld $11,<y0=int6464#9,>x1=int6464#2
# asm 2: vpslld $11,<y0=%xmm8,>x1=%xmm1
vpslld $11,%xmm8,%xmm1

# qhasm:   uint32323232 x2 = y3 << 11
# asm 1: vpslld $11,<y3=int6464#12,>x2=int6464#3
# asm 2: vpslld $11,<y3=%xmm11,>x2=%xmm2
vpslld $11,%xmm11,%xmm2

# qhasm:   uint32323232 x3 = y2 << 11
# asm 1: vpslld $11,<y2=int6464#11,>x3=int6464#4
# asm 2: vpslld $11,<y2=%xmm10,>x3=%xmm3
vpslld $11,%xmm10,%xmm3
...
# qhasm:   x7 ^= *(int128 *) crypto_hash_cubehash1632_amd64avx_final
# asm 1: pxor crypto_hash_cubehash1632_amd64avx_final,<x7=int6464#8
# asm 2: pxor crypto_hash_cubehash1632_amd64avx_final,<x7=%xmm7
pxor crypto_hash_cubehash1632_amd64avx_final,%xmm7
