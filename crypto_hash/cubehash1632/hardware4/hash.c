  ...
  mainloop:
    ...
    for (;r > 0;--r) {
	  ...
	  newsavef = x0f >> 5;
          ...
          se = x1e + x0e + carrye;
          sf = x1f + x0f + carryf;
          newcarry0 = cycle & (s0 < x00);
          newcarry1 = cycle & (s1 < x01);
          newcarry2 = cycle & (s2 < x02);
          newcarry3 = cycle & (s3 < x03);
          newcarry4 = cycle & (s4 < x04);
          newcarry5 = cycle & (s5 < x05);
          newcarry6 = cycle & (s6 < x06);
          newcarry7 = cycle & (s7 < x07);
          newcarry8 = cycle & (s8 < x08);
          newcarry9 = cycle & (s9 < x09);
          newcarrya = cycle & (sa < x0a);
          newcarryb = cycle & (sb < x0b);
          newcarryc = cycle & (sc < x0c);
          newcarryd = cycle & (sd < x0d);
          newcarrye = cycle & (se < x0e);
          newcarryf = cycle & (sf < x0f);
