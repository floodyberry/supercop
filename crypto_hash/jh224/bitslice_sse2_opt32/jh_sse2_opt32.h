/* This program gives the optimized SSE2 bitslice implementation of JH for 32-bit platform (with 8 128-bit XMM registers).
   ...
   1) 19.0 cycle/byte   compiler: Intel C++ compiler 11.1   compilation option: icc -O2 
   2) 21.2 cycles/byte  compiler: gcc 4.3.2                 compilation option: gcc -msse2 -O3  

   Microprocessor: Intel CORE 2 processor (Core 2 Quad Q6600 2.4GHz) 
   Operating System: 32-bit Windows Vista Business
   Speed for long message:
   3) 20.3 cycles/byte  compiler: Intel C++ compiler 11.1    compilation option: icl /O2
   4) 27.1 cycles/byte  compiler: Microsoft Visual C++ 2008  compilation option: release
