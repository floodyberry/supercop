...
void luffa256(uint32 *chainv, const uint8 *msg, uint64 round_num);
void luffa384(uint32 *chainv, const uint8 *msg, uint64 round_num);
void luffa512(uint32 *chainv, const uint8 *msg, uint64 round_num);
