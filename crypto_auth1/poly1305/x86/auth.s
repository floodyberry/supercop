...
# qhasm: enter crypto_auth1_poly1305_x86 stackaligned4096 crypto_auth1_poly1305_x86_constants
.text
.p2align 5
.globl _crypto_auth1_poly1305_x86
.globl crypto_auth1_poly1305_x86
_crypto_auth1_poly1305_x86:
crypto_auth1_poly1305_x86:
mov %esp,%eax
sub $crypto_auth1_poly1305_x86_constants,%eax
and $4095,%eax
add $192,%eax
sub %eax,%esp
...
# qhasm:   round *(uint16 *) &crypto_auth1_poly1305_x86_rounding
fldcw crypto_auth1_poly1305_x86_rounding
...
# qhasm:   a0 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset0
fsubl crypto_auth1_poly1305_x86_doffset0
# comment:fpstackfrombottom:<a0#24:
...
# qhasm:   a1 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset1
fsubl crypto_auth1_poly1305_x86_doffset1
# comment:fpstackfrombottom:<a0#24:<a1#25:
...
# qhasm:   a2 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset2
fsubl crypto_auth1_poly1305_x86_doffset2
# comment:fpstackfrombottom:<a0#24:<a1#25:<a2#26:
...
# qhasm:   a3 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset3
fsubl crypto_auth1_poly1305_x86_doffset3
# comment:fpstackfrombottom:<a0#24:<a1#25:<a2#26:<a3#27:
...
# qhasm:   a1 *= *(float64 *) &crypto_auth1_poly1305_x86_scale
fmull crypto_auth1_poly1305_x86_scale
# comment:fpstackfrombottom:<a3#27:<a2#26:<a1#25:
...
# qhasm:   a2 *= *(float64 *) &crypto_auth1_poly1305_x86_scale
fmull crypto_auth1_poly1305_x86_scale
# comment:fpstackfrombottom:<a3#27:<a2#26:
...
# qhasm:   a3 *= *(float64 *) &crypto_auth1_poly1305_x86_scale
fmull crypto_auth1_poly1305_x86_scale
# comment:fpstackfrombottom:<a3#27:
...
# qhasm:   h3 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset3minustwo128
fsubl crypto_auth1_poly1305_x86_doffset3minustwo128
# comment:fpstackfrombottom:<h0#41:<h2#39:<h1#40:<h3#38:
...
# qhasm:   h1 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset1
fsubl crypto_auth1_poly1305_x86_doffset1
# comment:fpstackfrombottom:<h0#41:<h2#39:<h3#38:<h1#40:
...
# qhasm:   h2 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset2
fsubl crypto_auth1_poly1305_x86_doffset2
# comment:fpstackfrombottom:<h0#41:<h1#40:<h3#38:<h2#39:
...
# qhasm:   h0 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset0
fsubl crypto_auth1_poly1305_x86_doffset0
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<h0#41:
...
# qhasm:   x0 = *(float64 *) &crypto_auth1_poly1305_x86_alpha130
fldl crypto_auth1_poly1305_x86_alpha130
...
# qhasm:   x0 -= *(float64 *) &crypto_auth1_poly1305_x86_alpha130
fsubl crypto_auth1_poly1305_x86_alpha130
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<h0#41:<x0#54:
...
# qhasm:   x0 *= *(float64 *) &crypto_auth1_poly1305_x86_scale
fmull crypto_auth1_poly1305_x86_scale
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<h0#41:<x0#54:

# qhasm:   x1 = *(float64 *) &crypto_auth1_poly1305_x86_alpha32
fldl crypto_auth1_poly1305_x86_alpha32
...
# qhasm:   x1 -= *(float64 *) &crypto_auth1_poly1305_x86_alpha32
fsubl crypto_auth1_poly1305_x86_alpha32
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<h0#41:<x0#54:<x1#55:
...
# qhasm:   x2 = *(float64 *) &crypto_auth1_poly1305_x86_alpha64
fldl crypto_auth1_poly1305_x86_alpha64
...
# qhasm:   x2 -= *(float64 *) &crypto_auth1_poly1305_x86_alpha64
fsubl crypto_auth1_poly1305_x86_alpha64
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<x1#55:<x0#54:<x2#56:
...
# qhasm:   x3 = *(float64 *) &crypto_auth1_poly1305_x86_alpha96
fldl crypto_auth1_poly1305_x86_alpha96
...
# qhasm:   x3 -= *(float64 *) &crypto_auth1_poly1305_x86_alpha96
fsubl crypto_auth1_poly1305_x86_alpha96
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<x1#55:<x0#54:<x2#56:<x3#57:
...
# qhasm:   y3 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset3minustwo128
fsubl crypto_auth1_poly1305_x86_doffset3minustwo128
# comment:fpstackfrombottom:<h1#40:<h0#41:<h2#39:<h3#38:<y3#71:
...
# qhasm:   y2 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset2
fsubl crypto_auth1_poly1305_x86_doffset2
# comment:fpstackfrombottom:<h1#40:<h0#41:<h3#38:<h2#39:<y2#72:
...
# qhasm:   y1 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset1
fsubl crypto_auth1_poly1305_x86_doffset1
# comment:fpstackfrombottom:<h2#39:<h0#41:<h3#38:<h1#40:<y1#73:
...
# qhasm:   y0 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset0
fsubl crypto_auth1_poly1305_x86_doffset0
# comment:fpstackfrombottom:<h2#39:<h1#40:<h3#38:<h0#41:<y0#74:
...
# qhasm:   h3 -= *(float64 *) &crypto_auth1_poly1305_x86_doffset3
fsubl crypto_auth1_poly1305_x86_doffset3
# comment:fpstackfrombottom:<h0#41:<h2#39:<h1#40:<h3#38:
...
# qhasm:   x0 += *(float64 *) &crypto_auth1_poly1305_x86_hoffset0
faddl crypto_auth1_poly1305_x86_hoffset0
...
# qhasm:   x1 += *(float64 *) &crypto_auth1_poly1305_x86_hoffset1
faddl crypto_auth1_poly1305_x86_hoffset1
# comment:fpstackfrombottom:<x0#114:<x3#117:<x2#116:<x1#115:
...
# qhasm:   x2 += *(float64 *) &crypto_auth1_poly1305_x86_hoffset2
faddl crypto_auth1_poly1305_x86_hoffset2
...
# qhasm:   x3 += *(float64 *) &crypto_auth1_poly1305_x86_hoffset3
faddl crypto_auth1_poly1305_x86_hoffset3
