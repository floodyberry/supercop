...
# qhasm: 		b3 = 0
# asm 1: pxor   >b3=int6464#5,>b3=int6464#5
# asm 2: pxor   >b3=%xmm4,>b3=%xmm4
pxor   %xmm4,%xmm4
...
# qhasm: uint32323232	b3 += diag3
# asm 1: paddd <diag3=int6464#4,<b3=int6464#5
# asm 2: paddd <diag3=%xmm3,<b3=%xmm4
paddd %xmm3,%xmm4
...
# qhasm: 				b1 = 0
# asm 1: pxor   >b1=int6464#5,>b1=int6464#5
# asm 2: pxor   >b1=%xmm4,>b1=%xmm4
pxor   %xmm4,%xmm4
...
# qhasm: uint32323232			b1 += diag1
# asm 1: paddd <diag1=int6464#2,<b1=int6464#5
# asm 2: paddd <diag1=%xmm1,<b1=%xmm4
paddd %xmm1,%xmm4
