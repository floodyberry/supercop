...
# qhasm:   z5_stack = z5
# asm 1: movdqa <z5=int6464#2,>z5_stack=stack128#1
# asm 2: movdqa <z5=%xmm1,>z5_stack=32(%esp)
movdqa %xmm1,32(%esp)

# qhasm:   z10_stack = z10
# asm 1: movdqa <z10=int6464#3,>z10_stack=stack128#2
# asm 2: movdqa <z10=%xmm2,>z10_stack=48(%esp)
movdqa %xmm2,48(%esp)

# qhasm:   z15_stack = z15
# asm 1: movdqa <z15=int6464#4,>z15_stack=stack128#3
# asm 2: movdqa <z15=%xmm3,>z15_stack=64(%esp)
movdqa %xmm3,64(%esp)

# qhasm:   z0_stack = z0
# asm 1: movdqa <z0=int6464#1,>z0_stack=stack128#4
# asm 2: movdqa <z0=%xmm0,>z0_stack=80(%esp)
movdqa %xmm0,80(%esp)
...
# qhasm:   z6_stack = z6
# asm 1: movdqa <z6=int6464#2,>z6_stack=stack128#9
# asm 2: movdqa <z6=%xmm1,>z6_stack=160(%esp)
movdqa %xmm1,160(%esp)

# qhasm:   z11_stack = z11
# asm 1: movdqa <z11=int6464#3,>z11_stack=stack128#10
# asm 2: movdqa <z11=%xmm2,>z11_stack=176(%esp)
movdqa %xmm2,176(%esp)

# qhasm:   z12_stack = z12
# asm 1: movdqa <z12=int6464#4,>z12_stack=stack128#11
# asm 2: movdqa <z12=%xmm3,>z12_stack=192(%esp)
movdqa %xmm3,192(%esp)

# qhasm:   z1_stack = z1
# asm 1: movdqa <z1=int6464#1,>z1_stack=stack128#12
# asm 2: movdqa <z1=%xmm0,>z1_stack=208(%esp)
movdqa %xmm0,208(%esp)

# qhasm:   orig6 = z6
# asm 1: movdqa <z6=int6464#2,>orig6=stack128#13
# asm 2: movdqa <z6=%xmm1,>orig6=224(%esp)
movdqa %xmm1,224(%esp)

# qhasm:   orig11 = z11
# asm 1: movdqa <z11=int6464#3,>orig11=stack128#14
# asm 2: movdqa <z11=%xmm2,>orig11=240(%esp)
movdqa %xmm2,240(%esp)

# qhasm:   orig12 = z12
# asm 1: movdqa <z12=int6464#4,>orig12=stack128#15
# asm 2: movdqa <z12=%xmm3,>orig12=256(%esp)
movdqa %xmm3,256(%esp)

# qhasm:   orig1 = z1
# asm 1: movdqa <z1=int6464#1,>orig1=stack128#16
# asm 2: movdqa <z1=%xmm0,>orig1=272(%esp)
movdqa %xmm0,272(%esp)
...
# qhasm:   z7_stack = z7
# asm 1: movdqa <z7=int6464#2,>z7_stack=stack128#17
# asm 2: movdqa <z7=%xmm1,>z7_stack=288(%esp)
movdqa %xmm1,288(%esp)

# qhasm:   z13_stack = z13
# asm 1: movdqa <z13=int6464#3,>z13_stack=stack128#18
# asm 2: movdqa <z13=%xmm2,>z13_stack=304(%esp)
movdqa %xmm2,304(%esp)

# qhasm:   z2_stack = z2
# asm 1: movdqa <z2=int6464#1,>z2_stack=stack128#19
# asm 2: movdqa <z2=%xmm0,>z2_stack=320(%esp)
movdqa %xmm0,320(%esp)

# qhasm:   orig7 = z7
# asm 1: movdqa <z7=int6464#2,>orig7=stack128#20
# asm 2: movdqa <z7=%xmm1,>orig7=336(%esp)
movdqa %xmm1,336(%esp)

# qhasm:   orig13 = z13
# asm 1: movdqa <z13=int6464#3,>orig13=stack128#21
# asm 2: movdqa <z13=%xmm2,>orig13=352(%esp)
movdqa %xmm2,352(%esp)

# qhasm:   orig2 = z2
# asm 1: movdqa <z2=int6464#1,>orig2=stack128#22
# asm 2: movdqa <z2=%xmm0,>orig2=368(%esp)
movdqa %xmm0,368(%esp)
...
# qhasm:   z4_stack = z4
# asm 1: movdqa <z4=int6464#2,>z4_stack=stack128#23
# asm 2: movdqa <z4=%xmm1,>z4_stack=384(%esp)
movdqa %xmm1,384(%esp)

# qhasm:   z14_stack = z14
# asm 1: movdqa <z14=int6464#3,>z14_stack=stack128#24
# asm 2: movdqa <z14=%xmm2,>z14_stack=400(%esp)
movdqa %xmm2,400(%esp)

# qhasm:   z3_stack = z3
# asm 1: movdqa <z3=int6464#1,>z3_stack=stack128#25
# asm 2: movdqa <z3=%xmm0,>z3_stack=416(%esp)
movdqa %xmm0,416(%esp)

# qhasm:   orig4 = z4
# asm 1: movdqa <z4=int6464#2,>orig4=stack128#26
# asm 2: movdqa <z4=%xmm1,>orig4=432(%esp)
movdqa %xmm1,432(%esp)

# qhasm:   orig14 = z14
# asm 1: movdqa <z14=int6464#3,>orig14=stack128#27
# asm 2: movdqa <z14=%xmm2,>orig14=448(%esp)
movdqa %xmm2,448(%esp)

# qhasm:   orig3 = z3
# asm 1: movdqa <z3=int6464#1,>orig3=stack128#28
# asm 2: movdqa <z3=%xmm0,>orig3=464(%esp)
movdqa %xmm0,464(%esp)
...
# qhasm:   ((uint32 *) &z8_stack)[0] = in8
# asm 1: movl <in8=int32#1,>z8_stack=stack128#29
# asm 2: movl <in8=%eax,>z8_stack=480(%esp)
movl %eax,480(%esp)

# qhasm:   ((uint32 *) &z9_stack)[0] = in9
# asm 1: movl <in9=int32#2,>z9_stack=stack128#30
# asm 2: movl <in9=%ecx,>z9_stack=496(%esp)
movl %ecx,496(%esp)

# qhasm:   ((uint32 *) &orig8)[0] = in8
# asm 1: movl <in8=int32#1,>orig8=stack128#31
# asm 2: movl <in8=%eax,>orig8=512(%esp)
movl %eax,512(%esp)

# qhasm:   ((uint32 *) &orig9)[0] = in9
# asm 1: movl <in9=int32#2,>orig9=stack128#32
# asm 2: movl <in9=%ecx,>orig9=528(%esp)
movl %ecx,528(%esp)
...
# qhasm:   ((uint32 *) &z8_stack)[1] = in8
# asm 1: movl <in8=int32#1,4+<z8_stack=stack128#29
# asm 2: movl <in8=%eax,4+<z8_stack=480(%esp)
movl %eax,4+480(%esp)

# qhasm:   ((uint32 *) &z9_stack)[1] = in9
# asm 1: movl <in9=int32#2,4+<z9_stack=stack128#30
# asm 2: movl <in9=%ecx,4+<z9_stack=496(%esp)
movl %ecx,4+496(%esp)

# qhasm:   ((uint32 *) &orig8)[1] = in8
# asm 1: movl <in8=int32#1,4+<orig8=stack128#31
# asm 2: movl <in8=%eax,4+<orig8=512(%esp)
movl %eax,4+512(%esp)

# qhasm:   ((uint32 *) &orig9)[1] = in9
# asm 1: movl <in9=int32#2,4+<orig9=stack128#32
# asm 2: movl <in9=%ecx,4+<orig9=528(%esp)
movl %ecx,4+528(%esp)
...
# qhasm:   ((uint32 *) &z8_stack)[2] = in8
# asm 1: movl <in8=int32#1,8+<z8_stack=stack128#29
# asm 2: movl <in8=%eax,8+<z8_stack=480(%esp)
movl %eax,8+480(%esp)

# qhasm:   ((uint32 *) &z9_stack)[2] = in9
# asm 1: movl <in9=int32#2,8+<z9_stack=stack128#30
# asm 2: movl <in9=%ecx,8+<z9_stack=496(%esp)
movl %ecx,8+496(%esp)

# qhasm:   ((uint32 *) &orig8)[2] = in8
# asm 1: movl <in8=int32#1,8+<orig8=stack128#31
# asm 2: movl <in8=%eax,8+<orig8=512(%esp)
movl %eax,8+512(%esp)

# qhasm:   ((uint32 *) &orig9)[2] = in9
# asm 1: movl <in9=int32#2,8+<orig9=stack128#32
# asm 2: movl <in9=%ecx,8+<orig9=528(%esp)
movl %ecx,8+528(%esp)
...
# qhasm:   ((uint32 *) &z8_stack)[3] = in8
# asm 1: movl <in8=int32#1,12+<z8_stack=stack128#29
# asm 2: movl <in8=%eax,12+<z8_stack=480(%esp)
movl %eax,12+480(%esp)

# qhasm:   ((uint32 *) &z9_stack)[3] = in9
# asm 1: movl <in9=int32#2,12+<z9_stack=stack128#30
# asm 2: movl <in9=%ecx,12+<z9_stack=496(%esp)
movl %ecx,12+496(%esp)

# qhasm:   ((uint32 *) &orig8)[3] = in8
# asm 1: movl <in8=int32#1,12+<orig8=stack128#31
# asm 2: movl <in8=%eax,12+<orig8=512(%esp)
movl %eax,12+512(%esp)

# qhasm:   ((uint32 *) &orig9)[3] = in9
# asm 1: movl <in9=int32#2,12+<orig9=stack128#32
# asm 2: movl <in9=%ecx,12+<orig9=528(%esp)
movl %ecx,12+528(%esp)
...
# qhasm:                   s = z12_stack
# asm 1: movdqa <z12_stack=stack128#11,>s=int6464#1
# asm 2: movdqa <z12_stack=192(%esp),>s=%xmm0
movdqa 192(%esp),%xmm0

# qhasm:                   p = z0_stack
# asm 1: movdqa <z0_stack=stack128#4,>p=int6464#2
# asm 2: movdqa <z0_stack=80(%esp),>p=%xmm1
movdqa 80(%esp),%xmm1

# qhasm:                   q = z4_stack
# asm 1: movdqa <z4_stack=stack128#23,>q=int6464#3
# asm 2: movdqa <z4_stack=384(%esp),>q=%xmm2
movdqa 384(%esp),%xmm2

# qhasm:                   r = z8_stack
# asm 1: movdqa <z8_stack=stack128#29,>r=int6464#4
# asm 2: movdqa <z8_stack=480(%esp),>r=%xmm3
movdqa 480(%esp),%xmm3

# qhasm:                   t = s
# asm 1: movdqa <s=int6464#1,>t=int6464#5
# asm 2: movdqa <s=%xmm0,>t=%xmm4
movdqa %xmm0,%xmm4

# qhasm: uint32323232      t += p
# asm 1: paddd <p=int6464#2,<t=int6464#5
# asm 2: paddd <p=%xmm1,<t=%xmm4
paddd %xmm1,%xmm4

# qhasm:                   u = t
# asm 1: movdqa <t=int6464#5,>u=int6464#6
# asm 2: movdqa <t=%xmm4,>u=%xmm5
movdqa %xmm4,%xmm5

# qhasm: uint32323232      u <<= 7
# asm 1: pslld $7,<u=int6464#6
# asm 2: pslld $7,<u=%xmm5
pslld $7,%xmm5

# qhasm:                   q ^= u
# asm 1: pxor  <u=int6464#6,<q=int6464#3
# asm 2: pxor  <u=%xmm5,<q=%xmm2
pxor  %xmm5,%xmm2

# qhasm: uint32323232      t >>= 25
# asm 1: psrld $25,<t=int6464#5
# asm 2: psrld $25,<t=%xmm4
psrld $25,%xmm4

# qhasm:                   q ^= t
# asm 1: pxor  <t=int6464#5,<q=int6464#3
# asm 2: pxor  <t=%xmm4,<q=%xmm2
pxor  %xmm4,%xmm2

# qhasm:                   z4_stack = q
# asm 1: movdqa <q=int6464#3,>z4_stack=stack128#11
# asm 2: movdqa <q=%xmm2,>z4_stack=192(%esp)
movdqa %xmm2,192(%esp)

# qhasm:                   t = p
# asm 1: movdqa <p=int6464#2,>t=int6464#5
# asm 2: movdqa <p=%xmm1,>t=%xmm4
movdqa %xmm1,%xmm4

# qhasm: uint32323232      t += q
# asm 1: paddd <q=int6464#3,<t=int6464#5
# asm 2: paddd <q=%xmm2,<t=%xmm4
paddd %xmm2,%xmm4
...
# asm 1: pslld $9,<u=int6464#6
# asm 2: pslld $9,<u=%xmm5
pslld $9,%xmm5

# qhasm:                   r ^= u
# asm 1: pxor  <u=int6464#6,<r=int6464#4
# asm 2: pxor  <u=%xmm5,<r=%xmm3
pxor  %xmm5,%xmm3

# qhasm: uint32323232      t >>= 23
# asm 1: psrld $23,<t=int6464#5
# asm 2: psrld $23,<t=%xmm4
psrld $23,%xmm4

# qhasm:                   r ^= t
# asm 1: pxor  <t=int6464#5,<r=int6464#4
# asm 2: pxor  <t=%xmm4,<r=%xmm3
pxor  %xmm4,%xmm3

# qhasm:                   z8_stack = r
# asm 1: movdqa <r=int6464#4,>z8_stack=stack128#29
# asm 2: movdqa <r=%xmm3,>z8_stack=480(%esp)
movdqa %xmm3,480(%esp)

# qhasm: uint32323232      q += r
# asm 1: paddd <r=int6464#4,<q=int6464#3
# asm 2: paddd <r=%xmm3,<q=%xmm2
paddd %xmm3,%xmm2

# qhasm:                   u = q
# asm 1: movdqa <q=int6464#3,>u=int6464#5
# asm 2: movdqa <q=%xmm2,>u=%xmm4
movdqa %xmm2,%xmm4

# qhasm: uint32323232      u <<= 13
# asm 1: pslld $13,<u=int6464#5
# asm 2: pslld $13,<u=%xmm4
pslld $13,%xmm4

# qhasm:                   s ^= u
# asm 1: pxor  <u=int6464#5,<s=int6464#1
# asm 2: pxor  <u=%xmm4,<s=%xmm0
pxor  %xmm4,%xmm0

# qhasm: uint32323232      q >>= 19
# asm 1: psrld $19,<q=int6464#3
# asm 2: psrld $19,<q=%xmm2
psrld $19,%xmm2

# qhasm:                   s ^= q
# asm 1: pxor  <q=int6464#3,<s=int6464#1
# asm 2: pxor  <q=%xmm2,<s=%xmm0
pxor  %xmm2,%xmm0

# qhasm:                   z12_stack = s
# asm 1: movdqa <s=int6464#1,>z12_stack=stack128#33
# asm 2: movdqa <s=%xmm0,>z12_stack=544(%esp)
movdqa %xmm0,544(%esp)

# qhasm: uint32323232      r += s
# asm 1: paddd <s=int6464#1,<r=int6464#4
# asm 2: paddd <s=%xmm0,<r=%xmm3
paddd %xmm0,%xmm3

# qhasm:                   u = r
# asm 1: movdqa <r=int6464#4,>u=int6464#1
# asm 2: movdqa <r=%xmm3,>u=%xmm0
movdqa %xmm3,%xmm0

# qhasm: uint32323232      u <<= 18
# asm 1: pslld $18,<u=int6464#1
# asm 2: pslld $18,<u=%xmm0
pslld $18,%xmm0

# qhasm:                   p ^= u
# asm 1: pxor  <u=int6464#1,<p=int6464#2
# asm 2: pxor  <u=%xmm0,<p=%xmm1
pxor  %xmm0,%xmm1

# qhasm: uint32323232      r >>= 14
# asm 1: psrld $14,<r=int6464#4
# asm 2: psrld $14,<r=%xmm3
psrld $14,%xmm3

# qhasm:                   p ^= r
# asm 1: pxor  <r=int6464#4,<p=int6464#2
# asm 2: pxor  <r=%xmm3,<p=%xmm1
pxor  %xmm3,%xmm1

# qhasm:                   z0_stack = p
# asm 1: movdqa <p=int6464#2,>z0_stack=stack128#4
# asm 2: movdqa <p=%xmm1,>z0_stack=80(%esp)
movdqa %xmm1,80(%esp)

# qhasm:                                   s = z1_stack
# asm 1: movdqa <z1_stack=stack128#12,>s=int6464#1
# asm 2: movdqa <z1_stack=208(%esp),>s=%xmm0
movdqa 208(%esp),%xmm0

# qhasm:                                   p = z5_stack
# asm 1: movdqa <z5_stack=stack128#1,>p=int6464#2
# asm 2: movdqa <z5_stack=32(%esp),>p=%xmm1
movdqa 32(%esp),%xmm1

# qhasm:                                   q = z9_stack
# asm 1: movdqa <z9_stack=stack128#30,>q=int6464#3
# asm 2: movdqa <z9_stack=496(%esp),>q=%xmm2
movdqa 496(%esp),%xmm2

# qhasm:                                   r = z13_stack
# asm 1: movdqa <z13_stack=stack128#18,>r=int6464#4
# asm 2: movdqa <z13_stack=304(%esp),>r=%xmm3
movdqa 304(%esp),%xmm3
...
# qhasm:                                   z9_stack = q
# asm 1: movdqa <q=int6464#3,>z9_stack=stack128#18
# asm 2: movdqa <q=%xmm2,>z9_stack=304(%esp)
movdqa %xmm2,304(%esp)
...
# qhasm:                                   z13_stack = r
# asm 1: movdqa <r=int6464#4,>z13_stack=stack128#34
# asm 2: movdqa <r=%xmm3,>z13_stack=560(%esp)
movdqa %xmm3,560(%esp)
...
# qhasm:                                   z1_stack = s
# asm 1: movdqa <s=int6464#1,>z1_stack=stack128#1
# asm 2: movdqa <s=%xmm0,>z1_stack=32(%esp)
movdqa %xmm0,32(%esp)
...
# qhasm:                                   z5_stack = p
# asm 1: movdqa <p=int6464#2,>z5_stack=stack128#23
# asm 2: movdqa <p=%xmm1,>z5_stack=384(%esp)
movdqa %xmm1,384(%esp)

# qhasm:                                                   s = z6_stack
# asm 1: movdqa <z6_stack=stack128#9,>s=int6464#1
# asm 2: movdqa <z6_stack=160(%esp),>s=%xmm0
movdqa 160(%esp),%xmm0

# qhasm:                                                   p = z10_stack
# asm 1: movdqa <z10_stack=stack128#2,>p=int6464#2
# asm 2: movdqa <z10_stack=48(%esp),>p=%xmm1
movdqa 48(%esp),%xmm1

# qhasm:                                                   q = z14_stack
# asm 1: movdqa <z14_stack=stack128#24,>q=int6464#3
# asm 2: movdqa <z14_stack=400(%esp),>q=%xmm2
movdqa 400(%esp),%xmm2

# qhasm:                                                   r = z2_stack
# asm 1: movdqa <z2_stack=stack128#19,>r=int6464#4
# asm 2: movdqa <z2_stack=320(%esp),>r=%xmm3
movdqa 320(%esp),%xmm3
...
# qhasm:                                                   z14_stack = q
# asm 1: movdqa <q=int6464#3,>z14_stack=stack128#24
# asm 2: movdqa <q=%xmm2,>z14_stack=400(%esp)
movdqa %xmm2,400(%esp)
...
# qhasm:                                                   z2_stack = r
# asm 1: movdqa <r=int6464#4,>z2_stack=stack128#2
# asm 2: movdqa <r=%xmm3,>z2_stack=48(%esp)
movdqa %xmm3,48(%esp)
...
# qhasm:                                                   z6_stack = s
# asm 1: movdqa <s=int6464#1,>z6_stack=stack128#9
# asm 2: movdqa <s=%xmm0,>z6_stack=160(%esp)
movdqa %xmm0,160(%esp)
...
# qhasm:                                                   z10_stack = p
# asm 1: movdqa <p=int6464#2,>z10_stack=stack128#30
# asm 2: movdqa <p=%xmm1,>z10_stack=496(%esp)
movdqa %xmm1,496(%esp)

# qhasm:                                                                   s = z11_stack
# asm 1: movdqa <z11_stack=stack128#10,>s=int6464#1
# asm 2: movdqa <z11_stack=176(%esp),>s=%xmm0
movdqa 176(%esp),%xmm0

# qhasm:                                                                   p = z15_stack
# asm 1: movdqa <z15_stack=stack128#3,>p=int6464#2
# asm 2: movdqa <z15_stack=64(%esp),>p=%xmm1
movdqa 64(%esp),%xmm1

# qhasm:                                                                   q = z3_stack
# asm 1: movdqa <z3_stack=stack128#25,>q=int6464#3
# asm 2: movdqa <z3_stack=416(%esp),>q=%xmm2
movdqa 416(%esp),%xmm2

# qhasm:                                                                   r = z7_stack
# asm 1: movdqa <z7_stack=stack128#17,>r=int6464#4
# asm 2: movdqa <z7_stack=288(%esp),>r=%xmm3
movdqa 288(%esp),%xmm3
...
# qhasm:                                                                   z3_stack = q
# asm 1: movdqa <q=int6464#3,>z3_stack=stack128#3
# asm 2: movdqa <q=%xmm2,>z3_stack=64(%esp)
movdqa %xmm2,64(%esp)
...
# qhasm:                                                                   z7_stack = r
# asm 1: movdqa <r=int6464#4,>z7_stack=stack128#10
# asm 2: movdqa <r=%xmm3,>z7_stack=176(%esp)
movdqa %xmm3,176(%esp)
...
# qhasm:                                                                   z11_stack = s
# asm 1: movdqa <s=int6464#1,>z11_stack=stack128#35
# asm 2: movdqa <s=%xmm0,>z11_stack=576(%esp)
movdqa %xmm0,576(%esp)
...
# qhasm:                                                                   z15_stack = p
# asm 1: movdqa <p=int6464#2,>z15_stack=stack128#36
# asm 2: movdqa <p=%xmm1,>z15_stack=592(%esp)
movdqa %xmm1,592(%esp)

# qhasm:                   s = z3_stack
# asm 1: movdqa <z3_stack=stack128#3,>s=int6464#1
# asm 2: movdqa <z3_stack=64(%esp),>s=%xmm0
movdqa 64(%esp),%xmm0
...
# qhasm:                   q = z1_stack
# asm 1: movdqa <z1_stack=stack128#1,>q=int6464#3
# asm 2: movdqa <z1_stack=32(%esp),>q=%xmm2
movdqa 32(%esp),%xmm2

# qhasm:                   r = z2_stack
# asm 1: movdqa <z2_stack=stack128#2,>r=int6464#4
# asm 2: movdqa <z2_stack=48(%esp),>r=%xmm3
movdqa 48(%esp),%xmm3
...
# qhasm:                   z1_stack = q
# asm 1: movdqa <q=int6464#3,>z1_stack=stack128#12
# asm 2: movdqa <q=%xmm2,>z1_stack=208(%esp)
movdqa %xmm2,208(%esp)
...
# qhasm:                   z2_stack = r
# asm 1: movdqa <r=int6464#4,>z2_stack=stack128#19
# asm 2: movdqa <r=%xmm3,>z2_stack=320(%esp)
movdqa %xmm3,320(%esp)
...
# qhasm:                   z3_stack = s
# asm 1: movdqa <s=int6464#1,>z3_stack=stack128#25
# asm 2: movdqa <s=%xmm0,>z3_stack=416(%esp)
movdqa %xmm0,416(%esp)
...
# qhasm:                                   s = z4_stack
# asm 1: movdqa <z4_stack=stack128#11,>s=int6464#1
# asm 2: movdqa <z4_stack=192(%esp),>s=%xmm0
movdqa 192(%esp),%xmm0

# qhasm:                                   p = z5_stack
# asm 1: movdqa <z5_stack=stack128#23,>p=int6464#2
# asm 2: movdqa <z5_stack=384(%esp),>p=%xmm1
movdqa 384(%esp),%xmm1

# qhasm:                                   q = z6_stack
# asm 1: movdqa <z6_stack=stack128#9,>q=int6464#3
# asm 2: movdqa <z6_stack=160(%esp),>q=%xmm2
movdqa 160(%esp),%xmm2

# qhasm:                                   r = z7_stack
# asm 1: movdqa <z7_stack=stack128#10,>r=int6464#4
# asm 2: movdqa <z7_stack=176(%esp),>r=%xmm3
movdqa 176(%esp),%xmm3
...
# qhasm:                                   z6_stack = q
# asm 1: movdqa <q=int6464#3,>z6_stack=stack128#9
# asm 2: movdqa <q=%xmm2,>z6_stack=160(%esp)
movdqa %xmm2,160(%esp)
...
# qhasm:                                   z7_stack = r
# asm 1: movdqa <r=int6464#4,>z7_stack=stack128#17
# asm 2: movdqa <r=%xmm3,>z7_stack=288(%esp)
movdqa %xmm3,288(%esp)
...
# qhasm:                                   z4_stack = s
# asm 1: movdqa <s=int6464#1,>z4_stack=stack128#23
# asm 2: movdqa <s=%xmm0,>z4_stack=384(%esp)
movdqa %xmm0,384(%esp)
...
# qhasm:                                   z5_stack = p
# asm 1: movdqa <p=int6464#2,>z5_stack=stack128#1
# asm 2: movdqa <p=%xmm1,>z5_stack=32(%esp)
movdqa %xmm1,32(%esp)

# qhasm:                                                   s = z9_stack
# asm 1: movdqa <z9_stack=stack128#18,>s=int6464#1
# asm 2: movdqa <z9_stack=304(%esp),>s=%xmm0
movdqa 304(%esp),%xmm0

# qhasm:                                                   p = z10_stack
# asm 1: movdqa <z10_stack=stack128#30,>p=int6464#2
# asm 2: movdqa <z10_stack=496(%esp),>p=%xmm1
movdqa 496(%esp),%xmm1

# qhasm:                                                   q = z11_stack
# asm 1: movdqa <z11_stack=stack128#35,>q=int6464#3
# asm 2: movdqa <z11_stack=576(%esp),>q=%xmm2
movdqa 576(%esp),%xmm2
...
# qhasm:                                                   z11_stack = q
# asm 1: movdqa <q=int6464#3,>z11_stack=stack128#10
# asm 2: movdqa <q=%xmm2,>z11_stack=176(%esp)
movdqa %xmm2,176(%esp)
...
# qhasm:                                                   z9_stack = s
# asm 1: movdqa <s=int6464#1,>z9_stack=stack128#30
# asm 2: movdqa <s=%xmm0,>z9_stack=496(%esp)
movdqa %xmm0,496(%esp)
...
# qhasm:                                                   z10_stack = p
# asm 1: movdqa <p=int6464#2,>z10_stack=stack128#2
# asm 2: movdqa <p=%xmm1,>z10_stack=48(%esp)
movdqa %xmm1,48(%esp)

# qhasm:                                                                   s = z14_stack
# asm 1: movdqa <z14_stack=stack128#24,>s=int6464#1
# asm 2: movdqa <z14_stack=400(%esp),>s=%xmm0
movdqa 400(%esp),%xmm0

# qhasm:                                                                   p = z15_stack
# asm 1: movdqa <z15_stack=stack128#36,>p=int6464#2
# asm 2: movdqa <z15_stack=592(%esp),>p=%xmm1
movdqa 592(%esp),%xmm1

# qhasm:                                                                   q = z12_stack
# asm 1: movdqa <z12_stack=stack128#33,>q=int6464#3
# asm 2: movdqa <z12_stack=544(%esp),>q=%xmm2
movdqa 544(%esp),%xmm2

# qhasm:                                                                   r = z13_stack
# asm 1: movdqa <z13_stack=stack128#34,>r=int6464#4
# asm 2: movdqa <z13_stack=560(%esp),>r=%xmm3
movdqa 560(%esp),%xmm3
...
# qhasm:                                                                   z12_stack = q
# asm 1: movdqa <q=int6464#3,>z12_stack=stack128#11
# asm 2: movdqa <q=%xmm2,>z12_stack=192(%esp)
movdqa %xmm2,192(%esp)
...
# qhasm:                                                                   z13_stack = r
# asm 1: movdqa <r=int6464#4,>z13_stack=stack128#18
# asm 2: movdqa <r=%xmm3,>z13_stack=304(%esp)
movdqa %xmm3,304(%esp)
...
# qhasm:                                                                   z14_stack = s
# asm 1: movdqa <s=int6464#1,>z14_stack=stack128#24
# asm 2: movdqa <s=%xmm0,>z14_stack=400(%esp)
movdqa %xmm0,400(%esp)
...
# qhasm:                                                                   z15_stack = p
# asm 1: movdqa <p=int6464#2,>z15_stack=stack128#3
# asm 2: movdqa <p=%xmm1,>z15_stack=64(%esp)
movdqa %xmm1,64(%esp)
...
# qhasm:   z0 = z0_stack
# asm 1: movdqa <z0_stack=stack128#4,>z0=int6464#1
# asm 2: movdqa <z0_stack=80(%esp),>z0=%xmm0
movdqa 80(%esp),%xmm0

# qhasm:   z1 = z1_stack
# asm 1: movdqa <z1_stack=stack128#12,>z1=int6464#2
# asm 2: movdqa <z1_stack=208(%esp),>z1=%xmm1
movdqa 208(%esp),%xmm1

# qhasm:   z2 = z2_stack
# asm 1: movdqa <z2_stack=stack128#19,>z2=int6464#3
# asm 2: movdqa <z2_stack=320(%esp),>z2=%xmm2
movdqa 320(%esp),%xmm2
...
# asm 1: paddd <orig1=stack128#16,<z1=int6464#2
# asm 2: paddd <orig1=272(%esp),<z1=%xmm1
paddd 272(%esp),%xmm1

# qhasm:   uint32323232 z2 += orig2
# asm 1: paddd <orig2=stack128#22,<z2=int6464#3
# asm 2: paddd <orig2=368(%esp),<z2=%xmm2
paddd 368(%esp),%xmm2

# qhasm:   uint32323232 z3 += orig3
# asm 1: paddd <orig3=stack128#28,<z3=int6464#4
# asm 2: paddd <orig3=464(%esp),<z3=%xmm3
paddd 464(%esp),%xmm3
...
# qhasm:   z4 = z4_stack
# asm 1: movdqa <z4_stack=stack128#23,>z4=int6464#1
# asm 2: movdqa <z4_stack=384(%esp),>z4=%xmm0
movdqa 384(%esp),%xmm0

# qhasm:   z5 = z5_stack
# asm 1: movdqa <z5_stack=stack128#1,>z5=int6464#2
# asm 2: movdqa <z5_stack=32(%esp),>z5=%xmm1
movdqa 32(%esp),%xmm1

# qhasm:   z6 = z6_stack
# asm 1: movdqa <z6_stack=stack128#9,>z6=int6464#3
# asm 2: movdqa <z6_stack=160(%esp),>z6=%xmm2
movdqa 160(%esp),%xmm2

# qhasm:   z7 = z7_stack
# asm 1: movdqa <z7_stack=stack128#17,>z7=int6464#4
# asm 2: movdqa <z7_stack=288(%esp),>z7=%xmm3
movdqa 288(%esp),%xmm3

# qhasm:   uint32323232 z4 += orig4
# asm 1: paddd <orig4=stack128#26,<z4=int6464#1
# asm 2: paddd <orig4=432(%esp),<z4=%xmm0
paddd 432(%esp),%xmm0
...
# asm 1: paddd <orig6=stack128#13,<z6=int6464#3
# asm 2: paddd <orig6=224(%esp),<z6=%xmm2
paddd 224(%esp),%xmm2

# qhasm:   uint32323232 z7 += orig7
# asm 1: paddd <orig7=stack128#20,<z7=int6464#4
# asm 2: paddd <orig7=336(%esp),<z7=%xmm3
paddd 336(%esp),%xmm3
...
# qhasm:   z9 = z9_stack
# asm 1: movdqa <z9_stack=stack128#30,>z9=int6464#2
# asm 2: movdqa <z9_stack=496(%esp),>z9=%xmm1
movdqa 496(%esp),%xmm1

# qhasm:   z10 = z10_stack
# asm 1: movdqa <z10_stack=stack128#2,>z10=int6464#3
# asm 2: movdqa <z10_stack=48(%esp),>z10=%xmm2
movdqa 48(%esp),%xmm2

# qhasm:   z11 = z11_stack
# asm 1: movdqa <z11_stack=stack128#10,>z11=int6464#4
# asm 2: movdqa <z11_stack=176(%esp),>z11=%xmm3
movdqa 176(%esp),%xmm3

# qhasm:   uint32323232 z8 += orig8
# asm 1: paddd <orig8=stack128#31,<z8=int6464#1
# asm 2: paddd <orig8=512(%esp),<z8=%xmm0
paddd 512(%esp),%xmm0

# qhasm:   uint32323232 z9 += orig9
# asm 1: paddd <orig9=stack128#32,<z9=int6464#2
# asm 2: paddd <orig9=528(%esp),<z9=%xmm1
paddd 528(%esp),%xmm1
...
# asm 1: paddd <orig11=stack128#14,<z11=int6464#4
# asm 2: paddd <orig11=240(%esp),<z11=%xmm3
paddd 240(%esp),%xmm3
...
# qhasm:   z12 = z12_stack
# asm 1: movdqa <z12_stack=stack128#11,>z12=int6464#1
# asm 2: movdqa <z12_stack=192(%esp),>z12=%xmm0
movdqa 192(%esp),%xmm0

# qhasm:   z13 = z13_stack
# asm 1: movdqa <z13_stack=stack128#18,>z13=int6464#2
# asm 2: movdqa <z13_stack=304(%esp),>z13=%xmm1
movdqa 304(%esp),%xmm1
...
# qhasm:   z15 = z15_stack
# asm 1: movdqa <z15_stack=stack128#3,>z15=int6464#4
# asm 2: movdqa <z15_stack=64(%esp),>z15=%xmm3
movdqa 64(%esp),%xmm3
...
# asm 1: paddd <orig13=stack128#21,<z13=int6464#2
# asm 2: paddd <orig13=352(%esp),<z13=%xmm1
paddd 352(%esp),%xmm1

# qhasm:   uint32323232 z14 += orig14
# asm 1: paddd <orig14=stack128#27,<z14=int6464#3
# asm 2: paddd <orig14=448(%esp),<z14=%xmm2
paddd 448(%esp),%xmm2
...
# asm 2: leal <tmp=608(%esp),>out=%edi
leal 608(%esp),%edi
