...
# qhasm: c = x4
# asm 1: movl <x4=stack32#31,>c=int32#4
# asm 2: movl <x4=120(%esp),>c=%ebx
movl 120(%esp),%ebx

# qhasm: 		r = x1
# asm 1: movl <x1=stack32#28,>r=int32#5
# asm 2: movl <x1=108(%esp),>r=%esi
movl 108(%esp),%esi
...
# qhasm: d = x8
# asm 1: movl <x8=stack32#35,>d=int32#6
# asm 2: movl <x8=136(%esp),>d=%edi
movl 136(%esp),%edi
...
# asm 2: movl <x5=124(%esp),>s=%ebp
movl 124(%esp),%ebp

# qhasm: x8 = d
# asm 1: movl <d=int32#6,>x8=stack32#28
# asm 2: movl <d=%edi,>x8=108(%esp)
movl %edi,108(%esp)
...
# asm 2: movl <t=%ebx,>x9=124(%esp)
movl %ebx,124(%esp)

# qhasm: 		u = x13
# asm 1: movl <x13=stack32#40,>u=int32#6
# asm 2: movl <x13=156(%esp),>u=%edi
movl 156(%esp),%edi
...
# asm 2: movl <b=%edx,>x0=128(%esp)
movl %edx,128(%esp)

# qhasm: 				b = x10
# asm 1: movl <x10=stack32#37,>b=int32#3
# asm 2: movl <x10=144(%esp),>b=%edx
movl 144(%esp),%edx
...
# asm 2: movl <x14=160(%esp),>c=%ebx
movl 160(%esp),%ebx

# qhasm: 		x1 = r
# asm 1: movl <r=int32#5,>x1=stack32#36
# asm 2: movl <r=%esi,>x1=140(%esp)
movl %esi,140(%esp)
...
# asm 2: movl <c=%ebx,>x14=144(%esp)
movl %ebx,144(%esp)

# qhasm: 				d = x2
# asm 1: movl <x2=stack32#29,>d=int32#6
# asm 2: movl <x2=112(%esp),>d=%edi
movl 112(%esp),%edi
...
# asm 2: movl <d=%edi,>x2=112(%esp)
movl %edi,112(%esp)

# qhasm: 						r = x11
# asm 1: movl <x11=stack32#38,>r=int32#5
# asm 2: movl <x11=148(%esp),>r=%esi
movl 148(%esp),%esi

# qhasm: 		x5 = s
# asm 1: movl <s=int32#7,>x5=stack32#38
# asm 2: movl <s=%ebp,>x5=148(%esp)
movl %ebp,148(%esp)

# qhasm: 						s = x15
# asm 1: movl <x15=stack32#42,>s=int32#7
# asm 2: movl <x15=164(%esp),>s=%ebp
movl 164(%esp),%ebp
...
# asm 2: movl <b=%edx,>x10=152(%esp)
movl %edx,152(%esp)

# qhasm: b = x0
# asm 1: movl <x0=stack32#33,>b=int32#3
# asm 2: movl <x0=128(%esp),>b=%edx
movl 128(%esp),%edx
...
# asm 2: movl <x1=140(%esp),>c=%ebx
movl 140(%esp),%ebx

# qhasm: 						x11 = r
# asm 1: movl <r=int32#5,>x11=stack32#33
# asm 2: movl <r=%esi,>x11=128(%esp)
movl %esi,128(%esp)
...
# qhasm: 		s = x5
# asm 1: movl <x5=stack32#38,>s=int32#7
# asm 2: movl <x5=148(%esp),>s=%ebp
movl 148(%esp),%ebp
...
# qhasm: 				b = x10
# asm 1: movl <x10=stack32#39,>b=int32#3
# asm 2: movl <x10=152(%esp),>b=%edx
movl 152(%esp),%edx
...
# asm 2: movl <x11=128(%esp),>c=%ebx
movl 128(%esp),%ebx

# qhasm: 		x4 = r
# asm 1: movl <r=int32#5,>x4=stack32#33
# asm 2: movl <r=%esi,>x4=128(%esp)
movl %esi,128(%esp)
...
# asm 2: movl <c=%ebx,>x11=152(%esp)
movl %ebx,152(%esp)

# qhasm: 				d = x8
# asm 1: movl <x8=stack32#28,>d=int32#6
# asm 2: movl <x8=108(%esp),>d=%edi
movl 108(%esp),%edi
...
# qhasm: 						r = x14
# asm 1: movl <x14=stack32#37,>r=int32#5
# asm 2: movl <x14=144(%esp),>r=%esi
movl 144(%esp),%esi

# qhasm: 		x5 = s
# asm 1: movl <s=int32#7,>x5=stack32#37
# asm 2: movl <s=%ebp,>x5=144(%esp)
movl %ebp,144(%esp)
...
# asm 2: movl <x4=128(%esp),>c=%ebx
movl 128(%esp),%ebx

# qhasm: 						x14 = r
# asm 1: movl <r=int32#5,>x14=stack32#32
# asm 2: movl <r=%esi,>x14=124(%esp)
movl %esi,124(%esp)
...
# asm 2: movl <x1=140(%esp),>r=%edi
movl 140(%esp),%edi

# qhasm: 						x15 = s
# asm 1: movl <s=int32#7,>x15=stack32#28
# asm 2: movl <s=%ebp,>x15=108(%esp)
movl %ebp,108(%esp)

# qhasm: 		s = x5
# asm 1: movl <x5=stack32#37,>s=int32#7
# asm 2: movl <x5=144(%esp),>s=%ebp
movl 144(%esp),%ebp

# qhasm: x8 = d
# asm 1: movl <d=int32#5,>x8=stack32#36
# asm 2: movl <d=%esi,>x8=140(%esp)
movl %esi,140(%esp)
...
# qhasm: 				b = x10
# asm 1: movl <x10=stack32#35,>b=int32#3
# asm 2: movl <x10=136(%esp),>b=%edx
movl 136(%esp),%edx
...
# asm 2: movl <x14=124(%esp),>c=%ebx
movl 124(%esp),%ebx

# qhasm: 		x1 = r
# asm 1: movl <r=int32#6,>x1=stack32#32
# asm 2: movl <r=%edi,>x1=124(%esp)
movl %edi,124(%esp)
...
# asm 2: movl <c=%ebx,>x14=160(%esp)
movl %ebx,160(%esp)

# qhasm: 				d = x2
# asm 1: movl <x2=stack32#29,>d=int32#5
# asm 2: movl <x2=112(%esp),>d=%esi
movl 112(%esp),%esi
...
# asm 2: movl <d=%esi,>x2=112(%esp)
movl %esi,112(%esp)

# qhasm: 						r = x11
# asm 1: movl <x11=stack32#39,>r=int32#6
# asm 2: movl <x11=152(%esp),>r=%edi
movl 152(%esp),%edi

# qhasm: 		x5 = s
# asm 1: movl <s=int32#7,>x5=stack32#35
# asm 2: movl <s=%ebp,>x5=136(%esp)
movl %ebp,136(%esp)

# qhasm: 						s = x15
# asm 1: movl <x15=stack32#28,>s=int32#7
# asm 2: movl <x15=108(%esp),>s=%ebp
movl 108(%esp),%ebp
...
# asm 2: movl <x1=124(%esp),>c=%ebx
movl 124(%esp),%ebx

# qhasm: 						x11 = r
# asm 1: movl <r=int32#6,>x11=stack32#31
# asm 2: movl <r=%edi,>x11=120(%esp)
movl %edi,120(%esp)
...
# qhasm: 		r = x4
# asm 1: movl <x4=stack32#33,>r=int32#6
# asm 2: movl <x4=128(%esp),>r=%edi
movl 128(%esp),%edi

# qhasm: 						x15 = s
# asm 1: movl <s=int32#7,>x15=stack32#39
# asm 2: movl <s=%ebp,>x15=152(%esp)
movl %ebp,152(%esp)

# qhasm: 		s = x5
# asm 1: movl <x5=stack32#35,>s=int32#7
# asm 2: movl <x5=136(%esp),>s=%ebp
movl 136(%esp),%ebp
...
# qhasm: 				b = x10
# asm 1: movl <x10=stack32#38,>b=int32#3
# asm 2: movl <x10=148(%esp),>b=%edx
movl 148(%esp),%edx
...
# asm 2: movl <c=%ebx,>x11=148(%esp)
movl %ebx,148(%esp)

# qhasm: 				d = x8
# asm 1: movl <x8=stack32#36,>d=int32#5
# asm 2: movl <x8=140(%esp),>d=%esi
movl 140(%esp),%esi
...
# asm 2: movl <d=%esi,>x8=136(%esp)
movl %esi,136(%esp)

# qhasm: 						r = x14
# asm 1: movl <x14=stack32#41,>r=int32#6
# asm 2: movl <x14=160(%esp),>r=%edi
movl 160(%esp),%edi

# qhasm: 		x5 = s
# asm 1: movl <s=int32#7,>x5=stack32#32
# asm 2: movl <s=%ebp,>x5=124(%esp)
movl %ebp,124(%esp)

# qhasm: 						s = x15
# asm 1: movl <x15=stack32#39,>s=int32#7
# asm 2: movl <x15=152(%esp),>s=%ebp
movl 152(%esp),%ebp
...
# asm 2: movl <t=%ebx,>x12=152(%esp)
movl %ebx,152(%esp)

# qhasm: 						u = x13
# asm 1: movl <x13=stack32#40,>u=int32#5
# asm 2: movl <x13=156(%esp),>u=%esi
movl 156(%esp),%esi
