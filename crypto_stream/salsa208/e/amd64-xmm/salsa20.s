...
# qhasm:             	a0 = diag1 <<< 0
# asm 1: pshufd $0xe4,<diag1=int6464#2,>a0=int6464#5
# asm 2: pshufd $0xe4,<diag1=%xmm1,>a0=%xmm4
pshufd $0xe4,%xmm1,%xmm4

# qhasm:             	b0 = 0
# asm 1: pxor   >b0=int6464#6,>b0=int6464#6
# asm 2: pxor   >b0=%xmm5,>b0=%xmm5
pxor   %xmm5,%xmm5
...
# qhasm: 				a1 = diag0 <<< 0
# asm 1: pshufd $0xe4,<diag0=int6464#1,>a1=int6464#7
# asm 2: pshufd $0xe4,<diag0=%xmm0,>a1=%xmm6
pshufd $0xe4,%xmm0,%xmm6

# qhasm: uint32323232	b0 += a0
# asm 1: paddd <a0=int6464#5,<b0=int6464#6
# asm 2: paddd <a0=%xmm4,<b0=%xmm5
paddd %xmm4,%xmm5
...
# qhasm: 				b1 = 0
# asm 1: pxor   >b1=int6464#8,>b1=int6464#8
# asm 2: pxor   >b1=%xmm7,>b1=%xmm7
pxor   %xmm7,%xmm7

# qhasm: uint32323232	b0 >>= 25
# asm 1: psrld $25,<b0=int6464#6
# asm 2: psrld $25,<b0=%xmm5
psrld $25,%xmm5
...
# qhasm:                 diag3 ^= b0
# asm 1: pxor  <b0=int6464#6,<diag3=int6464#4
# asm 2: pxor  <b0=%xmm5,<diag3=%xmm3
pxor  %xmm5,%xmm3

# qhasm: uint32323232			a1 += diag3
# asm 1: paddd <diag3=int6464#4,<a1=int6464#7
# asm 2: paddd <diag3=%xmm3,<a1=%xmm6
paddd %xmm3,%xmm6

# qhasm: 						a2 = diag3 <<< 0
# asm 1: pshufd $0xe4,<diag3=int6464#4,>a2=int6464#5
# asm 2: pshufd $0xe4,<diag3=%xmm3,>a2=%xmm4
pshufd $0xe4,%xmm3,%xmm4

# qhasm: uint32323232			b1 += a1
# asm 1: paddd <a1=int6464#7,<b1=int6464#8
# asm 2: paddd <a1=%xmm6,<b1=%xmm7
paddd %xmm6,%xmm7

# qhasm: uint32323232			a1 <<= 9
# asm 1: pslld $9,<a1=int6464#7
# asm 2: pslld $9,<a1=%xmm6
pslld $9,%xmm6

# qhasm: 						b2 = 0
# asm 1: pxor   >b2=int6464#6,>b2=int6464#6
# asm 2: pxor   >b2=%xmm5,>b2=%xmm5
pxor   %xmm5,%xmm5

# qhasm: uint32323232			b1 >>= 23
# asm 1: psrld $23,<b1=int6464#8
# asm 2: psrld $23,<b1=%xmm7
psrld $23,%xmm7

# qhasm: 				diag2 ^= a1
# asm 1: pxor  <a1=int6464#7,<diag2=int6464#3
# asm 2: pxor  <a1=%xmm6,<diag2=%xmm2
pxor  %xmm6,%xmm2
...
# qhasm: 				diag2 ^= b1
# asm 1: pxor  <b1=int6464#8,<diag2=int6464#3
# asm 2: pxor  <b1=%xmm7,<diag2=%xmm2
pxor  %xmm7,%xmm2
...
# qhasm: 								a3 = diag2 <<< 0
# asm 1: pshufd $0xe4,<diag2=int6464#3,>a3=int6464#7
# asm 2: pshufd $0xe4,<diag2=%xmm2,>a3=%xmm6
pshufd $0xe4,%xmm2,%xmm6

# qhasm: uint32323232					b2 += a2
# asm 1: paddd <a2=int6464#5,<b2=int6464#6
# asm 2: paddd <a2=%xmm4,<b2=%xmm5
paddd %xmm4,%xmm5
...
# qhasm: 								b3 = 0
# asm 1: pxor   >b3=int6464#8,>b3=int6464#8
# asm 2: pxor   >b3=%xmm7,>b3=%xmm7
pxor   %xmm7,%xmm7

# qhasm: uint32323232					b2 >>= 19
# asm 1: psrld $19,<b2=int6464#6
# asm 2: psrld $19,<b2=%xmm5
psrld $19,%xmm5
...
# qhasm: 						diag1 ^= b2
# asm 1: pxor  <b2=int6464#6,<diag1=int6464#2
# asm 2: pxor  <b2=%xmm5,<diag1=%xmm1
pxor  %xmm5,%xmm1

# qhasm: uint32323232							a3 += diag1
# asm 1: paddd <diag1=int6464#2,<a3=int6464#7
# asm 2: paddd <diag1=%xmm1,<a3=%xmm6
paddd %xmm1,%xmm6

# qhasm: 		a4 = diag3 <<< 0
# asm 1: pshufd $0xe4,<diag3=int6464#4,>a4=int6464#5
# asm 2: pshufd $0xe4,<diag3=%xmm3,>a4=%xmm4
pshufd $0xe4,%xmm3,%xmm4

# qhasm: uint32323232							b3 += a3
# asm 1: paddd <a3=int6464#7,<b3=int6464#8
# asm 2: paddd <a3=%xmm6,<b3=%xmm7
paddd %xmm6,%xmm7

# qhasm: uint32323232							a3 <<= 18
# asm 1: pslld $18,<a3=int6464#7
# asm 2: pslld $18,<a3=%xmm6
pslld $18,%xmm6

# qhasm: 		b4 = 0
# asm 1: pxor   >b4=int6464#6,>b4=int6464#6
# asm 2: pxor   >b4=%xmm5,>b4=%xmm5
pxor   %xmm5,%xmm5

# qhasm: uint32323232							b3 >>= 14
# asm 1: psrld $14,<b3=int6464#8
# asm 2: psrld $14,<b3=%xmm7
psrld $14,%xmm7

# qhasm: 								diag0 ^= a3
# asm 1: pxor  <a3=int6464#7,<diag0=int6464#1
# asm 2: pxor  <a3=%xmm6,<diag0=%xmm0
pxor  %xmm6,%xmm0
...
# qhasm: 								diag0 ^= b3
# asm 1: pxor  <b3=int6464#8,<diag0=int6464#1
# asm 2: pxor  <b3=%xmm7,<diag0=%xmm0
pxor  %xmm7,%xmm0
...
# qhasm: 				a5 = diag0 <<< 0
# asm 1: pshufd $0xe4,<diag0=int6464#1,>a5=int6464#7
# asm 2: pshufd $0xe4,<diag0=%xmm0,>a5=%xmm6
pshufd $0xe4,%xmm0,%xmm6

# qhasm: uint32323232	b4 += a4
# asm 1: paddd <a4=int6464#5,<b4=int6464#6
# asm 2: paddd <a4=%xmm4,<b4=%xmm5
paddd %xmm4,%xmm5
...
# qhasm: 				b5 = 0
# asm 1: pxor   >b5=int6464#8,>b5=int6464#8
# asm 2: pxor   >b5=%xmm7,>b5=%xmm7
pxor   %xmm7,%xmm7

# qhasm: uint32323232	b4 >>= 25
# asm 1: psrld $25,<b4=int6464#6
# asm 2: psrld $25,<b4=%xmm5
psrld $25,%xmm5
...
# qhasm:                 diag1 ^= b4
# asm 1: pxor  <b4=int6464#6,<diag1=int6464#2
# asm 2: pxor  <b4=%xmm5,<diag1=%xmm1
pxor  %xmm5,%xmm1

# qhasm: uint32323232			a5 += diag1
# asm 1: paddd <diag1=int6464#2,<a5=int6464#7
# asm 2: paddd <diag1=%xmm1,<a5=%xmm6
paddd %xmm1,%xmm6

# qhasm: 						a6 = diag1 <<< 0
# asm 1: pshufd $0xe4,<diag1=int6464#2,>a6=int6464#5
# asm 2: pshufd $0xe4,<diag1=%xmm1,>a6=%xmm4
pshufd $0xe4,%xmm1,%xmm4

# qhasm: uint32323232			b5 += a5
# asm 1: paddd <a5=int6464#7,<b5=int6464#8
# asm 2: paddd <a5=%xmm6,<b5=%xmm7
paddd %xmm6,%xmm7

# qhasm: uint32323232			a5 <<= 9
# asm 1: pslld $9,<a5=int6464#7
# asm 2: pslld $9,<a5=%xmm6
pslld $9,%xmm6

# qhasm: 						b6 = 0
# asm 1: pxor   >b6=int6464#6,>b6=int6464#6
# asm 2: pxor   >b6=%xmm5,>b6=%xmm5
pxor   %xmm5,%xmm5

# qhasm: uint32323232			b5 >>= 23
# asm 1: psrld $23,<b5=int6464#8
# asm 2: psrld $23,<b5=%xmm7
psrld $23,%xmm7

# qhasm: 				diag2 ^= a5
# asm 1: pxor  <a5=int6464#7,<diag2=int6464#3
# asm 2: pxor  <a5=%xmm6,<diag2=%xmm2
pxor  %xmm6,%xmm2
...
# qhasm: 				diag2 ^= b5
# asm 1: pxor  <b5=int6464#8,<diag2=int6464#3
# asm 2: pxor  <b5=%xmm7,<diag2=%xmm2
pxor  %xmm7,%xmm2
...
# qhasm: 								a7 = diag2 <<< 0
# asm 1: pshufd $0xe4,<diag2=int6464#3,>a7=int6464#7
# asm 2: pshufd $0xe4,<diag2=%xmm2,>a7=%xmm6
pshufd $0xe4,%xmm2,%xmm6

# qhasm: uint32323232					b6 += a6
# asm 1: paddd <a6=int6464#5,<b6=int6464#6
# asm 2: paddd <a6=%xmm4,<b6=%xmm5
paddd %xmm4,%xmm5
...
# qhasm: 								b7 = 0
# asm 1: pxor   >b7=int6464#8,>b7=int6464#8
# asm 2: pxor   >b7=%xmm7,>b7=%xmm7
pxor   %xmm7,%xmm7

# qhasm: uint32323232					b6 >>= 19
# asm 1: psrld $19,<b6=int6464#6
# asm 2: psrld $19,<b6=%xmm5
psrld $19,%xmm5
...
# qhasm: 						diag3 ^= b6
# asm 1: pxor  <b6=int6464#6,<diag3=int6464#4
# asm 2: pxor  <b6=%xmm5,<diag3=%xmm3
pxor  %xmm5,%xmm3

# qhasm: uint32323232							a7 += diag3
# asm 1: paddd <diag3=int6464#4,<a7=int6464#7
# asm 2: paddd <diag3=%xmm3,<a7=%xmm6
paddd %xmm3,%xmm6
...
# qhasm: uint32323232							b7 += a7
# asm 1: paddd <a7=int6464#7,<b7=int6464#8
# asm 2: paddd <a7=%xmm6,<b7=%xmm7
paddd %xmm6,%xmm7

# qhasm: uint32323232							a7 <<= 18
# asm 1: pslld $18,<a7=int6464#7
# asm 2: pslld $18,<a7=%xmm6
pslld $18,%xmm6
...
# asm 1: psrld $14,<b7=int6464#8
# asm 2: psrld $14,<b7=%xmm7
psrld $14,%xmm7

# qhasm: 								diag0 ^= a7
# asm 1: pxor  <a7=int6464#7,<diag0=int6464#1
# asm 2: pxor  <a7=%xmm6,<diag0=%xmm0
pxor  %xmm6,%xmm0
...
# qhasm: 								diag0 ^= b7
# asm 1: pxor  <b7=int6464#8,<diag0=int6464#1
# asm 2: pxor  <b7=%xmm7,<diag0=%xmm0
pxor  %xmm7,%xmm0
