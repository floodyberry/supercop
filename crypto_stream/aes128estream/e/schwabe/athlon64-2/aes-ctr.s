...
# asm 1: movl   2(<table=int64#9,<p03=int64#1,8),>z3=int64#10d
# asm 2: movl   2(<table=%r11,<p03=%rdi,8),>z3=%r12d
movl   2(%r11,%rdi,8),%r12d
...
# asm 1: movl   1(<table=int64#9,<p02=int64#1,8),>z2=int64#11d
# asm 2: movl   1(<table=%r11,<p02=%rdi,8),>z2=%r13d
movl   1(%r11,%rdi,8),%r13d
...
# asm 1: movl   4(<table=int64#9,<p01=int64#1,8),>z1=int64#12d
# asm 2: movl   4(<table=%r11,<p01=%rdi,8),>z1=%r14d
movl   4(%r11,%rdi,8),%r14d
...
# asm 1: xorl 3(<table=int64#9,<p10=int64#1,8),<z1=int64#12d
# asm 2: xorl 3(<table=%r11,<p10=%rdi,8),<z1=%r14d
...
# asm 1: movl   2(<table=int64#9,<p11=int64#1,8),>z0=int64#13d
# asm 2: movl   2(<table=%r11,<p11=%rdi,8),>z0=%r15d
...
# asm 1: xorl 1(<table=int64#9,<p12=int64#1,8),<z3=int64#10d
# asm 2: xorl 1(<table=%r11,<p12=%rdi,8),<z3=%r12d
...
# asm 1: xorl 4(<table=int64#9,<p13=int64#1,8),<z2=int64#11d
# asm 2: xorl 4(<table=%r11,<p13=%rdi,8),<z2=%r13d
...
# asm 1: xorl 3(<table=int64#9,<p20=int64#1,8),<z2=int64#11d
# asm 2: xorl 3(<table=%r11,<p20=%rdi,8),<z2=%r13d
...
# asm 1: xorl 2(<table=int64#9,<p21=int64#1,8),<z1=int64#12d
# asm 2: xorl 2(<table=%r11,<p21=%rdi,8),<z1=%r14d
...
# asm 1: xorl 1(<table=int64#9,<p22=int64#1,8),<z0=int64#13d
# asm 2: xorl 1(<table=%r11,<p22=%rdi,8),<z0=%r15d
...
# asm 1: xorl 4(<table=int64#9,<p23=int64#1,8),<z3=int64#10d
# asm 2: xorl 4(<table=%r11,<p23=%rdi,8),<z3=%r12d
...
# asm 1: xorl 3(<table=int64#9,<p30=int64#1,8),<z3=int64#10d
# asm 2: xorl 3(<table=%r11,<p30=%rdi,8),<z3=%r12d
xorl 3(%r11,%rdi,8),%r12d
...
# asm 1: xorl 2(<table=int64#9,<p31=int64#1,8),<z2=int64#11d
# asm 2: xorl 2(<table=%r11,<p31=%rdi,8),<z2=%r13d
...
# asm 1: xorl 1(<table=int64#9,<p32=int64#1,8),<z1=int64#12d
# asm 2: xorl 1(<table=%r11,<p32=%rdi,8),<z1=%r14d
...
# asm 1: xorl 4(<table=int64#9,<p33=int64#1,8),<z0=int64#13d
# asm 2: xorl 4(<table=%r11,<p33=%rdi,8),<z0=%r15d
...
# qhasm:   y1 ^= z1
# asm 1: xor  <z1=int64#12,<y1=int64#3
# asm 2: xor  <z1=%r14,<y1=%rdx
xor  %r14,%rdx
...
# qhasm:   y2 ^= z2
# asm 1: xor  <z2=int64#11,<y2=int64#4
# asm 2: xor  <z2=%r13,<y2=%rcx
xor  %r13,%rcx
...
# qhasm:   y3 ^= z3
# asm 1: xor  <z3=int64#10,<y3=int64#7
# asm 2: xor  <z3=%r12,<y3=%rax
xor  %r12,%rax

# qhasm:   z0 ^= r4
# asm 1: xorq <r4=stack64#12,<z0=int64#13
# asm 2: xorq <r4=88(%rsp),<z0=%r15
xorq 88(%rsp),%r15

# qhasm:   pre10 = z0
# asm 1: movq <z0=int64#13,>pre10=stack64#56
# asm 2: movq <z0=%r15,>pre10=440(%rsp)
movq %r15,440(%rsp)
...
# asm 1: movl   3(<table=int64#9,<p10=int64#1,8),>z1=int64#10d
# asm 2: movl   3(<table=%r11,<p10=%rdi,8),>z1=%r12d
...
# qhasm:   z0 = *(uint32 *) (table + 2 + p11 * 8)
# asm 1: movl   2(<table=int64#9,<p11=int64#1,8),>z0=int64#11d
# asm 2: movl   2(<table=%r11,<p11=%rdi,8),>z0=%r13d
...
# asm 1: movl   1(<table=int64#9,<p12=int64#1,8),>z3=int64#12d
# asm 2: movl   1(<table=%r11,<p12=%rdi,8),>z3=%r14d
...
# qhasm:   (uint32) z1 ^= *(uint32 *) (table + 2 + p21 * 8)
# asm 1: xorl 2(<table=int64#9,<p21=int64#1,8),<z1=int64#10d
# asm 2: xorl 2(<table=%r11,<p21=%rdi,8),<z1=%r12d
...
# qhasm:   (uint32) z1 ^= *(uint32 *) (table + 1 + p32 * 8)
# asm 1: xorl 1(<table=int64#9,<p32=int64#1,8),<z1=int64#10d
# asm 2: xorl 1(<table=%r11,<p32=%rdi,8),<z1=%r12d
xorl 1(%r11,%rdi,8),%r12d
...
# qhasm:   z0 ^= r8
# asm 1: xorq <r8=stack64#16,<z0=int64#11
# asm 2: xorq <r8=120(%rsp),<z0=%r13
xorq 120(%rsp),%r13

# qhasm:   z1 ^= r9
# asm 1: xorq <r9=stack64#17,<z1=int64#10
# asm 2: xorq <r9=128(%rsp),<z1=%r12
xorq 128(%rsp),%r12

# qhasm:   z2 ^= r10
# asm 1: xorq <r10=stack64#18,<z2=int64#3
# asm 2: xorq <r10=136(%rsp),<z2=%rdx
xorq 136(%rsp),%rdx

# qhasm:   z3 ^= r11
# asm 1: xorq <r11=stack64#19,<z3=int64#12
# asm 2: xorq <r11=144(%rsp),<z3=%r14
xorq 144(%rsp),%r14

# qhasm:   pre20 = z0
# asm 1: movq <z0=int64#11,>pre20=stack64#57
# asm 2: movq <z0=%r13,>pre20=448(%rsp)
movq %r13,448(%rsp)

# qhasm:   pre21 = z1
# asm 1: movq <z1=int64#10,>pre21=stack64#58
# asm 2: movq <z1=%r12,>pre21=456(%rsp)
movq %r12,456(%rsp)

# qhasm:   pre22 = z2
# asm 1: movq <z2=int64#3,>pre22=stack64#59
# asm 2: movq <z2=%rdx,>pre22=464(%rsp)
movq %rdx,464(%rsp)

# qhasm:   pre23 = z3
# asm 1: movq <z3=int64#12,>pre23=stack64#60
# asm 2: movq <z3=%r14,>pre23=472(%rsp)
movq %r14,472(%rsp)
...
# qhasm:     z0 ^= pre10
# asm 1: xorq <pre10=stack64#56,<z0=int64#14
# asm 2: xorq <pre10=440(%rsp),<z0=%rbx
xorq 440(%rsp),%rbx
...
# qhasm:     y0 ^= pre20
# asm 1: xorq <pre20=stack64#57,<y0=int64#3
# asm 2: xorq <pre20=448(%rsp),<y0=%rdx
xorq 448(%rsp),%rdx

# qhasm:     y1 ^= pre21
# asm 1: xorq <pre21=stack64#58,<y1=int64#14
# asm 2: xorq <pre21=456(%rsp),<y1=%rbx
xorq 456(%rsp),%rbx

# qhasm:     y2 ^= pre22
# asm 1: xorq <pre22=stack64#59,<y2=int64#4
# asm 2: xorq <pre22=464(%rsp),<y2=%rcx
xorq 464(%rsp),%rcx

# qhasm:     y3 ^= pre23
# asm 1: xorq <pre23=stack64#60,<y3=int64#7
# asm 2: xorq <pre23=472(%rsp),<y3=%rax
xorq 472(%rsp),%rax
...
# asm 2: movq <r21=224(%rsp),>y1=%rdx
movq 224(%rsp),%rdx

# qhasm:   y2 = r22
# asm 1: movq <r22=stack64#30,>y2=int64#4
# asm 2: movq <r22=232(%rsp),>y2=%rcx
movq 232(%rsp),%rcx
...
# asm 1: movl   2048(<table=int64#9,<z2=int64#1,8),>z2=int64#12d
# asm 2: movl   2048(<table=%r11,<z2=%rdi,8),>z2=%r14d
movl   2048(%r11,%rdi,8),%r14d
...
# asm 1: movl   2052(<table=int64#9,<z1=int64#1,8),>z1=int64#13d
# asm 2: movl   2052(<table=%r11,<z1=%rdi,8),>z1=%r15d
movl   2052(%r11,%rdi,8),%r15d
...
# qhasm:   check = y0 & 255
# asm 1: movzbl  <y0=int64#14b,>check=int64#1d
# asm 2: movzbl  <y0=%bl,>check=%edi
movzbl  %bl,%edi
...
# qhasm:   =? check - 0
# asm 1: cmp  $0,<check=int64#1
# asm 2: cmp  $0,<check=%rdi
cmp  $0,%rdi
# comment:fp stack unchanged by jump

# qhasm:   goto after_precompute if !=
jne ._after_precompute
# comment:fp stack unchanged by jump
