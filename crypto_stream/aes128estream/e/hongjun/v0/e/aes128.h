...
/*
    ...
    printf("%8x  %8x  %8x  %8x",((u32*)output)[0],((u32*)output)[1],((u32*)output)[2],((u32*)output)[3]); \
}
*/


void aes128_enc_block(u32* x,u8* output, ECRYPT_ctx* ctx) {
	u32 y0,y1,y2,y3;
	u32 z0,z1,z2,z3;
	u32 a0,a1,a2,a3;
	u32 b0,b1,b2,b3;
	...
	last_round(ctx,y0,y1,y2,y3,output,10);
}
