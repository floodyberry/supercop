...
# qhasm: int3232 x0_save

# qhasm: int3232 x1_save

# qhasm: int3232 x2_save

# qhasm: int3232 x3_save
...
# qhasm: x0_save = *(uint32 *) (c + 0)
# asm 1: movd 0(<c=int64#2),>x0_save=int3232#1
# asm 2: movd 0(<c=%rsi),>x0_save=%mm0
movd 0(%rsi),%mm0

# qhasm: x1_save = *(uint32 *) (c + 4)
# asm 1: movd 4(<c=int64#2),>x1_save=int3232#2
# asm 2: movd 4(<c=%rsi),>x1_save=%mm1
movd 4(%rsi),%mm1

# qhasm: x2_save = *(uint32 *) (c + 8)
# asm 1: movd 8(<c=int64#2),>x2_save=int3232#3
# asm 2: movd 8(<c=%rsi),>x2_save=%mm2
movd 8(%rsi),%mm2

# qhasm: x3_save = *(uint32 *) (c + 12)
# asm 1: movd 12(<c=int64#2),>x3_save=int3232#4
# asm 2: movd 12(<c=%rsi),>x3_save=%mm3
movd 12(%rsi),%mm3

# qhasm: x0_save = *(uint32 *) (c + 16)
# asm 1: movd 16(<c=int64#2),>x0_save=int3232#5
# asm 2: movd 16(<c=%rsi),>x0_save=%mm4
movd 16(%rsi),%mm4

# qhasm: x1_save ^= x0_save
# asm 1: pxor  <x0_save=int3232#5,<x1_save=int3232#2
# asm 2: pxor  <x0_save=%mm4,<x1_save=%mm1
pxor  %mm4,%mm1

# qhasm: x2_save ^= x1_save
# asm 1: pxor  <x1_save=int3232#2,<x2_save=int3232#3
# asm 2: pxor  <x1_save=%mm1,<x2_save=%mm2
pxor  %mm1,%mm2

# qhasm: x3_save ^= x2_save
# asm 1: pxor  <x2_save=int3232#3,<x3_save=int3232#4
# asm 2: pxor  <x2_save=%mm2,<x3_save=%mm3
pxor  %mm2,%mm3

# qhasm: r0 = x0_save
# asm 1: movd <x0_save=int3232#5,>r0=stack64#8
# asm 2: movd <x0_save=%mm4,>r0=56(%rsp)
movd %mm4,56(%rsp)

# qhasm: r1 = x1_save
# asm 1: movd <x1_save=int3232#2,>r1=stack64#9
# asm 2: movd <x1_save=%mm1,>r1=64(%rsp)
movd %mm1,64(%rsp)

# qhasm: r2 = x2_save
# asm 1: movd <x2_save=int3232#3,>r2=stack64#10
# asm 2: movd <x2_save=%mm2,>r2=72(%rsp)
movd %mm2,72(%rsp)

# qhasm: r3 = x3_save
# asm 1: movd <x3_save=int3232#4,>r3=stack64#11
# asm 2: movd <x3_save=%mm3,>r3=80(%rsp)
movd %mm3,80(%rsp)
...
# qhasm:   mmx0 = x0_save 
# asm 1: movq <x0_save=int3232#5,>mmx0=int3232#1
# asm 2: movq <x0_save=%mm4,>mmx0=%mm0
movq %mm4,%mm0

# qhasm:   mmx1 = x1_save
# asm 1: movq <x1_save=int3232#2,>mmx1=int3232#6
# asm 2: movq <x1_save=%mm1,>mmx1=%mm5
movq %mm1,%mm5

# qhasm:   mmx2 = x2_save 
# asm 1: movq <x2_save=int3232#3,>mmx2=int3232#7
# asm 2: movq <x2_save=%mm2,>mmx2=%mm6
movq %mm2,%mm6

# qhasm:   mmx3 = x3_save 
# asm 1: movq <x3_save=int3232#4,>mmx3=int3232#8
# asm 2: movq <x3_save=%mm3,>mmx3=%mm7
movq %mm3,%mm7
...
# qhasm:   x0 = mmx0
# asm 1: movd <mmx0=int3232#1,>x0=int64#1
# asm 2: movd <mmx0=%mm0,>x0=%rdi
movd %mm0,%rdi

# qhasm:   x1 = mmx1
# asm 1: movd <mmx1=int3232#6,>x1=int64#3
# asm 2: movd <mmx1=%mm5,>x1=%rdx
movd %mm5,%rdx

# qhasm:   x2 = mmx2
# asm 1: movd <mmx2=int3232#7,>x2=int64#4
# asm 2: movd <mmx2=%mm6,>x2=%rcx
movd %mm6,%rcx

# qhasm:   x3 = mmx3
# asm 1: movd <mmx3=int3232#8,>x3=int64#7
# asm 2: movd <mmx3=%mm7,>x3=%rax
movd %mm7,%rax

# qhasm:   y0 = x0
# asm 1: mov  <x0=int64#1,>y0=int64#14
# asm 2: mov  <x0=%rdi,>y0=%rbx
mov  %rdi,%rbx
...
# qhasm:   y1 = x1
# asm 1: mov  <x1=int64#3,>y1=int64#3
# asm 2: mov  <x1=%rdx,>y1=%rdx
mov  %rdx,%rdx
...
# qhasm:   y2 = x2
# asm 1: mov  <x2=int64#4,>y2=int64#4
# asm 2: mov  <x2=%rcx,>y2=%rcx
mov  %rcx,%rcx
...
# qhasm:   y3 = x3
# asm 1: mov  <x3=int64#7,>y3=int64#7
# asm 2: mov  <x3=%rax,>y3=%rax
mov  %rax,%rax
...
# qhasm:   mmx0 = *(uint32 *) (c + 20)
# asm 1: movd 20(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 20(<c=%rsi),>mmx0=%mm0
movd 20(%rsi),%mm0

# qhasm:   mmx1 ^= mmx0
# asm 1: pxor  <mmx0=int3232#1,<mmx1=int3232#6
# asm 2: pxor  <mmx0=%mm0,<mmx1=%mm5
pxor  %mm0,%mm5

# qhasm:   mmx2 ^= mmx1
# asm 1: pxor  <mmx1=int3232#6,<mmx2=int3232#7
# asm 2: pxor  <mmx1=%mm5,<mmx2=%mm6
pxor  %mm5,%mm6

# qhasm:   mmx3 ^= mmx2
# asm 1: pxor  <mmx2=int3232#7,<mmx3=int3232#8
# asm 2: pxor  <mmx2=%mm6,<mmx3=%mm7
pxor  %mm6,%mm7
...
# qhasm:   mmx0 = *(uint32 *) (c + 24)
# asm 1: movd 24(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 24(<c=%rsi),>mmx0=%mm0
movd 24(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 28)
# asm 1: movd 28(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 28(<c=%rsi),>mmx0=%mm0
movd 28(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 32)
# asm 1: movd 32(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 32(<c=%rsi),>mmx0=%mm0
movd 32(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 36)
# asm 1: movd 36(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 36(<c=%rsi),>mmx0=%mm0
movd 36(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 40)
# asm 1: movd 40(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 40(<c=%rsi),>mmx0=%mm0
movd 40(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 44)
# asm 1: movd 44(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 44(<c=%rsi),>mmx0=%mm0
movd 44(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 48)
# asm 1: movd 48(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 48(<c=%rsi),>mmx0=%mm0
movd 48(%rsi),%mm0
...
# qhasm:   mmx0 = *(uint32 *) (c + 52)
# asm 1: movd 52(<c=int64#2),>mmx0=int3232#1
# asm 2: movd 52(<c=%rsi),>mmx0=%mm0
movd 52(%rsi),%mm0
...
# asm 2: movq <in=%r9,>in_stack=56(%rsp)
movq %r9,56(%rsp)

# qhasm: out_stack = out
# asm 1: movq <out=int64#8,>out_stack=stack64#10
# asm 2: movq <out=%r10,>out_stack=72(%rsp)
movq %r10,72(%rsp)

# qhasm: len_stack = len
# asm 1: movq <len=int64#5,>len_stack=stack64#9
# asm 2: movq <len=%r8,>len_stack=64(%rsp)
movq %r8,64(%rsp)
...
# asm 2: leaq <stream=96(%rsp),>in=%r9
leaq 96(%rsp),%r9
