...
# qhasm: i12 = x12
# asm 1: movl <x12=stack32#39,>i12=int32#4
# asm 2: movl <x12=152(%esp),>i12=%ebx
movl 152(%esp),%ebx
...
# qhasm: i8 = x8
# asm 1: movl <x8=stack32#35,>i8=int32#5
# asm 2: movl <x8=136(%esp),>i8=%esi
movl 136(%esp),%esi
...
# qhasm: 		i1 = x1
# asm 1: movl <x1=stack32#28,>i1=int32#2
# asm 2: movl <x1=108(%esp),>i1=%ecx
movl 108(%esp),%ecx

# qhasm: 		i5 = x5
# asm 1: movl <x5=stack32#32,>i5=int32#6
# asm 2: movl <x5=124(%esp),>i5=%edi
movl 124(%esp),%edi
...
# qhasm: 		i13 = x13
# asm 1: movl <x13=stack32#40,>i13=int32#7
# asm 2: movl <x13=156(%esp),>i13=%ebp
movl 156(%esp),%ebp
...
# qhasm: x12 = i12
# asm 1: movl <i12=int32#4,>x12=stack32#28
# asm 2: movl <i12=%ebx,>x12=108(%esp)
movl %ebx,108(%esp)
...
# qhasm: 		i9 = x9
# asm 1: movl <x9=stack32#36,>i9=int32#4
# asm 2: movl <x9=140(%esp),>i9=%ebx
movl 140(%esp),%ebx
...
# qhasm: 		x1 = i1
# asm 1: movl <i1=int32#2,>x1=stack32#31
# asm 2: movl <i1=%ecx,>x1=120(%esp)
movl %ecx,120(%esp)
...
# qhasm: x8 = i8
# asm 1: movl <i8=int32#5,>x8=stack32#35
# asm 2: movl <i8=%esi,>x8=136(%esp)
movl %esi,136(%esp)
...
# qhasm: x4 = i4
# asm 1: movl <i4=int32#3,>x4=stack32#36
# asm 2: movl <i4=%edx,>x4=140(%esp)
movl %edx,140(%esp)

# qhasm: 				i2 = x2
# asm 1: movl <x2=stack32#29,>i2=int32#2
# asm 2: movl <x2=112(%esp),>i2=%ecx
movl 112(%esp),%ecx

# qhasm: 				i6 = x6
# asm 1: movl <x6=stack32#33,>i6=int32#3
# asm 2: movl <x6=128(%esp),>i6=%edx
movl 128(%esp),%edx
...
# qhasm: 				i14 = x14
# asm 1: movl <x14=stack32#41,>i14=int32#5
# asm 2: movl <x14=160(%esp),>i14=%esi
movl 160(%esp),%esi
...
# qhasm: 		x13 = i13
# asm 1: movl <i13=int32#7,>x13=stack32#29
# asm 2: movl <i13=%ebp,>x13=112(%esp)
movl %ebp,112(%esp)
...
# qhasm: 				i10 = x10
# asm 1: movl <x10=stack32#37,>i10=int32#7
# asm 2: movl <x10=144(%esp),>i10=%ebp
movl 144(%esp),%ebp
...
# qhasm: 				x2 = i2
# asm 1: movl <i2=int32#2,>x2=stack32#33
# asm 2: movl <i2=%ecx,>x2=128(%esp)
movl %ecx,128(%esp)
...
# qhasm: 		x9 = i9
# asm 1: movl <i9=int32#4,>x9=stack32#41
# asm 2: movl <i9=%ebx,>x9=160(%esp)
movl %ebx,160(%esp)
...
# qhasm: 		x5 = i5
# asm 1: movl <i5=int32#6,>x5=stack32#32
# asm 2: movl <i5=%edi,>x5=124(%esp)
movl %edi,124(%esp)

# qhasm: 						i3 = x3
# asm 1: movl <x3=stack32#30,>i3=int32#2
# asm 2: movl <x3=116(%esp),>i3=%ecx
movl 116(%esp),%ecx

# qhasm: 						i7 = x7
# asm 1: movl <x7=stack32#34,>i7=int32#4
# asm 2: movl <x7=132(%esp),>i7=%ebx
movl 132(%esp),%ebx
...
# qhasm: 						i15 = x15
# asm 1: movl <x15=stack32#42,>i15=int32#6
# asm 2: movl <x15=164(%esp),>i15=%edi
movl 164(%esp),%edi
...
# qhasm: 				x14 = i14
# asm 1: movl <i14=int32#5,>x14=stack32#30
# asm 2: movl <i14=%esi,>x14=116(%esp)
movl %esi,116(%esp)
...
# qhasm: 						i11 = x11
# asm 1: movl <x11=stack32#38,>i11=int32#5
# asm 2: movl <x11=148(%esp),>i11=%esi
movl 148(%esp),%esi
...
# qhasm: 						x11 = i11
# asm 1: movl <i11=int32#5,>x11=stack32#37
# asm 2: movl <i11=%esi,>x11=144(%esp)
movl %esi,144(%esp)
...
# qhasm: 						x7 = i7
# asm 1: movl <i7=int32#4,>x7=stack32#38
# asm 2: movl <i7=%ebx,>x7=148(%esp)
movl %ebx,148(%esp)

# qhasm: 				x10 = i10
# asm 1: movl <i10=int32#7,>x10=stack32#39
# asm 2: movl <i10=%ebp,>x10=152(%esp)
movl %ebp,152(%esp)
...
# qhasm: i5 = x5
# asm 1: movl <x5=stack32#32,>i5=int32#4
# asm 2: movl <x5=124(%esp),>i5=%ebx
movl 124(%esp),%ebx
...
# qhasm: i10 = x10
# asm 1: movl <x10=stack32#39,>i10=int32#5
# asm 2: movl <x10=152(%esp),>i10=%esi
movl 152(%esp),%esi
...
# qhasm: 		i1 = x1
# asm 1: movl <x1=stack32#31,>i1=int32#2
# asm 2: movl <x1=120(%esp),>i1=%ecx
movl 120(%esp),%ecx
...
# qhasm: 		i12 = x12
# asm 1: movl <x12=stack32#28,>i12=int32#7
# asm 2: movl <x12=108(%esp),>i12=%ebp
movl 108(%esp),%ebp
...
# qhasm: x15 = i15
# asm 1: movl <i15=int32#6,>x15=stack32#42
# asm 2: movl <i15=%edi,>x15=164(%esp)
movl %edi,164(%esp)
...
# qhasm: 		i11 = x11
# asm 1: movl <x11=stack32#37,>i11=int32#6
# asm 2: movl <x11=144(%esp),>i11=%edi
movl 144(%esp),%edi
...
# qhasm: 		x1 = i1
# asm 1: movl <i1=int32#2,>x1=stack32#28
# asm 2: movl <i1=%ecx,>x1=108(%esp)
movl %ecx,108(%esp)
...
# qhasm: x10 = i10
# asm 1: movl <i10=int32#5,>x10=stack32#37
# asm 2: movl <i10=%esi,>x10=144(%esp)
movl %esi,144(%esp)
...
# qhasm: x5 = i5
# asm 1: movl <i5=int32#4,>x5=stack32#32
# asm 2: movl <i5=%ebx,>x5=124(%esp)
movl %ebx,124(%esp)

# qhasm: 				i2 = x2
# asm 1: movl <x2=stack32#33,>i2=int32#2
# asm 2: movl <x2=128(%esp),>i2=%ecx
movl 128(%esp),%ecx

# qhasm: 				i7 = x7
# asm 1: movl <x7=stack32#38,>i7=int32#4
# asm 2: movl <x7=148(%esp),>i7=%ebx
movl 148(%esp),%ebx
...
# qhasm: 				i13 = x13
# asm 1: movl <x13=stack32#29,>i13=int32#5
# asm 2: movl <x13=112(%esp),>i13=%esi
movl 112(%esp),%esi
...
# qhasm: 		x12 = i12
# asm 1: movl <i12=int32#7,>x12=stack32#39
# asm 2: movl <i12=%ebp,>x12=152(%esp)
movl %ebp,152(%esp)
...
# qhasm: 				i8 = x8
# asm 1: movl <x8=stack32#35,>i8=int32#7
# asm 2: movl <x8=136(%esp),>i8=%ebp
movl 136(%esp),%ebp
...
# qhasm: 				x2 = i2
# asm 1: movl <i2=int32#2,>x2=stack32#29
# asm 2: movl <i2=%ecx,>x2=112(%esp)
movl %ecx,112(%esp)
...
# qhasm: 		x11 = i11
# asm 1: movl <i11=int32#6,>x11=stack32#38
# asm 2: movl <i11=%edi,>x11=148(%esp)
movl %edi,148(%esp)
...
# qhasm: 		x6 = i6
# asm 1: movl <i6=int32#3,>x6=stack32#33
# asm 2: movl <i6=%edx,>x6=128(%esp)
movl %edx,128(%esp)
...
# qhasm: 						i4 = x4
# asm 1: movl <x4=stack32#36,>i4=int32#3
# asm 2: movl <x4=140(%esp),>i4=%edx
movl 140(%esp),%edx
...
# qhasm: 						i14 = x14
# asm 1: movl <x14=stack32#30,>i14=int32#6
# asm 2: movl <x14=116(%esp),>i14=%edi
movl 116(%esp),%edi
...
# qhasm: 				x13 = i13
# asm 1: movl <i13=int32#5,>x13=stack32#40
# asm 2: movl <i13=%esi,>x13=156(%esp)
movl %esi,156(%esp)
...
# qhasm: 						i9 = x9
# asm 1: movl <x9=stack32#41,>i9=int32#5
# asm 2: movl <x9=160(%esp),>i9=%esi
movl 160(%esp),%esi
...
# qhasm: 						x3 = i3
# asm 1: movl <i3=int32#2,>x3=stack32#30
# asm 2: movl <i3=%ecx,>x3=116(%esp)
movl %ecx,116(%esp)
...
# qhasm: 						x14 = i14
# asm 1: movl <i14=int32#6,>x14=stack32#41
# asm 2: movl <i14=%edi,>x14=160(%esp)
movl %edi,160(%esp)
...
# qhasm: 				x8 = i8
# asm 1: movl <i8=int32#7,>x8=stack32#35
# asm 2: movl <i8=%ebp,>x8=136(%esp)
movl %ebp,136(%esp)
...
# qhasm: 				x7 = i7
# asm 1: movl <i7=int32#4,>x7=stack32#34
# asm 2: movl <i7=%ebx,>x7=132(%esp)
movl %ebx,132(%esp)

# qhasm: 						x9 = i9
# asm 1: movl <i9=int32#5,>x9=stack32#36
# asm 2: movl <i9=%esi,>x9=140(%esp)
movl %esi,140(%esp)
