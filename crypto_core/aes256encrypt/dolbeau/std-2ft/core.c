/*
  core.c version $Date: 2014/12/12 11:02:41 $
  aes256encrypt
  Romain Dolbeau
  Public Domain
*/
...
static inline void aes256_2ft_encrypt(const unsigned int *aes_edrk, const unsigned int *input, unsigned int *output)
{
...
int crypto_core(
  ...
  aes256_2ft_encrypt(rkeys, (const unsigned int*)in, (unsigned int*)out);
  return 0;
}
