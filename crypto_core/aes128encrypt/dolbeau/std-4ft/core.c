/*
  core.c version $Date: 2014/12/14 11:01:53 $
  aes128encrypt
  Romain Dolbeau
  Public Domain
*/
...
static inline void aes128_4ft_encrypt(const unsigned int *aes_edrk, const unsigned int *input, unsigned int *output)
{
...
int crypto_core(
  ...
  aes128_4ft_encrypt(rkeys, (const unsigned int*)in, (unsigned int*)out);
  return 0;
}
