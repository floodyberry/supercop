...
static inline void aes128_1ft_encrypt(const unsigned int *aes_edrk, const unsigned int *input, unsigned int *output)
{
...
int crypto_core(
  ...
  aes128_1ft_encrypt(rkeys, (const unsigned int*)in, (unsigned int*)out);
  return 0;
}
