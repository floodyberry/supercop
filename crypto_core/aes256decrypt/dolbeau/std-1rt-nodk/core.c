...
static inline void aes256_1rtnodk_decrypt(const unsigned int *aes_edrk, const unsigned int *input, unsigned int *output)
{
...
int crypto_core(
  ...
  aes256_1rtnodk_decrypt(rkeys, (const unsigned int*)in, (unsigned int*)out);
  return 0;
}
