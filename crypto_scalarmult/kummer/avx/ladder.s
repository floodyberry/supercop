...
# asm 2: leaq <const0_storage=0(%rsp),>const0=%rax
# bytes: 4 uops: 1
leaq 0(%rsp),%rax
...
# asm 2: leaq <const1_storage=256(%rsp),>const1=%r10
# bytes: 8 uops: 1
leaq 256(%rsp),%r10
...
# asm 2: leaq <const2_storage=512(%rsp),>const2=%r11
# bytes: 8 uops: 1
leaq 512(%rsp),%r11
# block pos: 134 168 uops: 4
...
# asm 1: vperm2f128 $0x21,<abcd4=reg256#1,<abcd4=reg256#1,>cdab4=reg256#4
# asm 2: vperm2f128 $0x21,<abcd4=%ymm0,<abcd4=%ymm0,>cdab4=%ymm3
# bytes: 7 uops: 2
.byte 0x3e
vperm2f128 $0x21,%ymm0,%ymm0,%ymm3
...
# asm 1: vaddsubpd <cdab4=reg256#4,<badc4=reg256#1,>H4=reg256#1
# asm 2: vaddsubpd <cdab4=%ymm3,<badc4=%ymm0,>H4=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vpermilpd $0x5,<F0=reg256#6,>yxtz0=reg256#4
# asm 2: vpermilpd $0x5,<F0=%ymm5,>yxtz0=%ymm3
# bytes: 6 uops: 1
vpermilpd $0x5,%ymm5,%ymm3

# qhasm:   abcd0[0,1,2,3] approx= F0[0]-yxtz0[0],F0[1]+yxtz0[1],F0[2]-yxtz0[2],F0[3]+yxtz0[3]
# asm 1: vaddsubpd <yxtz0=reg256#4,<F0=reg256#6,>abcd0=reg256#4
# asm 2: vaddsubpd <yxtz0=%ymm3,<F0=%ymm5,>abcd0=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# qhasm:   cdab0[0,1,2,3] = abcd0[2,3],abcd0[0,1]
# asm 1: vperm2f128 $0x21,<abcd0=reg256#4,<abcd0=reg256#4,>cdab0=reg256#6
# asm 2: vperm2f128 $0x21,<abcd0=%ymm3,<abcd0=%ymm3,>cdab0=%ymm5
# bytes: 7 uops: 2
.byte 0x3e
vperm2f128 $0x21,%ymm3,%ymm3,%ymm5
...
# asm 1: vaddsubpd <cdab0=reg256#6,<badc0=reg256#4,>I0=reg256#4
# asm 2: vaddsubpd <cdab0=%ymm5,<badc0=%ymm3,>I0=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm5,%ymm3,%ymm3

# qhasm:                           a22 aligned= mem256[const2 - 128]
# asm 1: vmovapd   -128(<const2=int64#9),>a22=reg256#6
# asm 2: vmovapd   -128(<const2=%r11),>a22=%ymm5
# bytes: 6 uops: 1
vmovapd   -128(%r11),%ymm5

# qhasm:                           4x H1 = approx H0 + a22
# asm 1: vaddpd <H0=reg256#3,<a22=reg256#6,>H1=reg256#7
# asm 2: vaddpd <H0=%ymm2,<a22=%ymm5,>H1=%ymm6
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <a22=reg256#6,<H1=reg256#7,>H1=reg256#6
# asm 2: vsubpd <a22=%ymm5,<H1=%ymm6,>H1=%ymm5
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm5,%ymm6,%ymm5

# qhasm:                           4x H0 approx-= H1
# asm 1: vsubpd <H1=reg256#6,<H0=reg256#3,>H0=reg256#3
# asm 2: vsubpd <H1=%ymm5,<H0=%ymm2,>H0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm5,%ymm2,%ymm2

# qhasm:                           4x H3 = approx H2 * mem256[const1 - 96]
# asm 1: vmulpd -96(<const1=int64#8),<H2=reg256#2,>H3=reg256#7
# asm 2: vmulpd -96(<const1=%r10),<H2=%ymm1,>H3=%ymm6
# bytes: 6 uops: 1
vmulpd -96(%r10),%ymm1,%ymm6

# qhasm:                           4x H3 = round(H3)
# asm 1: vroundpd $8,<H3=reg256#7,>H3=reg256#7
# asm 2: vroundpd $8,<H3=%ymm6,>H3=%ymm6
# bytes: 6 uops: 1
vroundpd $8,%ymm6,%ymm6

# qhasm:                           4x H3 approx*= mem256[const0 - 64]
# asm 1: vmulpd -64(<const0=int64#7),<H3=reg256#7,>H3=reg256#7
# asm 2: vmulpd -64(<const0=%rax),<H3=%ymm6,>H3=%ymm6
# bytes: 5 uops: 1
vmulpd -64(%rax),%ymm6,%ymm6

# qhasm:                           4x H2 approx-= H3
# asm 1: vsubpd <H3=reg256#7,<H2=reg256#2,>H2=reg256#2
# asm 2: vsubpd <H3=%ymm6,<H2=%ymm1,>H2=%ymm1
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm6,%ymm1,%ymm1
# block pos: 800 832 uops: 6

# qhasm:                           4x H5 = approx H4 * mem256[const1 - 32]
# asm 1: vmulpd -32(<const1=int64#8),<H4=reg256#1,>H5=reg256#8
# asm 2: vmulpd -32(<const1=%r10),<H4=%ymm0,>H5=%ymm7
# bytes: 6 uops: 1
vmulpd -32(%r10),%ymm0,%ymm7

# qhasm:                           4x H5 = round(H5)
# asm 1: vroundpd $8,<H5=reg256#8,>H5=reg256#8
# asm 2: vroundpd $8,<H5=%ymm7,>H5=%ymm7
# bytes: 6 uops: 1
vroundpd $8,%ymm7,%ymm7

# qhasm:                           4x H5 approx*= mem256[const0 + 0]
# asm 1: vmulpd 0(<const0=int64#7),<H5=reg256#8,>H5=reg256#8
# asm 2: vmulpd 0(<const0=%rax),<H5=%ymm7,>H5=%ymm7
# bytes: 4 uops: 1
vmulpd 0(%rax),%ymm7,%ymm7

# qhasm:                           4x H4 approx-= H5
# asm 1: vsubpd <H5=reg256#8,<H4=reg256#1,>H4=reg256#1
# asm 2: vsubpd <H5=%ymm7,<H4=%ymm0,>H4=%ymm0
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm7,%ymm0,%ymm0

# qhasm:   a22 aligned= mem256[const2 - 128]
# asm 1: vmovapd   -128(<const2=int64#9),>a22=reg256#9
# asm 2: vmovapd   -128(<const2=%r11),>a22=%ymm8
# bytes: 6 uops: 1
vmovapd   -128(%r11),%ymm8

# qhasm:   4x I1 = approx I0 + a22
# asm 1: vaddpd <I0=reg256#4,<a22=reg256#9,>I1=reg256#10
# asm 2: vaddpd <I0=%ymm3,<a22=%ymm8,>I1=%ymm9
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vsubpd <a22=reg256#9,<I1=reg256#10,>I1=reg256#9
# asm 2: vsubpd <a22=%ymm8,<I1=%ymm9,>I1=%ymm8
# bytes: 6 uops: 1
.byte 0x3e
vsubpd %ymm8,%ymm9,%ymm8

# qhasm:   4x I0 approx-= I1
# asm 1: vsubpd <I1=reg256#9,<I0=reg256#4,>I0=reg256#4
# asm 2: vsubpd <I1=%ymm8,<I0=%ymm3,>I0=%ymm3
# bytes: 5 uops: 1
vsubpd %ymm8,%ymm3,%ymm3

# qhasm:                                     4x 127I1 = approx I1 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<I1=reg256#9,>127I1=reg256#10
# asm 2: vmulpd -128(<const1=%r10),<I1=%ymm8,>127I1=%ymm9
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm8,%ymm9

# qhasm:                                   4x R1 = approx I1 * H0
# asm 1: vmulpd <I1=reg256#9,<H0=reg256#3,>R1=reg256#11
# asm 2: vmulpd <I1=%ymm8,<H0=%ymm2,>R1=%ymm10
# bytes: 5 uops: 1
vmulpd %ymm8,%ymm2,%ymm10

# qhasm:                                 4x R2 = approx I1 * H1
# asm 1: vmulpd <I1=reg256#9,<H1=reg256#6,>R2=reg256#12
# asm 2: vmulpd <I1=%ymm8,<H1=%ymm5,>R2=%ymm11
# bytes: 5 uops: 1
vmulpd %ymm8,%ymm5,%ymm11

# qhasm:                               4x R3 = approx I1 * H2
# asm 1: vmulpd <I1=reg256#9,<H2=reg256#2,>R3=reg256#13
# asm 2: vmulpd <I1=%ymm8,<H2=%ymm1,>R3=%ymm12
# bytes: 5 uops: 1
vmulpd %ymm8,%ymm1,%ymm12
# block pos: 864 896 uops: 6

# qhasm:                             4x R4 = approx I1 * H3
# asm 1: vmulpd <I1=reg256#9,<H3=reg256#7,>R4=reg256#14
# asm 2: vmulpd <I1=%ymm8,<H3=%ymm6,>R4=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm8,%ymm6,%ymm13

# qhasm:                           4x R5 = approx I1 * H4
# asm 1: vmulpd <I1=reg256#9,<H4=reg256#1,>R5=reg256#15
# asm 2: vmulpd <I1=%ymm8,<H4=%ymm0,>R5=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm8,%ymm0,%ymm14

# qhasm:                                     4x R0 = approx 127I1 * H5
# asm 1: vmulpd <127I1=reg256#10,<H5=reg256#8,>R0=reg256#10
# asm 2: vmulpd <127I1=%ymm9,<H5=%ymm7,>R0=%ymm9
# bytes: 5 uops: 1
vmulpd %ymm9,%ymm7,%ymm9

# qhasm:                                 4x a0b2 = approx I0 * H2
# asm 1: vmulpd <I0=reg256#4,<H2=reg256#2,>a0b2=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H2=%ymm1,>a0b2=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm1,%ymm15

# qhasm:                                 4x R2 approx+= a0b2
# asm 1: vaddpd <a0b2=reg256#16,<R2=reg256#12,>R2=reg256#12
# asm 2: vaddpd <a0b2=%ymm15,<R2=%ymm11,>R2=%ymm11
# bytes: 5 uops: 1
...
# asm 1: vmulpd <I0=reg256#4,<H3=reg256#7,>a0b3=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H3=%ymm6,>a0b3=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <a0b3=reg256#16,<R3=reg256#13,>R3=reg256#13
# asm 2: vaddpd <a0b3=%ymm15,<R3=%ymm12,>R3=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm12,%ymm12

# qhasm:                             4x a0b4 = approx I0 * H4
# asm 1: vmulpd <I0=reg256#4,<H4=reg256#1,>a0b4=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H4=%ymm0,>a0b4=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <I0=reg256#4,<H5=reg256#8,>a0b5=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H5=%ymm7,>a0b5=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm7,%ymm15

# qhasm:                           4x R5 approx+= a0b5
# asm 1: vaddpd <a0b5=reg256#16,<R5=reg256#15,>R5=reg256#15
# asm 2: vaddpd <a0b5=%ymm15,<R5=%ymm14,>R5=%ymm14
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm14,%ymm14

# qhasm:                                   4x a0b1 = approx I0 * H1
# asm 1: vmulpd <I0=reg256#4,<H1=reg256#6,>a0b1=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H1=%ymm5,>a0b1=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <a0b1=reg256#16,<R1=reg256#11,>R1=reg256#11
# asm 2: vaddpd <a0b1=%ymm15,<R1=%ymm10,>R1=%ymm10
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <I0=reg256#4,<H0=reg256#3,>a0b0=reg256#16
# asm 2: vmulpd <I0=%ymm3,<H0=%ymm2,>a0b0=%ymm15
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
.byte 0x3e
vmulpd %ymm3,%ymm2,%ymm15

# qhasm:                                     4x R0 approx+= a0b0
# asm 1: vaddpd <a0b0=reg256#16,<R0=reg256#10,>R0=reg256#10
# asm 2: vaddpd <a0b0=%ymm15,<R0=%ymm9,>R0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm9,%ymm9

# qhasm:   b = mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32]
# asm 1: vbroadcastsd 32(<work3=int64#1),>b=reg256#16
# asm 2: vbroadcastsd 32(<work3=%rdi),>b=%ymm15
# bytes: 6 uops: 1
vbroadcastsd 32(%rdi),%ymm15

# qhasm: 	      4x Q1 = I1 if b<0 else H1
# asm 1: vblendvpd <b=reg256#16,<I1=reg256#9,<H1=reg256#6,>Q1=reg256#9
# asm 2: vblendvpd <b=%ymm15,<I1=%ymm8,<H1=%ymm5,>Q1=%ymm8
# bytes: 6 uops: 2
vblendvpd %ymm15,%ymm8,%ymm5,%ymm8
# block pos: 992 1024 uops: 6

# qhasm:               mem256[work1 - 96] aligned= Q1
# asm 1: vmovapd   <Q1=reg256#9,-96(<work1=int64#5)
# asm 2: vmovapd   <Q1=%ymm8,-96(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm8,-96(%r8)

# qhasm: 	      4x Q0 = I0 if b<0 else H0
# asm 1: vblendvpd <b=reg256#16,<I0=reg256#4,<H0=reg256#3,>Q0=reg256#4
# asm 2: vblendvpd <b=%ymm15,<I0=%ymm3,<H0=%ymm2,>Q0=%ymm3
# bytes: 7 uops: 2
.byte 0x3e
vblendvpd %ymm15,%ymm3,%ymm2,%ymm3

# qhasm:               mem256[work1 - 128] aligned= Q0
# asm 1: vmovapd   <Q0=reg256#4,-128(<work1=int64#5)
# asm 2: vmovapd   <Q0=%ymm3,-128(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm3,-128(%r8)

# qhasm:   a64 aligned= mem256[const2 - 64]
# asm 1: vmovapd   -64(<const2=int64#9),>a64=reg256#4
# asm 2: vmovapd   -64(<const2=%r11),>a64=%ymm3
# bytes: 6 uops: 1
vmovapd   -64(%r11),%ymm3

# qhasm:   4x I3 = approx I2 + a64
# asm 1: vaddpd <I2=reg256#5,<a64=reg256#4,>I3=reg256#9
# asm 2: vaddpd <I2=%ymm4,<a64=%ymm3,>I3=%ymm8
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <a64=reg256#4,<I3=reg256#9,>I3=reg256#4
# asm 2: vsubpd <a64=%ymm3,<I3=%ymm8,>I3=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <I3=reg256#4,<I2=reg256#5,>I2=reg256#5
# asm 2: vsubpd <I3=%ymm3,<I2=%ymm4,>I2=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vsubpd %ymm3,%ymm4,%ymm4
...
# asm 1: vmulpd <I3=reg256#4,<H0=reg256#3,>a3b0=reg256#9
# asm 2: vmulpd <I3=%ymm3,<H0=%ymm2,>a3b0=%ymm8
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm2,%ymm8

# qhasm:                               4x R3 approx+= a3b0
# asm 1: vaddpd <a3b0=reg256#9,<R3=reg256#13,>R3=reg256#9
# asm 2: vaddpd <a3b0=%ymm8,<R3=%ymm12,>R3=%ymm8
# bytes: 5 uops: 1
vaddpd %ymm8,%ymm12,%ymm8

# qhasm:                             4x a3b1 = approx I3 * H1
# asm 1: vmulpd <I3=reg256#4,<H1=reg256#6,>a3b1=reg256#13
# asm 2: vmulpd <I3=%ymm3,<H1=%ymm5,>a3b1=%ymm12
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm5,%ymm12

# qhasm:                             4x R4 approx+= a3b1
# asm 1: vaddpd <a3b1=reg256#13,<R4=reg256#14,>R4=reg256#13
# asm 2: vaddpd <a3b1=%ymm12,<R4=%ymm13,>R4=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm12,%ymm13,%ymm12
# block pos: 1056 1088 uops: 6

# qhasm:                           4x a3b2 = approx I3 * H2
# asm 1: vmulpd <I3=reg256#4,<H2=reg256#2,>a3b2=reg256#14
# asm 2: vmulpd <I3=%ymm3,<H2=%ymm1,>a3b2=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <a3b2=reg256#14,<R5=reg256#15,>R5=reg256#14
# asm 2: vaddpd <a3b2=%ymm13,<R5=%ymm14,>R5=%ymm13
# bytes: 5 uops: 1
vaddpd %ymm13,%ymm14,%ymm13

# qhasm:                                 4x 127I3 = approx I3 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<I3=reg256#4,>127I3=reg256#15
# asm 2: vmulpd -128(<const1=%r10),<I3=%ymm3,>127I3=%ymm14
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm3,%ymm14

# qhasm:                                 4x a3b5 = approx 127I3 * H5
# asm 1: vmulpd <127I3=reg256#15,<H5=reg256#8,>a3b5=reg256#16
# asm 2: vmulpd <127I3=%ymm14,<H5=%ymm7,>a3b5=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm7,%ymm15

# qhasm:                                 4x R2 approx+= a3b5
# asm 1: vaddpd <a3b5=reg256#16,<R2=reg256#12,>R2=reg256#12
# asm 2: vaddpd <a3b5=%ymm15,<R2=%ymm11,>R2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm11,%ymm11

# qhasm:                                   4x a3b4 = approx 127I3 * H4
# asm 1: vmulpd <127I3=reg256#15,<H4=reg256#1,>a3b4=reg256#16
# asm 2: vmulpd <127I3=%ymm14,<H4=%ymm0,>a3b4=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm0,%ymm15
# block pos: 1088 1120 uops: 6

# qhasm:                                   4x R1 approx+= a3b4
# asm 1: vaddpd <a3b4=reg256#16,<R1=reg256#11,>R1=reg256#11
# asm 2: vaddpd <a3b4=%ymm15,<R1=%ymm10,>R1=%ymm10
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm10,%ymm10

# qhasm:                                     4x a3b3 = approx 127I3 * H3
# asm 1: vmulpd <127I3=reg256#15,<H3=reg256#7,>a3b3=reg256#15
# asm 2: vmulpd <127I3=%ymm14,<H3=%ymm6,>a3b3=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm6,%ymm14

# qhasm:                                     4x R0 approx+= a3b3
# asm 1: vaddpd <a3b3=reg256#15,<R0=reg256#10,>R0=reg256#10
# asm 2: vaddpd <a3b3=%ymm14,<R0=%ymm9,>R0=%ymm9
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm9,%ymm9

# qhasm:                           4x a2b3 = approx I2 * H3
# asm 1: vmulpd <I2=reg256#5,<H3=reg256#7,>a2b3=reg256#15
# asm 2: vmulpd <I2=%ymm4,<H3=%ymm6,>a2b3=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm4,%ymm6,%ymm14

# qhasm:                           4x R5 approx+= a2b3
# asm 1: vaddpd <a2b3=reg256#15,<R5=reg256#14,>R5=reg256#14
# asm 2: vaddpd <a2b3=%ymm14,<R5=%ymm13,>R5=%ymm13
# bytes: 5 uops: 1
...
# asm 1: vaddpd <a2b2=reg256#15,<R4=reg256#13,>R4=reg256#13
# asm 2: vaddpd <a2b2=%ymm14,<R4=%ymm12,>R4=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm12,%ymm12

# qhasm:                               4x a2b1 = approx I2 * H1
# asm 1: vmulpd <I2=reg256#5,<H1=reg256#6,>a2b1=reg256#15
# asm 2: vmulpd <I2=%ymm4,<H1=%ymm5,>a2b1=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
...
# qhasm: 			        4x a2b0 =approx I2 * H0
# asm 1: vmulpd <I2=reg256#5,<H0=reg256#3,>a2b0=reg256#15
# asm 2: vmulpd <I2=%ymm4,<H0=%ymm2,>a2b0=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm4,%ymm2,%ymm14

# qhasm:                                 4x R2 approx+= a2b0
# asm 1: vaddpd <a2b0=reg256#15,<R2=reg256#12,>R2=reg256#12
# asm 2: vaddpd <a2b0=%ymm14,<R2=%ymm11,>R2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm11,%ymm11

# qhasm:                                   4x 127I2 = approx I2 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<I2=reg256#5,>127I2=reg256#15
# asm 2: vmulpd -128(<const1=%r10),<I2=%ymm4,>127I2=%ymm14
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm4,%ymm14
# block pos: 1152 1184 uops: 5

# qhasm:                                   4x a2b5 = approx 127I2 * H5
# asm 1: vmulpd <127I2=reg256#15,<H5=reg256#8,>a2b5=reg256#16
# asm 2: vmulpd <127I2=%ymm14,<H5=%ymm7,>a2b5=%ymm15
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
vmulpd %ymm14,%ymm7,%ymm15
...
# asm 1: vaddpd <a2b5=reg256#16,<R1=reg256#11,>R1=reg256#11
# asm 2: vaddpd <a2b5=%ymm15,<R1=%ymm10,>R1=%ymm10
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
vaddpd %ymm15,%ymm10,%ymm10

# qhasm:                                     4x a2b4 = approx 127I2 * H4
# asm 1: vmulpd <127I2=reg256#15,<H4=reg256#1,>a2b4=reg256#15
# asm 2: vmulpd <127I2=%ymm14,<H4=%ymm0,>a2b4=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm0,%ymm14

# qhasm:                                     4x R0 approx+= a2b4
# asm 1: vaddpd <a2b4=reg256#15,<R0=reg256#10,>R0=reg256#10
# asm 2: vaddpd <a2b4=%ymm14,<R0=%ymm9,>R0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm9,%ymm9

# qhasm:   b = mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32]
# asm 1: vbroadcastsd 32(<work3=int64#1),>b=reg256#15
# asm 2: vbroadcastsd 32(<work3=%rdi),>b=%ymm14
# bytes: 6 uops: 1
vbroadcastsd 32(%rdi),%ymm14
# block pos: 1184 1216 uops: 6

# qhasm: 	      4x Q3 = I3 if b<0 else H3
# asm 1: vblendvpd <b=reg256#15,<I3=reg256#4,<H3=reg256#7,>Q3=reg256#4
# asm 2: vblendvpd <b=%ymm14,<I3=%ymm3,<H3=%ymm6,>Q3=%ymm3
# bytes: 10 uops: 2
.byte 0x3e
.byte 0x3e
.byte 0x3e
.byte 0x3e
vblendvpd %ymm14,%ymm3,%ymm6,%ymm3

# qhasm:               mem256[work1 - 32] aligned= Q3
# asm 1: vmovapd   <Q3=reg256#4,-32(<work1=int64#5)
# asm 2: vmovapd   <Q3=%ymm3,-32(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm3,-32(%r8)

# qhasm: 	      4x Q2 = I2 if b<0 else H2
# asm 1: vblendvpd <b=reg256#15,<I2=reg256#5,<H2=reg256#2,>Q2=reg256#4
# asm 2: vblendvpd <b=%ymm14,<I2=%ymm4,<H2=%ymm1,>Q2=%ymm3
# bytes: 10 uops: 2
.byte 0x3e
.byte 0x3e
.byte 0x3e
.byte 0x3e
vblendvpd %ymm14,%ymm4,%ymm1,%ymm3

# qhasm:               mem256[work1 - 64] aligned= Q2
# asm 1: vmovapd   <Q2=reg256#4,-64(<work1=int64#5)
# asm 2: vmovapd   <Q2=%ymm3,-64(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm3,-64(%r8)
...
# asm 1: vpermilpd $0x5,<F4=reg256#4,>yxtz4=reg256#5
# asm 2: vpermilpd $0x5,<F4=%ymm3,>yxtz4=%ymm4
# bytes: 7 uops: 1
.byte 0x3e
vpermilpd $0x5,%ymm3,%ymm4

# qhasm:   abcd4[0,1,2,3] approx= F4[0]-yxtz4[0],F4[1]+yxtz4[1],F4[2]-yxtz4[2],F4[3]+yxtz4[3]
# asm 1: vaddsubpd <yxtz4=reg256#5,<F4=reg256#4,>abcd4=reg256#4
# asm 2: vaddsubpd <yxtz4=%ymm4,<F4=%ymm3,>abcd4=%ymm3
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
.byte 0x3e
...
# qhasm:   cdab4[0,1,2,3] = abcd4[2,3],abcd4[0,1]
# asm 1: vperm2f128 $0x21,<abcd4=reg256#4,<abcd4=reg256#4,>cdab4=reg256#5
# asm 2: vperm2f128 $0x21,<abcd4=%ymm3,<abcd4=%ymm3,>cdab4=%ymm4
# bytes: 7 uops: 2
.byte 0x3e
vperm2f128 $0x21,%ymm3,%ymm3,%ymm4
...
# asm 1: vaddsubpd <cdab4=reg256#5,<badc4=reg256#4,>I4=reg256#4
# asm 2: vaddsubpd <cdab4=%ymm4,<badc4=%ymm3,>I4=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm4,%ymm3,%ymm3
...
# asm 1: vmovapd   0(<const2=int64#9),>a106=reg256#5
# asm 2: vmovapd   0(<const2=%r11),>a106=%ymm4
# bytes: 5 uops: 1
vmovapd   0(%r11),%ymm4

# qhasm:   4x I5 = approx I4 + a106
# asm 1: vaddpd <I4=reg256#4,<a106=reg256#5,>I5=reg256#15
# asm 2: vaddpd <I4=%ymm3,<a106=%ymm4,>I5=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <a106=reg256#5,<I5=reg256#15,>I5=reg256#5
# asm 2: vsubpd <a106=%ymm4,<I5=%ymm14,>I5=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm4,%ymm14,%ymm4

# qhasm:   4x I4 approx-= I5
# asm 1: vsubpd <I5=reg256#5,<I4=reg256#4,>I4=reg256#4
# asm 2: vsubpd <I5=%ymm4,<I4=%ymm3,>I4=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm4,%ymm3,%ymm3

# qhasm: 			  4x a5b0 = approx I5 * H0
# asm 1: vmulpd <I5=reg256#5,<H0=reg256#3,>a5b0=reg256#15
# asm 2: vmulpd <I5=%ymm4,<H0=%ymm2,>a5b0=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm4,%ymm2,%ymm14
...
# asm 1: vaddpd <a5b0=reg256#15,<R5=reg256#14,>R5=reg256#14
# asm 2: vaddpd <a5b0=%ymm14,<R5=%ymm13,>R5=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm13,%ymm13

# qhasm:                             4x 127I5 = approx I5 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<I5=reg256#5,>127I5=reg256#15
# asm 2: vmulpd -128(<const1=%r10),<I5=%ymm4,>127I5=%ymm14
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm4,%ymm14

# qhasm:                             4x a5b5 = approx 127I5 * H5
# asm 1: vmulpd <127I5=reg256#15,<H5=reg256#8,>a5b5=reg256#16
# asm 2: vmulpd <127I5=%ymm14,<H5=%ymm7,>a5b5=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm7,%ymm15

# qhasm:                             4x R4 approx+= a5b5
# asm 1: vaddpd <a5b5=reg256#16,<R4=reg256#13,>R4=reg256#13
# asm 2: vaddpd <a5b5=%ymm15,<R4=%ymm12,>R4=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm12,%ymm12

# qhasm:                               4x a5b4 = approx 127I5 * H4
# asm 1: vmulpd <127I5=reg256#15,<H4=reg256#1,>a5b4=reg256#16
# asm 2: vmulpd <127I5=%ymm14,<H4=%ymm0,>a5b4=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm0,%ymm15

# qhasm:                               4x R3 approx+= a5b4
# asm 1: vaddpd <a5b4=reg256#16,<R3=reg256#9,>R3=reg256#9
# asm 2: vaddpd <a5b4=%ymm15,<R3=%ymm8,>R3=%ymm8
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm8,%ymm8
# block pos: 1312 1344 uops: 6

# qhasm:                                 4x a5b3 = approx 127I5 * H3
# asm 1: vmulpd <127I5=reg256#15,<H3=reg256#7,>a5b3=reg256#16
# asm 2: vmulpd <127I5=%ymm14,<H3=%ymm6,>a5b3=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm6,%ymm15

# qhasm:                                 4x R2 approx+= a5b3
# asm 1: vaddpd <a5b3=reg256#16,<R2=reg256#12,>R2=reg256#12
# asm 2: vaddpd <a5b3=%ymm15,<R2=%ymm11,>R2=%ymm11
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm11,%ymm11

# qhasm:                                   4x a5b2 = approx 127I5 * H2
# asm 1: vmulpd <127I5=reg256#15,<H2=reg256#2,>a5b2=reg256#16
# asm 2: vmulpd <127I5=%ymm14,<H2=%ymm1,>a5b2=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm1,%ymm15

# qhasm:                                   4x R1 approx+= a5b2
# asm 1: vaddpd <a5b2=reg256#16,<R1=reg256#11,>R1=reg256#11
# asm 2: vaddpd <a5b2=%ymm15,<R1=%ymm10,>R1=%ymm10
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm10,%ymm10

# qhasm:                                     4x a5b1 = approx 127I5 * H1
# asm 1: vmulpd <127I5=reg256#15,<H1=reg256#6,>a5b1=reg256#15
# asm 2: vmulpd <127I5=%ymm14,<H1=%ymm5,>a5b1=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm5,%ymm14

# qhasm:                                     4x R0 approx+= a5b1
# asm 1: vaddpd <a5b1=reg256#15,<R0=reg256#10,>R0=reg256#10
# asm 2: vaddpd <a5b1=%ymm14,<R0=%ymm9,>R0=%ymm9
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm9,%ymm9
# block pos: 1344 1376 uops: 6

# qhasm:                           4x a4b1 = approx I4 * H1
# asm 1: vmulpd <I4=reg256#4,<H1=reg256#6,>a4b1=reg256#6
# asm 2: vmulpd <I4=%ymm3,<H1=%ymm5,>a4b1=%ymm5
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <a4b1=reg256#6,<R5=reg256#14,>R5=reg256#6
# asm 2: vaddpd <a4b1=%ymm5,<R5=%ymm13,>R5=%ymm5
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm5,%ymm13,%ymm5

# qhasm:                             4x a4b0 = approx I4 * H0
# asm 1: vmulpd <I4=reg256#4,<H0=reg256#3,>a4b0=reg256#3
# asm 2: vmulpd <I4=%ymm3,<H0=%ymm2,>a4b0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm2,%ymm2

# qhasm: 			    4x R4 approx+= a4b0
# asm 1: vaddpd <a4b0=reg256#3,<R4=reg256#13,>R4=reg256#3
# asm 2: vaddpd <a4b0=%ymm2,<R4=%ymm12,>R4=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm2,%ymm12,%ymm2

# qhasm:                               4x 127I4 = approx I4 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<I4=reg256#4,>127I4=reg256#13
# asm 2: vmulpd -128(<const1=%r10),<I4=%ymm3,>127I4=%ymm12
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm3,%ymm12

# qhasm:                               4x a4b5 = approx 127I4 * H5
# asm 1: vmulpd <127I4=reg256#13,<H5=reg256#8,>a4b5=reg256#14
# asm 2: vmulpd <127I4=%ymm12,<H5=%ymm7,>a4b5=%ymm13
# bytes: 5 uops: 1
vmulpd %ymm12,%ymm7,%ymm13
# block pos: 1376 1408 uops: 6

# qhasm:                               4x R3 approx+= a4b5
# asm 1: vaddpd <a4b5=reg256#14,<R3=reg256#9,>R3=reg256#9
# asm 2: vaddpd <a4b5=%ymm13,<R3=%ymm8,>R3=%ymm8
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm13,%ymm8,%ymm8

# qhasm:                                 4x a4b4 = approx 127I4 * H4
# asm 1: vmulpd <127I4=reg256#13,<H4=reg256#1,>a4b4=reg256#14
# asm 2: vmulpd <127I4=%ymm12,<H4=%ymm0,>a4b4=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm12,%ymm0,%ymm13

# qhasm:                                 4x R2 approx+= a4b4
# asm 1: vaddpd <a4b4=reg256#14,<R2=reg256#12,>R2=reg256#12
# asm 2: vaddpd <a4b4=%ymm13,<R2=%ymm11,>R2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm13,%ymm11,%ymm11

# qhasm:                                   4x a4b3 = approx 127I4 * H3
# asm 1: vmulpd <127I4=reg256#13,<H3=reg256#7,>a4b3=reg256#7
# asm 2: vmulpd <127I4=%ymm12,<H3=%ymm6,>a4b3=%ymm6
# bytes: 5 uops: 1
vmulpd %ymm12,%ymm6,%ymm6

# qhasm:                                   4x R1 approx+= a4b3
# asm 1: vaddpd <a4b3=reg256#7,<R1=reg256#11,>R1=reg256#7
# asm 2: vaddpd <a4b3=%ymm6,<R1=%ymm10,>R1=%ymm6
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm6,%ymm10,%ymm6

# qhasm:                                     4x a4b2 = approx 127I4 * H2
# asm 1: vmulpd <127I4=reg256#13,<H2=reg256#2,>a4b2=reg256#2
# asm 2: vmulpd <127I4=%ymm12,<H2=%ymm1,>a4b2=%ymm1
# bytes: 5 uops: 1
vmulpd %ymm12,%ymm1,%ymm1
# block pos: 1408 1440 uops: 5

# qhasm:                                     4x R0 approx+= a4b2
# asm 1: vaddpd <a4b2=reg256#2,<R0=reg256#10,>R0=reg256#2
# asm 2: vaddpd <a4b2=%ymm1,<R0=%ymm9,>R0=%ymm1
# bytes: 10 uops: 1
.byte 0x3e
.byte 0x3e
.byte 0x3e
...
# qhasm:   b = mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32],mem64[work3 + 32]
# asm 1: vbroadcastsd 32(<work3=int64#1),>b=reg256#10
# asm 2: vbroadcastsd 32(<work3=%rdi),>b=%ymm9
# bytes: 6 uops: 1
vbroadcastsd 32(%rdi),%ymm9

# qhasm: 	      4x Q5 = I5 if b<0 else H5
# asm 1: vblendvpd <b=reg256#10,<I5=reg256#5,<H5=reg256#8,>Q5=reg256#5
# asm 2: vblendvpd <b=%ymm9,<I5=%ymm4,<H5=%ymm7,>Q5=%ymm4
# bytes: 10 uops: 2
.byte 0x3e
.byte 0x3e
.byte 0x3e
.byte 0x3e
vblendvpd %ymm9,%ymm4,%ymm7,%ymm4

# qhasm:               mem256[work1 + 32] aligned= Q5
# asm 1: vmovapd   <Q5=reg256#5,32(<work1=int64#5)
# asm 2: vmovapd   <Q5=%ymm4,32(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm4,32(%r8)
# block pos: 1440 1472 uops: 6

# qhasm: 	      4x Q4 = I4 if b<0 else H4
# asm 1: vblendvpd <b=reg256#10,<I4=reg256#4,<H4=reg256#1,>Q4=reg256#1
# asm 2: vblendvpd <b=%ymm9,<I4=%ymm3,<H4=%ymm0,>Q4=%ymm0
# bytes: 9 uops: 2
.byte 0x3e
.byte 0x3e
.byte 0x3e
...
# asm 1: vmovapd   <Q4=reg256#1,0(<work1=int64#5)
# asm 2: vmovapd   <Q4=%ymm0,0(<work1=%r8)
# bytes: 5 uops: 1
vmovapd   %ymm0,0(%r8)

# qhasm:                                       4x c5 = approx R5 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<R5=reg256#6,>c5=reg256#1
# asm 2: vmulpd -128(<const1=%r10),<R5=%ymm5,>c5=%ymm0
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm5,%ymm0

# qhasm:                                       4x c4 = approx R4 * mem256[const1 - 32]
# asm 1: vmulpd -32(<const1=int64#8),<R4=reg256#3,>c4=reg256#4
# asm 2: vmulpd -32(<const1=%r10),<R4=%ymm2,>c4=%ymm3
# bytes: 6 uops: 1
vmulpd -32(%r10),%ymm2,%ymm3

# qhasm:                                       4x c3 = approx R3 * mem256[const1 - 64]
# asm 1: vmulpd -64(<const1=int64#8),<R3=reg256#9,>c3=reg256#5
# asm 2: vmulpd -64(<const1=%r10),<R3=%ymm8,>c3=%ymm4
# bytes: 6 uops: 1
vmulpd -64(%r10),%ymm8,%ymm4
# block pos: 1472 1506 uops: 6

# qhasm:                                       4x c2 = approx R2 * mem256[const1 - 96]
# asm 1: vmulpd -96(<const1=int64#8),<R2=reg256#12,>c2=reg256#8
# asm 2: vmulpd -96(<const1=%r10),<R2=%ymm11,>c2=%ymm7
# bytes: 6 uops: 1
vmulpd -96(%r10),%ymm11,%ymm7

# qhasm:                                       4x c1 = approx R1 * mem256[const0 + 96]
# asm 1: vmulpd 96(<const0=int64#7),<R1=reg256#7,>c1=reg256#10
# asm 2: vmulpd 96(<const0=%rax),<R1=%ymm6,>c1=%ymm9
# bytes: 5 uops: 1
vmulpd 96(%rax),%ymm6,%ymm9

# qhasm:                                       4x c0 = approx R0 * mem256[const0 + 64]
# asm 1: vmulpd 64(<const0=int64#7),<R0=reg256#2,>c0=reg256#11
# asm 2: vmulpd 64(<const0=%rax),<R0=%ymm1,>c0=%ymm10
# bytes: 5 uops: 1
vmulpd 64(%rax),%ymm1,%ymm10

# qhasm:                                       4x c5 = round(c5)
# asm 1: vroundpd $8,<c5=reg256#1,>c5=reg256#1
# asm 2: vroundpd $8,<c5=%ymm0,>c5=%ymm0
# bytes: 6 uops: 1
vroundpd $8,%ymm0,%ymm0

# qhasm:                                       4x c4 = round(c4)
# asm 1: vroundpd $8,<c4=reg256#4,>c4=reg256#4
# asm 2: vroundpd $8,<c4=%ymm3,>c4=%ymm3
# bytes: 6 uops: 1
...
# block pos: 1506 1537 uops: 6

# qhasm:                                       4x c2 = round(c2)
# asm 1: vroundpd $8,<c2=reg256#8,>c2=reg256#8
# asm 2: vroundpd $8,<c2=%ymm7,>c2=%ymm7
# bytes: 6 uops: 1
vroundpd $8,%ymm7,%ymm7
...
# asm 1: vroundpd $8,<c0=reg256#11,>c0=reg256#11
# asm 2: vroundpd $8,<c0=%ymm10,>c0=%ymm10
# bytes: 6 uops: 1
vroundpd $8,%ymm10,%ymm10

# qhasm:                                         4x R0 approx+= c5
# asm 1: vaddpd <c5=reg256#1,<R0=reg256#2,>R0=reg256#2
# asm 2: vaddpd <c5=%ymm0,<R0=%ymm1,>R0=%ymm1
# bytes: 4 uops: 1
vaddpd %ymm0,%ymm1,%ymm1

# qhasm:                                       4x c4 approx*= mem256[const0 + 0]
# asm 1: vmulpd 0(<const0=int64#7),<c4=reg256#4,>c4=reg256#4
# asm 2: vmulpd 0(<const0=%rax),<c4=%ymm3,>c4=%ymm3
# bytes: 4 uops: 1
vmulpd 0(%rax),%ymm3,%ymm3
...
# asm 1: vmulpd -64(<const0=int64#7),<c2=reg256#8,>c2=reg256#8
# asm 2: vmulpd -64(<const0=%rax),<c2=%ymm7,>c2=%ymm7
# bytes: 5 uops: 1
vmulpd -64(%rax),%ymm7,%ymm7
...
# asm 1: vmulpd -128(<const0=int64#7),<c0=reg256#11,>c0=reg256#11
# asm 2: vmulpd -128(<const0=%rax),<c0=%ymm10,>c0=%ymm10
# bytes: 5 uops: 1
vmulpd -128(%rax),%ymm10,%ymm10

# qhasm:                                         4x c5 approx*= mem256[const0 + 32]
# asm 1: vmulpd 32(<const0=int64#7),<c5=reg256#1,>c5=reg256#1
# asm 2: vmulpd 32(<const0=%rax),<c5=%ymm0,>c5=%ymm0
# bytes: 5 uops: 1
vmulpd 32(%rax),%ymm0,%ymm0

# qhasm:                                         4x R5 approx-= c5
# asm 1: vsubpd <c5=reg256#1,<R5=reg256#6,>R5=reg256#1
# asm 2: vsubpd <c5=%ymm0,<R5=%ymm5,>R5=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <c4=reg256#4,<R5=reg256#1,>R5=reg256#1
# asm 2: vaddpd <c4=%ymm3,<R5=%ymm0,>R5=%ymm0
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vsubpd <c4=reg256#4,<R4=reg256#3,>R4=reg256#3
# asm 2: vsubpd <c4=%ymm3,<R4=%ymm2,>R4=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <c3=reg256#5,<R4=reg256#3,>R4=reg256#3
# asm 2: vaddpd <c3=%ymm4,<R4=%ymm2,>R4=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <c3=reg256#5,<R3=reg256#9,>R3=reg256#4
# asm 2: vsubpd <c3=%ymm4,<R3=%ymm8,>R3=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm4,%ymm8,%ymm3

# qhasm:                                         4x R3 approx+= c2
# asm 1: vaddpd <c2=reg256#8,<R3=reg256#4,>R3=reg256#4
# asm 2: vaddpd <c2=%ymm7,<R3=%ymm3,>R3=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm7,%ymm3,%ymm3

# qhasm:                                         4x R2 approx-= c2
# asm 1: vsubpd <c2=reg256#8,<R2=reg256#12,>R2=reg256#5
# asm 2: vsubpd <c2=%ymm7,<R2=%ymm11,>R2=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm7,%ymm11,%ymm4

# qhasm:                                         4x R2 approx+= c1
# asm 1: vaddpd <c1=reg256#10,<R2=reg256#5,>R2=reg256#5
# asm 2: vaddpd <c1=%ymm9,<R2=%ymm4,>R2=%ymm4
# bytes: 5 uops: 1
vaddpd %ymm9,%ymm4,%ymm4
# block pos: 1600 1632 uops: 6

# qhasm:                                         4x R1 approx-= c1
# asm 1: vsubpd <c1=reg256#10,<R1=reg256#7,>R1=reg256#6
# asm 2: vsubpd <c1=%ymm9,<R1=%ymm6,>R1=%ymm5
# bytes: 6 uops: 1
.byte 0x3e
vsubpd %ymm9,%ymm6,%ymm5

# qhasm:                                         4x R1 approx+= c0
# asm 1: vaddpd <c0=reg256#11,<R1=reg256#6,>R1=reg256#6
# asm 2: vaddpd <c0=%ymm10,<R1=%ymm5,>R1=%ymm5
# bytes: 5 uops: 1
vaddpd %ymm10,%ymm5,%ymm5

# qhasm:                                         4x R0 approx-= c0
# asm 1: vsubpd <c0=reg256#11,<R0=reg256#2,>R0=reg256#2
# asm 2: vsubpd <c0=%ymm10,<R0=%ymm1,>R0=%ymm1
# bytes: 5 uops: 1
...
# asm 1: vmulpd <R5=reg256#1,<abcd=reg256#9,>R5=reg256#1
# asm 2: vmulpd <R5=%ymm0,<abcd=%ymm8,>R5=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <R4=reg256#3,<abcd=reg256#9,>R4=reg256#3
# asm 2: vmulpd <R4=%ymm2,<abcd=%ymm8,>R4=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm8,%ymm2

# qhasm:                           4x R3 = approx R3 * abcd
# asm 1: vmulpd <R3=reg256#4,<abcd=reg256#9,>R3=reg256#4
# asm 2: vmulpd <R3=%ymm3,<abcd=%ymm8,>R3=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm8,%ymm3

# qhasm:                           4x R2 = approx R2 * abcd
# asm 1: vmulpd <R2=reg256#5,<abcd=reg256#9,>R2=reg256#5
# asm 2: vmulpd <R2=%ymm4,<abcd=%ymm8,>R2=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm4,%ymm8,%ymm4

# qhasm:                           4x R1 = approx R1 * abcd
# asm 1: vmulpd <R1=reg256#6,<abcd=reg256#9,>R1=reg256#6
# asm 2: vmulpd <R1=%ymm5,<abcd=%ymm8,>R1=%ymm5
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <R5=reg256#1,<a127=reg256#12,>c5=reg256#13
# asm 2: vaddpd <R5=%ymm0,<a127=%ymm11,>c5=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# qhasm:                           4x R5 approx-= c5
# asm 1: vsubpd <c5=reg256#12,<R5=reg256#1,>R5=reg256#1
# asm 2: vsubpd <c5=%ymm11,<R5=%ymm0,>R5=%ymm0
# bytes: 5 uops: 1
...
# asm 1: vaddpd <R5=reg256#1,<R4=reg256#3,>R4=reg256#1
# asm 2: vaddpd <R5=%ymm0,<R4=%ymm2,>R4=%ymm0
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmovapd   -64(<work1=int64#5),>Q2=reg256#3
# asm 2: vmovapd   -64(<work1=%r8),>Q2=%ymm2
# bytes: 6 uops: 1
vmovapd   -64(%r8),%ymm2

# qhasm:       4x S4 =approx Q2 * Q2
# asm 1: vmulpd <Q2=reg256#3,<Q2=reg256#3,>S4=reg256#12
# asm 2: vmulpd <Q2=%ymm2,<Q2=%ymm2,>S4=%ymm11
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <2Q1=reg256#10,<Q2=reg256#3,>S3=reg256#13
# asm 2: vmulpd <2Q1=%ymm9,<Q2=%ymm2,>S3=%ymm12
# bytes: 5 uops: 1
vmulpd %ymm9,%ymm2,%ymm12

# qhasm:       4x 2Q0Q2 = approx 2Q0 * Q2
# asm 1: vmulpd <2Q0=reg256#8,<Q2=reg256#3,>2Q0Q2=reg256#14
# asm 2: vmulpd <2Q0=%ymm7,<Q2=%ymm2,>2Q0Q2=%ymm13
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd 0(<const1=int64#8),<Q2=reg256#3,>2Q2=reg256#3
# asm 2: vmulpd 0(<const1=%r10),<Q2=%ymm2,>2Q2=%ymm2
# bytes: 5 uops: 1
...
# asm 1: vaddpd <R3=reg256#4,<a85=reg256#14,>c3=reg256#15
# asm 2: vaddpd <R3=%ymm3,<a85=%ymm13,>c3=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# qhasm:                           4x R4 approx+= c3
# asm 1: vaddpd <c3=reg256#14,<R4=reg256#1,>R4=reg256#1
# asm 2: vaddpd <c3=%ymm13,<R4=%ymm0,>R4=%ymm0
# bytes: 5 uops: 1
vaddpd %ymm13,%ymm0,%ymm0

# qhasm: 			  4x R3 approx-= c3
# asm 1: vsubpd <c3=reg256#14,<R3=reg256#4,>R3=reg256#4
# asm 2: vsubpd <c3=%ymm13,<R3=%ymm3,>R3=%ymm3
# bytes: 5 uops: 1
vsubpd %ymm13,%ymm3,%ymm3

# qhasm:                           4x R2 approx+= R3
# asm 1: vaddpd <R3=reg256#4,<R2=reg256#5,>R2=reg256#4
# asm 2: vaddpd <R3=%ymm3,<R2=%ymm4,>R2=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmovapd   -96(<const2=int64#9),>a43=reg256#5
# asm 2: vmovapd   -96(<const2=%r11),>a43=%ymm4
# bytes: 6 uops: 1
vmovapd   -96(%r11),%ymm4

# qhasm:                           4x c1 = approx R1 + a43
# asm 1: vaddpd <R1=reg256#6,<a43=reg256#5,>c1=reg256#14
# asm 2: vaddpd <R1=%ymm5,<a43=%ymm4,>c1=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <a43=reg256#5,<c1=reg256#14,>c1=reg256#5
# asm 2: vsubpd <a43=%ymm4,<c1=%ymm13,>c1=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm4,%ymm13,%ymm4

# qhasm:                           4x R2 approx+= c1
# asm 1: vaddpd <c1=reg256#5,<R2=reg256#4,>R2=reg256#4
# asm 2: vaddpd <c1=%ymm4,<R2=%ymm3,>R2=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm4,%ymm3,%ymm3

# qhasm: 			  4x R1 approx-= c1
# asm 1: vsubpd <c1=reg256#5,<R1=reg256#6,>R1=reg256#5
# asm 2: vsubpd <c1=%ymm4,<R1=%ymm5,>R1=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm4,%ymm5,%ymm4

# qhasm:                           4x R0 approx+= R1
# asm 1: vaddpd <R1=reg256#5,<R0=reg256#2,>R0=reg256#2
# asm 2: vaddpd <R1=%ymm4,<R0=%ymm1,>R0=%ymm1
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm4,%ymm1,%ymm1
...
# asm 1: vmovapd   -32(<work1=int64#5),>Q3=reg256#5
# asm 2: vmovapd   -32(<work1=%r8),>Q3=%ymm4
# bytes: 6 uops: 1
vmovapd   -32(%r8),%ymm4

# qhasm:       4x S5 = approx 2Q2 * Q3
# asm 1: vmulpd <2Q2=reg256#3,<Q3=reg256#5,>S5=reg256#6
# asm 2: vmulpd <2Q2=%ymm2,<Q3=%ymm4,>S5=%ymm5
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <2Q1=reg256#10,<Q3=reg256#5,>2Q1Q3=reg256#14
# asm 2: vmulpd <2Q1=%ymm9,<Q3=%ymm4,>2Q1Q3=%ymm13
# bytes: 5 uops: 1
vmulpd %ymm9,%ymm4,%ymm13
...
# asm 1: vmulpd <2Q0=reg256#8,<Q3=reg256#5,>2Q0Q3=reg256#14
# asm 2: vmulpd <2Q0=%ymm7,<Q3=%ymm4,>2Q0Q3=%ymm13
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <Q3=reg256#5,<Q3=reg256#5,>Q3Q3=reg256#14
# asm 2: vmulpd <Q3=%ymm4,<Q3=%ymm4,>Q3Q3=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd 0(<const1=int64#8),<Q3=reg256#5,>2Q3=reg256#5
# asm 2: vmulpd 0(<const1=%r10),<Q3=%ymm4,>2Q3=%ymm4
# bytes: 5 uops: 1
...
# asm 1: vmulpd <2Q3=reg256#5,<127Q4=reg256#15,>2Q3Q4=reg256#16
# asm 2: vmulpd <2Q3=%ymm4,<127Q4=%ymm14,>2Q3Q4=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <2Q2=reg256#3,<127Q4=reg256#15,>2Q2Q4=reg256#15
# asm 2: vmulpd <2Q2=%ymm2,<127Q4=%ymm14,>2Q2Q4=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <2Q3=reg256#5,<127Q5=reg256#8,>2Q3Q5=reg256#5
# asm 2: vmulpd <2Q3=%ymm4,<127Q5=%ymm7,>2Q3Q5=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <2Q3Q5=reg256#5,<S2=reg256#11,>S2=reg256#5
# asm 2: vaddpd <2Q3Q5=%ymm4,<S2=%ymm10,>S2=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm4,%ymm10,%ymm4

# qhasm:       4x 2Q2Q5 = approx 2Q2 * 127Q5
# asm 1: vmulpd <2Q2=reg256#3,<127Q5=reg256#8,>2Q2Q5=reg256#3
# asm 2: vmulpd <2Q2=%ymm2,<127Q5=%ymm7,>2Q2Q5=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm7,%ymm2

# qhasm:       4x S1 approx+= 2Q2Q5
# asm 1: vaddpd <2Q2Q5=reg256#3,<S1=reg256#9,>S1=reg256#3
# asm 2: vaddpd <2Q2Q5=%ymm2,<S1=%ymm8,>S1=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vpermilpd $0x5,<R4=reg256#1,>yxtz4=reg256#8
# asm 2: vpermilpd $0x5,<R4=%ymm0,>yxtz4=%ymm7
# bytes: 7 uops: 1
.byte 0x3e
vpermilpd $0x5,%ymm0,%ymm7

# qhasm:                           abcd4[0,1,2,3] approx= R4[0]-yxtz4[0],R4[1]+yxtz4[1],R4[2]-yxtz4[2],R4[3]+yxtz4[3]
# asm 1: vaddsubpd <yxtz4=reg256#8,<R4=reg256#1,>abcd4=reg256#1
# asm 2: vaddsubpd <yxtz4=%ymm7,<R4=%ymm0,>abcd4=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm7,%ymm0,%ymm0

# qhasm:                           cdab4[0,1,2,3] = abcd4[2,3],abcd4[0,1]
# asm 1: vperm2f128 $0x21,<abcd4=reg256#1,<abcd4=reg256#1,>cdab4=reg256#8
# asm 2: vperm2f128 $0x21,<abcd4=%ymm0,<abcd4=%ymm0,>cdab4=%ymm7
# bytes: 6 uops: 2
vperm2f128 $0x21,%ymm0,%ymm0,%ymm7
...
# bytes: 6 uops: 1
vpermilpd $0x5,%ymm0,%ymm0
# block pos: 2048 2081 uops: 6

# qhasm:                           A4[0,1,2,3] approx= badc4[0]-cdab4[0],badc4[1]+cdab4[1],badc4[2]-cdab4[2],badc4[3]+cdab4[3]
# asm 1: vaddsubpd <cdab4=reg256#8,<badc4=reg256#1,>A4=reg256#1
# asm 2: vaddsubpd <cdab4=%ymm7,<badc4=%ymm0,>A4=%ymm0
# bytes: 4 uops: 1
vaddsubpd %ymm7,%ymm0,%ymm0
...
# asm 1: vmulpd -96(<const1=int64#8),<S2=reg256#5,>c2=reg256#11
# asm 2: vmulpd -96(<const1=%r10),<S2=%ymm4,>c2=%ymm10
# bytes: 6 uops: 1
vmulpd -96(%r10),%ymm4,%ymm10

# qhasm:   4x c1 = approx S1 * mem256[const0 + 96]
# asm 1: vmulpd 96(<const0=int64#7),<S1=reg256#3,>c1=reg256#14
# asm 2: vmulpd 96(<const0=%rax),<S1=%ymm2,>c1=%ymm13
# bytes: 5 uops: 1
vmulpd 96(%rax),%ymm2,%ymm13
# block pos: 2081 2116 uops: 6
...
# asm 1: vpermilpd $0x5,<R2=reg256#4,>yxtz2=reg256#16
# asm 2: vpermilpd $0x5,<R2=%ymm3,>yxtz2=%ymm15
# bytes: 7 uops: 1
.byte 0x3e
vpermilpd $0x5,%ymm3,%ymm15

# qhasm:                           abcd2[0,1,2,3] approx= R2[0]-yxtz2[0],R2[1]+yxtz2[1],R2[2]-yxtz2[2],R2[3]+yxtz2[3]
# asm 1: vaddsubpd <yxtz2=reg256#16,<R2=reg256#4,>abcd2=reg256#4
# asm 2: vaddsubpd <yxtz2=%ymm15,<R2=%ymm3,>abcd2=%ymm3
# bytes: 7 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm15,%ymm3,%ymm3

# qhasm:                           cdab2[0,1,2,3] = abcd2[2,3],abcd2[0,1]
# asm 1: vperm2f128 $0x21,<abcd2=reg256#4,<abcd2=reg256#4,>cdab2=reg256#16
# asm 2: vperm2f128 $0x21,<abcd2=%ymm3,<abcd2=%ymm3,>cdab2=%ymm15
# bytes: 6 uops: 2
vperm2f128 $0x21,%ymm3,%ymm3,%ymm15

# qhasm:                           badc2[0,1,2,3] = abcd2[1,0,3,2]
# asm 1: vpermilpd $0x5,<abcd2=reg256#4,>badc2=reg256#4
# asm 2: vpermilpd $0x5,<abcd2=%ymm3,>badc2=%ymm3
# bytes: 6 uops: 1
vpermilpd $0x5,%ymm3,%ymm3
# block pos: 2176 2208 uops: 6

# qhasm:                           A2[0,1,2,3] approx= badc2[0]-cdab2[0],badc2[1]+cdab2[1],badc2[2]-cdab2[2],badc2[3]+cdab2[3]
# asm 1: vaddsubpd <cdab2=reg256#16,<badc2=reg256#4,>A2=reg256#4
# asm 2: vaddsubpd <cdab2=%ymm15,<badc2=%ymm3,>A2=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
vaddsubpd %ymm15,%ymm3,%ymm3
...
# asm 1: vaddpd <c1=reg256#14,<S2=reg256#5,>S2=reg256#5
# asm 2: vaddpd <c1=%ymm13,<S2=%ymm4,>S2=%ymm4
# bytes: 5 uops: 1
vaddpd %ymm13,%ymm4,%ymm4
# block pos: 2208 2240 uops: 6

# qhasm:   4x S1 approx+= c0
# asm 1: vaddpd <c0=reg256#15,<S1=reg256#3,>S1=reg256#3
# asm 2: vaddpd <c0=%ymm14,<S1=%ymm2,>S1=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vsubpd <c2=reg256#11,<S2=reg256#5,>S2=reg256#5
# asm 2: vsubpd <c2=%ymm10,<S2=%ymm4,>S2=%ymm4
# bytes: 5 uops: 1
vsubpd %ymm10,%ymm4,%ymm4

# qhasm:   4x S1 approx-= c1
# asm 1: vsubpd <c1=reg256#14,<S1=reg256#3,>S1=reg256#3
# asm 2: vsubpd <c1=%ymm13,<S1=%ymm2,>S1=%ymm2
# bytes: 5 uops: 1
...
# asm 1: vaddpd <A4=reg256#1,<a106=reg256#10,>A5=reg256#11
# asm 2: vaddpd <A4=%ymm0,<a106=%ymm9,>A5=%ymm10
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vsubpd <A5=reg256#10,<A4=reg256#1,>A4=reg256#1
# asm 2: vsubpd <A5=%ymm9,<A4=%ymm0,>A4=%ymm0
# bytes: 5 uops: 1
...
# asm 1: vaddpd <A2=reg256#4,<a64=reg256#11,>A3=reg256#12
# asm 2: vaddpd <A2=%ymm3,<a64=%ymm10,>A3=%ymm11
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <A3=reg256#11,<A2=reg256#4,>A2=reg256#4
# asm 2: vsubpd <A3=%ymm10,<A2=%ymm3,>A2=%ymm3
# bytes: 5 uops: 1
...
# asm 1: vmulpd <S2=reg256#5,<abcd=reg256#13,>S2=reg256#5
# asm 2: vmulpd <S2=%ymm4,<abcd=%ymm12,>S2=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <S1=reg256#3,<abcd=reg256#13,>S1=reg256#3
# asm 2: vmulpd <S1=%ymm2,<abcd=%ymm12,>S1=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
...
# qhasm:   4x c1 = approx S1 * mem256[const0 + 96]
# asm 1: vmulpd 96(<const0=int64#7),<S1=reg256#3,>c1=reg256#15
# asm 2: vmulpd 96(<const0=%rax),<S1=%ymm2,>c1=%ymm14
# bytes: 5 uops: 1
vmulpd 96(%rax),%ymm2,%ymm14
...
# qhasm:   4x S2 approx+= c1
# asm 1: vaddpd <c1=reg256#15,<S2=reg256#5,>S2=reg256#5
# asm 2: vaddpd <c1=%ymm14,<S2=%ymm4,>S2=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <S3=reg256#8,<S2=reg256#5,>S2=reg256#5
# asm 2: vaddpd <S3=%ymm7,<S2=%ymm4,>S2=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
...
# qhasm:   4x S1 approx-= c1
# asm 1: vsubpd <c1=reg256#15,<S1=reg256#3,>S1=reg256#3
# asm 2: vsubpd <c1=%ymm14,<S1=%ymm2,>S1=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
vsubpd %ymm14,%ymm2,%ymm2

# qhasm:   4x S0 approx+= S1
# asm 1: vaddpd <S1=reg256#3,<S0=reg256#7,>S0=reg256#3
# asm 2: vaddpd <S1=%ymm2,<S0=%ymm6,>S0=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vpermilpd $0x5,<S2=reg256#5,>yxtz2=reg256#7
# asm 2: vpermilpd $0x5,<S2=%ymm4,>yxtz2=%ymm6
# bytes: 6 uops: 1
vpermilpd $0x5,%ymm4,%ymm6

# qhasm:   abcd2[0,1,2,3] approx= S2[0]-yxtz2[0],S2[1]+yxtz2[1],S2[2]-yxtz2[2],S2[3]+yxtz2[3]
# asm 1: vaddsubpd <yxtz2=reg256#7,<S2=reg256#5,>abcd2=reg256#5
# asm 2: vaddsubpd <yxtz2=%ymm6,<S2=%ymm4,>abcd2=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# qhasm:   cdab2[0,1,2,3] = abcd2[2,3],abcd2[0,1]
# asm 1: vperm2f128 $0x21,<abcd2=reg256#5,<abcd2=reg256#5,>cdab2=reg256#7
# asm 2: vperm2f128 $0x21,<abcd2=%ymm4,<abcd2=%ymm4,>cdab2=%ymm6
# bytes: 7 uops: 2
.byte 0x3e
...
# asm 1: vaddsubpd <cdab2=reg256#7,<badc2=reg256#5,>B2=reg256#5
# asm 2: vaddsubpd <cdab2=%ymm6,<badc2=%ymm4,>B2=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm6,%ymm4,%ymm4
...
# asm 1: vpermilpd $0x5,<S0=reg256#3,>yxtz0=reg256#7
# asm 2: vpermilpd $0x5,<S0=%ymm2,>yxtz0=%ymm6
# bytes: 6 uops: 1
vpermilpd $0x5,%ymm2,%ymm6

# qhasm:   abcd0[0,1,2,3] approx= S0[0]-yxtz0[0],S0[1]+yxtz0[1],S0[2]-yxtz0[2],S0[3]+yxtz0[3]
# asm 1: vaddsubpd <yxtz0=reg256#7,<S0=reg256#3,>abcd0=reg256#3
# asm 2: vaddsubpd <yxtz0=%ymm6,<S0=%ymm2,>abcd0=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm6,%ymm2,%ymm2
...
# asm 1: vaddsubpd <cdab0=reg256#7,<badc0=reg256#3,>B0=reg256#3
# asm 2: vaddsubpd <cdab0=%ymm6,<badc0=%ymm2,>B0=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vaddsubpd %ymm6,%ymm2,%ymm2
...
# asm 1: vaddpd <A4=reg256#1,<A4=reg256#1,>2A4=reg256#8
# asm 2: vaddpd <A4=%ymm0,<A4=%ymm0,>2A4=%ymm7
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <A2=reg256#4,<2A3=reg256#9,>2a2a3=reg256#13
# asm 2: vmulpd <A2=%ymm3,<2A3=%ymm8,>2a2a3=%ymm12
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <A2=reg256#4,<A2=reg256#4,>a2a2=reg256#14
# asm 2: vmulpd <A2=%ymm3,<A2=%ymm3,>a2a2=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <A2=reg256#4,<A2=reg256#4,>2A2=reg256#4
# asm 2: vaddpd <A2=%ymm3,<A2=%ymm3,>2A2=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <A1=reg256#12,<2A2=reg256#4,>2a1a2=reg256#14
# asm 2: vmulpd <A1=%ymm11,<2A2=%ymm3,>2a1a2=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm11,%ymm3,%ymm13
...
# asm 1: vmulpd -128(<const1=int64#8),<A4=reg256#1,>127a4=reg256#14
# asm 2: vmulpd -128(<const1=%r10),<A4=%ymm0,>127a4=%ymm13
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm0,%ymm13
...
# asm 1: vaddpd <2a3a5=reg256#15,<C2=reg256#1,>C2=reg256#1
# asm 2: vaddpd <2a3a5=%ymm14,<C2=%ymm0,>C2=%ymm0
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm0,%ymm0
# block pos: 2784 2816 uops: 6

# qhasm:                               4x 2a0a2 = approx A0 * 2A2
# asm 1: vmulpd <A0=reg256#2,<2A2=reg256#4,>2a0a2=reg256#15
# asm 2: vmulpd <A0=%ymm1,<2A2=%ymm3,>2a0a2=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <2a0a2=reg256#15,<C2=reg256#1,>C2=reg256#1
# asm 2: vaddpd <2a0a2=%ymm14,<C2=%ymm0,>C2=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm0,%ymm0
...
# asm 1: vaddpd <a1a1=reg256#15,<C2=reg256#1,>C2=reg256#1
# asm 2: vaddpd <a1a1=%ymm14,<C2=%ymm0,>C2=%ymm0
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm0,%ymm0
...
# asm 1: vmulpd <2A2=reg256#4,<127a5=reg256#13,>2a2a5=reg256#15
# asm 2: vmulpd <2A2=%ymm3,<127a5=%ymm12,>2a2a5=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# block pos: 2848 2880 uops: 6

# qhasm:                               4x 2a2a4 = approx 2A2 * 127a4
# asm 1: vmulpd <2A2=reg256#4,<127a4=reg256#14,>2a2a4=reg256#4
# asm 2: vmulpd <2A2=%ymm3,<127a4=%ymm13,>2a2a4=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <2a2a4=reg256#4,<C0=reg256#11,>C0=reg256#4
# asm 2: vaddpd <2a2a4=%ymm3,<C0=%ymm10,>C0=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <2a1a5=reg256#11,<C0=reg256#4,>C0=reg256#4
# asm 2: vaddpd <2a1a5=%ymm10,<C0=%ymm3,>C0=%ymm3
# bytes: 5 uops: 1
...
# asm 1: vaddpd <a0a0=reg256#2,<C0=reg256#4,>C0=reg256#2
# asm 2: vaddpd <a0a0=%ymm1,<C0=%ymm3,>C0=%ymm1
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm1,%ymm3,%ymm1
# block pos: 2880 2913 uops: 6

# qhasm:                           4x c5 = approx C5 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<C5=reg256#7,>c5=reg256#4
# asm 2: vmulpd -128(<const1=%r10),<C5=%ymm6,>c5=%ymm3
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm6,%ymm3
...
# qhasm:    a22 aligned= mem256[const2 - 128]
# asm 1: vmovapd   -128(<const2=int64#9),>a22=reg256#11
# asm 2: vmovapd   -128(<const2=%r11),>a22=%ymm10
# bytes: 6 uops: 1
vmovapd   -128(%r11),%ymm10

# qhasm:    4x B1 = approx B0 + a22
# asm 1: vaddpd <B0=reg256#3,<a22=reg256#11,>B1=reg256#12
# asm 2: vaddpd <B0=%ymm2,<a22=%ymm10,>B1=%ymm11
# bytes: 4 uops: 1
vaddpd %ymm2,%ymm10,%ymm11

# qhasm:    4x B1 approx-= a22
# asm 1: vsubpd <a22=reg256#11,<B1=reg256#12,>B1=reg256#11
# asm 2: vsubpd <a22=%ymm10,<B1=%ymm11,>B1=%ymm10
# bytes: 5 uops: 1
vsubpd %ymm10,%ymm11,%ymm10

# qhasm:    4x B0 approx-= B1
# asm 1: vsubpd <B1=reg256#11,<B0=reg256#3,>B0=reg256#3
# asm 2: vsubpd <B1=%ymm10,<B0=%ymm2,>B0=%ymm2
# bytes: 5 uops: 1
vsubpd %ymm10,%ymm2,%ymm2

# qhasm:    4x B3 = approx B2 * mem256[const1 - 96]
# asm 1: vmulpd -96(<const1=int64#8),<B2=reg256#5,>B3=reg256#12
# asm 2: vmulpd -96(<const1=%r10),<B2=%ymm4,>B3=%ymm11
# bytes: 6 uops: 1
vmulpd -96(%r10),%ymm4,%ymm11
# block pos: 2944 2977 uops: 6
...
# asm 1: vsubpd <B3=reg256#12,<B2=reg256#5,>B2=reg256#5
# asm 2: vsubpd <B3=%ymm11,<B2=%ymm4,>B2=%ymm4
# bytes: 5 uops: 1
...
# qhasm:    a106 aligned= mem256[const2 + 0]
# asm 1: vmovapd   0(<const2=int64#9),>a106=reg256#13
# asm 2: vmovapd   0(<const2=%r11),>a106=%ymm12
# bytes: 5 uops: 1
vmovapd   0(%r11),%ymm12

# qhasm:    4x B5 = approx B4 + a106
# asm 1: vaddpd <B4=reg256#6,<a106=reg256#13,>B5=reg256#14
# asm 2: vaddpd <B4=%ymm5,<a106=%ymm12,>B5=%ymm13
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm5,%ymm12,%ymm13

# qhasm:    4x B5 approx-= a106
# asm 1: vsubpd <a106=reg256#13,<B5=reg256#14,>B5=reg256#13
# asm 2: vsubpd <a106=%ymm12,<B5=%ymm13,>B5=%ymm12
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm13,%ymm12

# qhasm:    4x B4 approx-= B5
# asm 1: vsubpd <B5=reg256#13,<B4=reg256#6,>B4=reg256#6
# asm 2: vsubpd <B5=%ymm12,<B4=%ymm5,>B4=%ymm5
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm5,%ymm5
...
# asm 1: vmulpd -96(<const1=int64#8),<C2=reg256#1,>c2=reg256#10
# asm 2: vmulpd -96(<const1=%r10),<C2=%ymm0,>c2=%ymm9
# bytes: 6 uops: 1
...
# asm 1: vsubpd <c2=reg256#10,<C2=reg256#1,>C2=reg256#1
# asm 2: vsubpd <c2=%ymm9,<C2=%ymm0,>C2=%ymm0
# bytes: 5 uops: 1
vsubpd %ymm9,%ymm0,%ymm0
...
# asm 1: vaddpd <c1=reg256#10,<C2=reg256#1,>C2=reg256#1
# asm 2: vaddpd <c1=%ymm9,<C2=%ymm0,>C2=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vmulpd 64(<const0=int64#7),<C0=reg256#2,>c0=reg256#10
# asm 2: vmulpd 64(<const0=%rax),<C0=%ymm1,>c0=%ymm9
# bytes: 5 uops: 1
vmulpd 64(%rax),%ymm1,%ymm9
# block pos: 3072 3104 uops: 6

# qhasm:                           4x C0 approx+= c5
# asm 1: vaddpd <c5=reg256#4,<C0=reg256#2,>C0=reg256#2
# asm 2: vaddpd <c5=%ymm3,<C0=%ymm1,>C0=%ymm1
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <c5=reg256#4,<C5=reg256#7,>C5=reg256#4
# asm 2: vsubpd <c5=%ymm3,<C5=%ymm6,>C5=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vsubpd <c0=reg256#7,<C0=reg256#2,>C0=reg256#2
# asm 2: vsubpd <c0=%ymm6,<C0=%ymm1,>C0=%ymm1
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
vsubpd %ymm6,%ymm1,%ymm1
...
# asm 1: vmovapd   <C5=reg256#4,32(<work2=int64#6)
# asm 2: vmovapd   <C5=%ymm3,32(<work2=%r9)
# bytes: 6 uops: 1
vmovapd   %ymm3,32(%r9)

# qhasm:     two aligned= mem256[const1 + 0]
# asm 1: vmovapd   0(<const1=int64#8),>two=reg256#4
# asm 2: vmovapd   0(<const1=%r10),>two=%ymm3
# bytes: 5 uops: 1
vmovapd   0(%r10),%ymm3

# qhasm:     4x 2B5 = approx B5 * two
# asm 1: vmulpd <B5=reg256#13,<two=reg256#4,>2B5=reg256#7
# asm 2: vmulpd <B5=%ymm12,<two=%ymm3,>2B5=%ymm6
# bytes: 5 uops: 1
...
# asm 1: vmulpd <B3=reg256#12,<two=reg256#4,>2B3=reg256#4
# asm 2: vmulpd <B3=%ymm11,<two=%ymm3,>2B3=%ymm3
# bytes: 5 uops: 1
vmulpd %ymm11,%ymm3,%ymm3
# block pos: 3136 3168 uops: 6

# qhasm:       4x D5 = approx B0 * 2B5
# asm 1: vmulpd <B0=reg256#3,<2B5=reg256#7,>D5=reg256#7
# asm 2: vmulpd <B0=%ymm2,<2B5=%ymm6,>D5=%ymm6
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <B1=reg256#11,<2B4=reg256#10,>2B1B4=reg256#14
# asm 2: vmulpd <B1=%ymm10,<2B4=%ymm9,>2B1B4=%ymm13
# bytes: 5 uops: 1
vmulpd %ymm10,%ymm9,%ymm13
...
# asm 1: vmulpd <B2=reg256#5,<2B3=reg256#4,>2B2B3=reg256#14
# asm 2: vmulpd <B2=%ymm4,<2B3=%ymm3,>2B2B3=%ymm13
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd -128(<const1=int64#8),<B5=reg256#13,>127B5=reg256#14
# asm 2: vmulpd -128(<const1=%r10),<B5=%ymm12,>127B5=%ymm13
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm12,%ymm13
# block pos: 3168 3200 uops: 6

# qhasm:       4x D4 = approx B5 * 127B5
# asm 1: vmulpd <B5=reg256#13,<127B5=reg256#14,>D4=reg256#13
# asm 2: vmulpd <B5=%ymm12,<127B5=%ymm13,>D4=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm12,%ymm13,%ymm12

# qhasm:       4x 2B0B4 = approx B0 * 2B4
# asm 1: vmulpd <B0=reg256#3,<2B4=reg256#10,>2B0B4=reg256#15
# asm 2: vmulpd <B0=%ymm2,<2B4=%ymm9,>2B0B4=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vaddpd <2B0B4=reg256#15,<D4=reg256#13,>D4=reg256#13
# asm 2: vaddpd <2B0B4=%ymm14,<D4=%ymm12,>D4=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm12,%ymm12

# qhasm:       4x 2B1B3 = approx B1 * 2B3
# asm 1: vmulpd <B1=reg256#11,<2B3=reg256#4,>2B1B3=reg256#15
# asm 2: vmulpd <B1=%ymm10,<2B3=%ymm3,>2B1B3=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm10,%ymm3,%ymm14

# qhasm:       4x D4 approx+= 2B1B3
# asm 1: vaddpd <2B1B3=reg256#15,<D4=reg256#13,>D4=reg256#13
# asm 2: vaddpd <2B1B3=%ymm14,<D4=%ymm12,>D4=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm12,%ymm12

# qhasm:       4x B2B2 = approx B2 * B2
# asm 1: vmulpd <B2=reg256#5,<B2=reg256#5,>B2B2=reg256#15
# asm 2: vmulpd <B2=%ymm4,<B2=%ymm4,>B2B2=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <B2B2=reg256#15,<D4=reg256#13,>D4=reg256#13
# asm 2: vaddpd <B2B2=%ymm14,<D4=%ymm12,>D4=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm12,%ymm12

# qhasm:     4x 2B2 = approx B2 + B2
# asm 1: vaddpd <B2=reg256#5,<B2=reg256#5,>2B2=reg256#5
# asm 2: vaddpd <B2=%ymm4,<B2=%ymm4,>2B2=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <B0=reg256#3,<2B3=reg256#4,>2B0B3=reg256#15
# asm 2: vmulpd <B0=%ymm2,<2B3=%ymm3,>2B0B3=%ymm14
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <B1=reg256#11,<2B2=reg256#5,>2B1B2=reg256#15
# asm 2: vmulpd <B1=%ymm10,<2B2=%ymm4,>2B1B2=%ymm14
# bytes: 5 uops: 1
...
# asm 1: vmulpd <2B3=reg256#4,<127B5=reg256#14,>2B3B5=reg256#16
# asm 2: vmulpd <2B3=%ymm3,<127B5=%ymm13,>2B3B5=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <B0=reg256#3,<2B2=reg256#5,>2B0B2=reg256#16
# asm 2: vmulpd <B0=%ymm2,<2B2=%ymm4,>2B0B2=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <B1=reg256#11,<B1=reg256#11,>B1B1=reg256#16
# asm 2: vmulpd <B1=%ymm10,<B1=%ymm10,>B1B1=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <B1=reg256#11,<B1=reg256#11,>2B1=reg256#11
# asm 2: vaddpd <B1=%ymm10,<B1=%ymm10,>2B1=%ymm10
# bytes: 5 uops: 1
vaddpd %ymm10,%ymm10,%ymm10

# qhasm:       4x D1 = approx 2B3 * 127B4
# asm 1: vmulpd <2B3=reg256#4,<127B4=reg256#15,>D1=reg256#4
# asm 2: vmulpd <2B3=%ymm3,<127B4=%ymm14,>D1=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm3,%ymm14,%ymm3

# qhasm:       4x 2B2B5 = approx 2B2 * 127B5
# asm 1: vmulpd <2B2=reg256#5,<127B5=reg256#14,>2B2B5=reg256#16
# asm 2: vmulpd <2B2=%ymm4,<127B5=%ymm13,>2B2B5=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <2B2B5=reg256#16,<D1=reg256#4,>D1=reg256#4
# asm 2: vaddpd <2B2B5=%ymm15,<D1=%ymm3,>D1=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm3,%ymm3

# qhasm:       4x 2B0B1 = approx B0 * 2B1
# asm 1: vmulpd <B0=reg256#3,<2B1=reg256#11,>2B0B1=reg256#16
# asm 2: vmulpd <B0=%ymm2,<2B1=%ymm10,>2B0B1=%ymm15
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm10,%ymm15

# qhasm:       4x D1 approx+= 2B0B1
# asm 1: vaddpd <2B0B1=reg256#16,<D1=reg256#4,>D1=reg256#4
# asm 2: vaddpd <2B0B1=%ymm15,<D1=%ymm3,>D1=%ymm3
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm3,%ymm3
...
# asm 1: vmulpd <2B2=reg256#5,<127B4=reg256#15,>2B2B4=reg256#5
# asm 2: vmulpd <2B2=%ymm4,<127B4=%ymm14,>2B2B4=%ymm4
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm4,%ymm14,%ymm4
# block pos: 3328 3360 uops: 6

# qhasm:       4x D0 approx+= 2B2B4
# asm 1: vaddpd <2B2B4=reg256#5,<D0=reg256#12,>D0=reg256#5
# asm 2: vaddpd <2B2B4=%ymm4,<D0=%ymm11,>D0=%ymm4
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <2B1=reg256#11,<127B5=reg256#14,>2B1B5=reg256#11
# asm 2: vmulpd <2B1=%ymm10,<127B5=%ymm13,>2B1B5=%ymm10
# bytes: 5 uops: 1
vmulpd %ymm10,%ymm13,%ymm10

# qhasm:       4x D0 approx+= 2B1B5
# asm 1: vaddpd <2B1B5=reg256#11,<D0=reg256#5,>D0=reg256#5
# asm 2: vaddpd <2B1B5=%ymm10,<D0=%ymm4,>D0=%ymm4
# bytes: 5 uops: 1
vaddpd %ymm10,%ymm4,%ymm4

# qhasm:       4x B0B0 = approx B0 * B0
# asm 1: vmulpd <B0=reg256#3,<B0=reg256#3,>B0B0=reg256#3
# asm 2: vmulpd <B0=%ymm2,<B0=%ymm2,>B0B0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm2,%ymm2

# qhasm:       4x D0 approx+= B0B0
# asm 1: vaddpd <B0B0=reg256#3,<D0=reg256#5,>D0=reg256#3
# asm 2: vaddpd <B0B0=%ymm2,<D0=%ymm4,>D0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
...
# block pos: 3360 3394 uops: 6

# qhasm:   4x c4 = approx D4 * mem256[const1 - 32]
# asm 1: vmulpd -32(<const1=int64#8),<D4=reg256#13,>c4=reg256#11
# asm 2: vmulpd -32(<const1=%r10),<D4=%ymm12,>c4=%ymm10
# bytes: 6 uops: 1
vmulpd -32(%r10),%ymm12,%ymm10

# qhasm:   4x c3 = approx D3 * mem256[const1 - 64]
# asm 1: vmulpd -64(<const1=int64#8),<D3=reg256#10,>c3=reg256#12
# asm 2: vmulpd -64(<const1=%r10),<D3=%ymm9,>c3=%ymm11
# bytes: 6 uops: 1
vmulpd -64(%r10),%ymm9,%ymm11
...
# asm 1: vmulpd 96(<const0=int64#7),<D1=reg256#4,>c1=reg256#15
# asm 2: vmulpd 96(<const0=%rax),<D1=%ymm3,>c1=%ymm14
# bytes: 5 uops: 1
vmulpd 96(%rax),%ymm3,%ymm14
...
# qhasm:   4x c3 = round(c3)
# asm 1: vroundpd $8,<c3=reg256#12,>c3=reg256#12
# asm 2: vroundpd $8,<c3=%ymm11,>c3=%ymm11
# bytes: 6 uops: 1
vroundpd $8,%ymm11,%ymm11
...
# qhasm:   4x c3 approx*= mem256[const0 - 32]
# asm 1: vmulpd -32(<const0=int64#7),<c3=reg256#12,>c3=reg256#12
# asm 2: vmulpd -32(<const0=%rax),<c3=%ymm11,>c3=%ymm11
# bytes: 5 uops: 1
vmulpd -32(%rax),%ymm11,%ymm11
...
# asm 1: vaddpd <c4=reg256#11,<D5=reg256#7,>D5=reg256#7
# asm 2: vaddpd <c4=%ymm10,<D5=%ymm6,>D5=%ymm6
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm10,%ymm6,%ymm6

# qhasm:   4x D4 approx+= c3
# asm 1: vaddpd <c3=reg256#12,<D4=reg256#13,>D4=reg256#13
# asm 2: vaddpd <c3=%ymm11,<D4=%ymm12,>D4=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <c0=reg256#16,<D1=reg256#4,>D1=reg256#4
# asm 2: vaddpd <c0=%ymm15,<D1=%ymm3,>D1=%ymm3
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm3,%ymm3
...
# asm 1: vsubpd <c4=reg256#11,<D4=reg256#13,>D4=reg256#7
# asm 2: vsubpd <c4=%ymm10,<D4=%ymm12,>D4=%ymm6
# bytes: 5 uops: 1
vsubpd %ymm10,%ymm12,%ymm6

# qhasm:   4x D3 approx-= c3
# asm 1: vsubpd <c3=reg256#12,<D3=reg256#10,>D3=reg256#10
# asm 2: vsubpd <c3=%ymm11,<D3=%ymm9,>D3=%ymm9
# bytes: 5 uops: 1
...
# asm 1: vsubpd <c1=reg256#15,<D1=reg256#4,>D1=reg256#4
# asm 2: vsubpd <c1=%ymm14,<D1=%ymm3,>D1=%ymm3
# bytes: 5 uops: 1
vsubpd %ymm14,%ymm3,%ymm3

# qhasm:     mem256[work1 - 96] aligned= D1
# asm 1: vmovapd   <D1=reg256#4,-96(<work1=int64#5)
# asm 2: vmovapd   <D1=%ymm3,-96(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm3,-96(%r8)

# qhasm:   4x D0 approx-= c0
# asm 1: vsubpd <c0=reg256#16,<D0=reg256#3,>D0=reg256#3
# asm 2: vsubpd <c0=%ymm15,<D0=%ymm2,>D0=%ymm2
# bytes: 5 uops: 1
vsubpd %ymm15,%ymm2,%ymm2

# qhasm:     mem256[work1 - 128] aligned= D0
# asm 1: vmovapd   <D0=reg256#3,-128(<work1=int64#5)
# asm 2: vmovapd   <D0=%ymm2,-128(<work1=%r8)
# bytes: 6 uops: 1
vmovapd   %ymm2,-128(%r8)

# qhasm:                           a0 aligned= mem256[work0 - 128]
# asm 1: vmovapd   -128(<work0=int64#3),>a0=reg256#3
# asm 2: vmovapd   -128(<work0=%rdx),>a0=%ymm2
# bytes: 5 uops: 1
vmovapd   -128(%rdx),%ymm2

# qhasm:                           C4 aligned= mem256[work2 +   0]
# asm 1: vmovapd   0(<work2=int64#6),>C4=reg256#4
# asm 2: vmovapd   0(<work2=%r9),>C4=%ymm3
# bytes: 5 uops: 1
vmovapd   0(%r9),%ymm3
# block pos: 3552 3584 uops: 6

# qhasm:                           C5 aligned= mem256[work2 +  32]
# asm 1: vmovapd   32(<work2=int64#6),>C5=reg256#6
# asm 2: vmovapd   32(<work2=%r9),>C5=%ymm5
# bytes: 6 uops: 1
vmovapd   32(%r9),%ymm5

# qhasm:                                     4x E0 = approx a0 * C0
# asm 1: vmulpd <a0=reg256#3,<C0=reg256#2,>E0=reg256#10
# asm 2: vmulpd <a0=%ymm2,<C0=%ymm1,>E0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <a0=reg256#3,<C1=reg256#9,>E1=reg256#11
# asm 2: vmulpd <a0=%ymm2,<C1=%ymm8,>E1=%ymm10
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm8,%ymm10

# qhasm:                                 4x E2 = approx a0 * C2
# asm 1: vmulpd <a0=reg256#3,<C2=reg256#1,>E2=reg256#12
# asm 2: vmulpd <a0=%ymm2,<C2=%ymm0,>E2=%ymm11
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm0,%ymm11

# qhasm:                               4x E3 = approx a0 * C3
# asm 1: vmulpd <a0=reg256#3,<C3=reg256#8,>E3=reg256#13
# asm 2: vmulpd <a0=%ymm2,<C3=%ymm7,>E3=%ymm12
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm7,%ymm12

# qhasm:                             4x E4 = approx a0 * C4
# asm 1: vmulpd <a0=reg256#3,<C4=reg256#4,>E4=reg256#14
# asm 2: vmulpd <a0=%ymm2,<C4=%ymm3,>E4=%ymm13
# bytes: 5 uops: 1
.byte 0x3e
vmulpd %ymm2,%ymm3,%ymm13
# block pos: 3584 3616 uops: 6

# qhasm:                           4x E5 = approx a0 * C5
# asm 1: vmulpd <a0=reg256#3,<C5=reg256#6,>E5=reg256#3
# asm 2: vmulpd <a0=%ymm2,<C5=%ymm5,>E5=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <127a1=reg256#15,<C5=reg256#6,>a1b5=reg256#15
# asm 2: vmulpd <127a1=%ymm14,<C5=%ymm5,>a1b5=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm5,%ymm14

# qhasm:                                     4x E0 approx+= a1b5
# asm 1: vaddpd <a1b5=reg256#15,<E0=reg256#10,>E0=reg256#10
# asm 2: vaddpd <a1b5=%ymm14,<E0=%ymm9,>E0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm9,%ymm9

# qhasm:                           a1 aligned= mem256[work0 - 96]
# asm 1: vmovapd   -96(<work0=int64#3),>a1=reg256#15
# asm 2: vmovapd   -96(<work0=%rdx),>a1=%ymm14
# bytes: 5 uops: 1
vmovapd   -96(%rdx),%ymm14

# qhasm:                                   4x a1b0 = approx a1 * C0
# asm 1: vmulpd <a1=reg256#15,<C0=reg256#2,>a1b0=reg256#16
# asm 2: vmulpd <a1=%ymm14,<C0=%ymm1,>a1b0=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm1,%ymm15
# block pos: 3616 3648 uops: 6

# qhasm: 			          4x E1 approx+= a1b0
# asm 1: vaddpd <a1b0=reg256#16,<E1=reg256#11,>E1=reg256#11
# asm 2: vaddpd <a1b0=%ymm15,<E1=%ymm10,>E1=%ymm10
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm10,%ymm10

# qhasm:                                 4x a1b1 = approx a1 * C1
# asm 1: vmulpd <a1=reg256#15,<C1=reg256#9,>a1b1=reg256#16
# asm 2: vmulpd <a1=%ymm14,<C1=%ymm8,>a1b1=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm8,%ymm15

# qhasm:                                 4x E2 approx+= a1b1
# asm 1: vaddpd <a1b1=reg256#16,<E2=reg256#12,>E2=reg256#12
# asm 2: vaddpd <a1b1=%ymm15,<E2=%ymm11,>E2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm11,%ymm11

# qhasm:                               4x a1b2 = approx a1 * C2
# asm 1: vmulpd <a1=reg256#15,<C2=reg256#1,>a1b2=reg256#16
# asm 2: vmulpd <a1=%ymm14,<C2=%ymm0,>a1b2=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm0,%ymm15

# qhasm:                               4x E3 approx+= a1b2
# asm 1: vaddpd <a1b2=reg256#16,<E3=reg256#13,>E3=reg256#13
# asm 2: vaddpd <a1b2=%ymm15,<E3=%ymm12,>E3=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm12,%ymm12

# qhasm:                             4x a1b3 = approx a1 * C3
# asm 1: vmulpd <a1=reg256#15,<C3=reg256#8,>a1b3=reg256#16
# asm 2: vmulpd <a1=%ymm14,<C3=%ymm7,>a1b3=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm7,%ymm15
# block pos: 3648 3680 uops: 6

# qhasm:                             4x E4 approx+= a1b3
# asm 1: vaddpd <a1b3=reg256#16,<E4=reg256#14,>E4=reg256#14
# asm 2: vaddpd <a1b3=%ymm15,<E4=%ymm13,>E4=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm13,%ymm13

# qhasm:                           4x a1b4 = approx a1 * C4
# asm 1: vmulpd <a1=reg256#15,<C4=reg256#4,>a1b4=reg256#15
# asm 2: vmulpd <a1=%ymm14,<C4=%ymm3,>a1b4=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm3,%ymm14

# qhasm:                           4x E5 approx+= a1b4
# asm 1: vaddpd <a1b4=reg256#15,<E5=reg256#3,>E5=reg256#3
# asm 2: vaddpd <a1b4=%ymm14,<E5=%ymm2,>E5=%ymm2
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm2,%ymm2
...
# asm 1: vmulpd <127a2=reg256#15,<C4=reg256#4,>a2b4=reg256#16
# asm 2: vmulpd <127a2=%ymm14,<C4=%ymm3,>a2b4=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm3,%ymm15

# qhasm:                                     4x E0 approx+= a2b4
# asm 1: vaddpd <a2b4=reg256#16,<E0=reg256#10,>E0=reg256#10
# asm 2: vaddpd <a2b4=%ymm15,<E0=%ymm9,>E0=%ymm9
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm9,%ymm9
# block pos: 3680 3712 uops: 6

# qhasm:                                   4x a2b5 = approx 127a2 * C5
# asm 1: vmulpd <127a2=reg256#15,<C5=reg256#6,>a2b5=reg256#15
# asm 2: vmulpd <127a2=%ymm14,<C5=%ymm5,>a2b5=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm5,%ymm14

# qhasm:                                   4x E1 approx+= a2b5
# asm 1: vaddpd <a2b5=reg256#15,<E1=reg256#11,>E1=reg256#11
# asm 2: vaddpd <a2b5=%ymm14,<E1=%ymm10,>E1=%ymm10
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <a2=reg256#15,<C0=reg256#2,>a2b0=reg256#16
# asm 2: vmulpd <a2=%ymm14,<C0=%ymm1,>a2b0=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm1,%ymm15

# qhasm: 			        4x E2 approx+= a2b0
# asm 1: vaddpd <a2b0=reg256#16,<E2=reg256#12,>E2=reg256#12
# asm 2: vaddpd <a2b0=%ymm15,<E2=%ymm11,>E2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm11,%ymm11
...
# asm 1: vaddpd <a2b1=reg256#16,<E3=reg256#13,>E3=reg256#13
# asm 2: vaddpd <a2b1=%ymm15,<E3=%ymm12,>E3=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm12,%ymm12

# qhasm:                             4x a2b2 = approx a2 * C2
# asm 1: vmulpd <a2=reg256#15,<C2=reg256#1,>a2b2=reg256#16
# asm 2: vmulpd <a2=%ymm14,<C2=%ymm0,>a2b2=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm0,%ymm15

# qhasm:                             4x E4 approx+= a2b2
# asm 1: vaddpd <a2b2=reg256#16,<E4=reg256#14,>E4=reg256#14
# asm 2: vaddpd <a2b2=%ymm15,<E4=%ymm13,>E4=%ymm13
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm13,%ymm13

# qhasm:                           4x a2b3 = approx a2 * C3
# asm 1: vmulpd <a2=reg256#15,<C3=reg256#8,>a2b3=reg256#15
# asm 2: vmulpd <a2=%ymm14,<C3=%ymm7,>a2b3=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm7,%ymm14

# qhasm:                           4x E5 approx+= a2b3
# asm 1: vaddpd <a2b3=reg256#15,<E5=reg256#3,>E5=reg256#3
# asm 2: vaddpd <a2b3=%ymm14,<E5=%ymm2,>E5=%ymm2
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm2,%ymm2
...
# asm 1: vmulpd <127a3=reg256#15,<C3=reg256#8,>a3b3=reg256#16
# asm 2: vmulpd <127a3=%ymm14,<C3=%ymm7,>a3b3=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm7,%ymm15

# qhasm:                                     4x E0 approx+= a3b3
# asm 1: vaddpd <a3b3=reg256#16,<E0=reg256#10,>E0=reg256#10
# asm 2: vaddpd <a3b3=%ymm15,<E0=%ymm9,>E0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm9,%ymm9

# qhasm:                                   4x a3b4 = approx 127a3 * C4
# asm 1: vmulpd <127a3=reg256#15,<C4=reg256#4,>a3b4=reg256#16
# asm 2: vmulpd <127a3=%ymm14,<C4=%ymm3,>a3b4=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm3,%ymm15

# qhasm:                                   4x E1 approx+= a3b4
# asm 1: vaddpd <a3b4=reg256#16,<E1=reg256#11,>E1=reg256#11
# asm 2: vaddpd <a3b4=%ymm15,<E1=%ymm10,>E1=%ymm10
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm10,%ymm10

# qhasm:                                 4x a3b5 = approx 127a3 * C5
# asm 1: vmulpd <127a3=reg256#15,<C5=reg256#6,>a3b5=reg256#15
# asm 2: vmulpd <127a3=%ymm14,<C5=%ymm5,>a3b5=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm5,%ymm14

# qhasm:                                 4x E2 approx+= a3b5
# asm 1: vaddpd <a3b5=reg256#15,<E2=reg256#12,>E2=reg256#12
# asm 2: vaddpd <a3b5=%ymm14,<E2=%ymm11,>E2=%ymm11
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm11,%ymm11
...
# asm 1: vmulpd <a3=reg256#15,<C0=reg256#2,>a3b0=reg256#16
# asm 2: vmulpd <a3=%ymm14,<C0=%ymm1,>a3b0=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm1,%ymm15

# qhasm: 			      4x E3 approx+= a3b0
# asm 1: vaddpd <a3b0=reg256#16,<E3=reg256#13,>E3=reg256#13
# asm 2: vaddpd <a3b0=%ymm15,<E3=%ymm12,>E3=%ymm12
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm12,%ymm12
...
# asm 1: vaddpd <a3b1=reg256#16,<E4=reg256#14,>E4=reg256#14
# asm 2: vaddpd <a3b1=%ymm15,<E4=%ymm13,>E4=%ymm13
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm13,%ymm13

# qhasm:                           4x a3b2 = approx a3 * C2
# asm 1: vmulpd <a3=reg256#15,<C2=reg256#1,>a3b2=reg256#15
# asm 2: vmulpd <a3=%ymm14,<C2=%ymm0,>a3b2=%ymm14
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm0,%ymm14
# block pos: 3808 3840 uops: 6

# qhasm:                           4x E5 approx+= a3b2
# asm 1: vaddpd <a3b2=reg256#15,<E5=reg256#3,>E5=reg256#3
# asm 2: vaddpd <a3b2=%ymm14,<E5=%ymm2,>E5=%ymm2
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm14,%ymm2,%ymm2
...
# asm 1: vmulpd <127a4=reg256#15,<C2=reg256#1,>a4b2=reg256#16
# asm 2: vmulpd <127a4=%ymm14,<C2=%ymm0,>a4b2=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm0,%ymm15

# qhasm:                                     4x E0 approx+= a4b2
# asm 1: vaddpd <a4b2=reg256#16,<E0=reg256#10,>E0=reg256#10
# asm 2: vaddpd <a4b2=%ymm15,<E0=%ymm9,>E0=%ymm9
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm9,%ymm9
...
# asm 1: vaddpd <a4b3=reg256#16,<E1=reg256#11,>E1=reg256#11
# asm 2: vaddpd <a4b3=%ymm15,<E1=%ymm10,>E1=%ymm10
# bytes: 5 uops: 1
vaddpd %ymm15,%ymm10,%ymm10
# block pos: 3840 3872 uops: 6

# qhasm:                                 4x a4b4 = approx 127a4 * C4
# asm 1: vmulpd <127a4=reg256#15,<C4=reg256#4,>a4b4=reg256#16
# asm 2: vmulpd <127a4=%ymm14,<C4=%ymm3,>a4b4=%ymm15
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm3,%ymm15

# qhasm:                                 4x E2 approx+= a4b4
# asm 1: vaddpd <a4b4=reg256#16,<E2=reg256#12,>E2=reg256#12
# asm 2: vaddpd <a4b4=%ymm15,<E2=%ymm11,>E2=%ymm11
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm11,%ymm11

# qhasm:                               4x a4b5 = approx 127a4 * C5
# asm 1: vmulpd <127a4=reg256#15,<C5=reg256#6,>a4b5=reg256#15
# asm 2: vmulpd <127a4=%ymm14,<C5=%ymm5,>a4b5=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm5,%ymm14

# qhasm:                               4x E3 approx+= a4b5
# asm 1: vaddpd <a4b5=reg256#15,<E3=reg256#13,>E3=reg256#13
# asm 2: vaddpd <a4b5=%ymm14,<E3=%ymm12,>E3=%ymm12
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm12,%ymm12
...
# asm 1: vmulpd <a4=reg256#15,<C0=reg256#2,>a4b0=reg256#16
# asm 2: vmulpd <a4=%ymm14,<C0=%ymm1,>a4b0=%ymm15
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm1,%ymm15
# block pos: 3872 3904 uops: 6

# qhasm: 			    4x E4 approx+= a4b0
# asm 1: vaddpd <a4b0=reg256#16,<E4=reg256#14,>E4=reg256#14
# asm 2: vaddpd <a4b0=%ymm15,<E4=%ymm13,>E4=%ymm13
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm15,%ymm13,%ymm13

# qhasm:                           4x a4b1 = approx a4 * C1
# asm 1: vmulpd <a4=reg256#15,<C1=reg256#9,>a4b1=reg256#15
# asm 2: vmulpd <a4=%ymm14,<C1=%ymm8,>a4b1=%ymm14
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm8,%ymm14

# qhasm:                           4x E5 approx+= a4b1
# asm 1: vaddpd <a4b1=reg256#15,<E5=reg256#3,>E5=reg256#3
# asm 2: vaddpd <a4b1=%ymm14,<E5=%ymm2,>E5=%ymm2
# bytes: 5 uops: 1
vaddpd %ymm14,%ymm2,%ymm2

# qhasm:                             127a5 aligned= mem256[work3 - 128]
# asm 1: vmovapd   -128(<work3=int64#1),>127a5=reg256#15
# asm 2: vmovapd   -128(<work3=%rdi),>127a5=%ymm14
# bytes: 5 uops: 1
vmovapd   -128(%rdi),%ymm14

# qhasm:                                     4x a5b1 = approx 127a5 * C1
# asm 1: vmulpd <127a5=reg256#15,<C1=reg256#9,>a5b1=reg256#9
# asm 2: vmulpd <127a5=%ymm14,<C1=%ymm8,>a5b1=%ymm8
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm8,%ymm8

# qhasm:                                     4x E0 approx+= a5b1
# asm 1: vaddpd <a5b1=reg256#9,<E0=reg256#10,>E0=reg256#9
# asm 2: vaddpd <a5b1=%ymm8,<E0=%ymm9,>E0=%ymm8
# bytes: 5 uops: 1
vaddpd %ymm8,%ymm9,%ymm8
# block pos: 3904 3936 uops: 6

# qhasm:                                   4x a5b2 = approx 127a5 * C2
# asm 1: vmulpd <127a5=reg256#15,<C2=reg256#1,>a5b2=reg256#1
# asm 2: vmulpd <127a5=%ymm14,<C2=%ymm0,>a5b2=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm0,%ymm0

# qhasm:                                   4x E1 approx+= a5b2
# asm 1: vaddpd <a5b2=reg256#1,<E1=reg256#11,>E1=reg256#1
# asm 2: vaddpd <a5b2=%ymm0,<E1=%ymm10,>E1=%ymm0
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vmulpd <127a5=reg256#15,<C3=reg256#8,>a5b3=reg256#8
# asm 2: vmulpd <127a5=%ymm14,<C3=%ymm7,>a5b3=%ymm7
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm7,%ymm7

# qhasm:                                 4x E2 approx+= a5b3
# asm 1: vaddpd <a5b3=reg256#8,<E2=reg256#12,>E2=reg256#8
# asm 2: vaddpd <a5b3=%ymm7,<E2=%ymm11,>E2=%ymm7
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm7,%ymm11,%ymm7

# qhasm:                               4x a5b4 = approx 127a5 * C4
# asm 1: vmulpd <127a5=reg256#15,<C4=reg256#4,>a5b4=reg256#4
# asm 2: vmulpd <127a5=%ymm14,<C4=%ymm3,>a5b4=%ymm3
# bytes: 5 uops: 1
vmulpd %ymm14,%ymm3,%ymm3

# qhasm:                               4x E3 approx+= a5b4
# asm 1: vaddpd <a5b4=reg256#4,<E3=reg256#13,>E3=reg256#4
# asm 2: vaddpd <a5b4=%ymm3,<E3=%ymm12,>E3=%ymm3
# bytes: 5 uops: 1
.byte 0x3e
...
# asm 1: vmulpd <127a5=reg256#15,<C5=reg256#6,>a5b5=reg256#6
# asm 2: vmulpd <127a5=%ymm14,<C5=%ymm5,>a5b5=%ymm5
# bytes: 6 uops: 1
.byte 0x3e
vmulpd %ymm14,%ymm5,%ymm5

# qhasm:                             4x E4 approx+= a5b5
# asm 1: vaddpd <a5b5=reg256#6,<E4=reg256#14,>E4=reg256#6
# asm 2: vaddpd <a5b5=%ymm5,<E4=%ymm13,>E4=%ymm5
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm5,%ymm13,%ymm5

# qhasm:                           a5 aligned= mem256[work0 + 32]
# asm 1: vmovapd   32(<work0=int64#3),>a5=reg256#10
# asm 2: vmovapd   32(<work0=%rdx),>a5=%ymm9
# bytes: 5 uops: 1
vmovapd   32(%rdx),%ymm9

# qhasm:                           4x a5b0 = approx a5 * C0
# asm 1: vmulpd <a5=reg256#10,<C0=reg256#2,>a5b0=reg256#2
# asm 2: vmulpd <a5=%ymm9,<C0=%ymm1,>a5b0=%ymm1
# bytes: 5 uops: 1
vmulpd %ymm9,%ymm1,%ymm1

# qhasm: 			  4x E5 approx+= a5b0
# asm 1: vaddpd <a5b0=reg256#2,<E5=reg256#3,>E5=reg256#2
# asm 2: vaddpd <a5b0=%ymm1,<E5=%ymm2,>E5=%ymm1
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm1,%ymm2,%ymm1

# qhasm: 					    a22 aligned= mem256[const2 - 128]
# asm 1: vmovapd   -128(<const2=int64#9),>a22=reg256#3
# asm 2: vmovapd   -128(<const2=%r11),>a22=%ymm2
# bytes: 6 uops: 1
vmovapd   -128(%r11),%ymm2
# block pos: 3968 4000 uops: 6

# qhasm:                                             4x c0 = approx E0 + a22
# asm 1: vaddpd <E0=reg256#9,<a22=reg256#3,>c0=reg256#10
# asm 2: vaddpd <E0=%ymm8,<a22=%ymm2,>c0=%ymm9
# bytes: 6 uops: 1
.byte 0x3e
vaddpd %ymm8,%ymm2,%ymm9

# qhasm:                                             4x c0 approx-= a22
# asm 1: vsubpd <a22=reg256#3,<c0=reg256#10,>c0=reg256#3
# asm 2: vsubpd <a22=%ymm2,<c0=%ymm9,>c0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm2,%ymm9,%ymm2

# qhasm:                                             4x E1 approx+= c0
# asm 1: vaddpd <c0=reg256#3,<E1=reg256#1,>E1=reg256#1
# asm 2: vaddpd <c0=%ymm2,<E1=%ymm0,>E1=%ymm0
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm2,%ymm0,%ymm0

# qhasm:                                             a64 aligned= mem256[const2 - 64]
# asm 1: vmovapd   -64(<const2=int64#9),>a64=reg256#10
# asm 2: vmovapd   -64(<const2=%r11),>a64=%ymm9
# bytes: 6 uops: 1
vmovapd   -64(%r11),%ymm9

# qhasm:                                             4x c2 = approx E2 + a64
# asm 1: vaddpd <E2=reg256#8,<a64=reg256#10,>c2=reg256#11
# asm 2: vaddpd <E2=%ymm7,<a64=%ymm9,>c2=%ymm10
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm7,%ymm9,%ymm10

# qhasm:                                             4x c2 approx-= a64
# asm 1: vsubpd <a64=reg256#10,<c2=reg256#11,>c2=reg256#10
# asm 2: vsubpd <a64=%ymm9,<c2=%ymm10,>c2=%ymm9
# bytes: 5 uops: 1
vsubpd %ymm9,%ymm10,%ymm9
# block pos: 4000 4032 uops: 6

# qhasm:                                             4x E3 approx+= c2
# asm 1: vaddpd <c2=reg256#10,<E3=reg256#4,>E3=reg256#4
# asm 2: vaddpd <c2=%ymm9,<E3=%ymm3,>E3=%ymm3
# bytes: 6 uops: 1
.byte 0x3e
...
# asm 1: vaddpd <E4=reg256#6,<a106=reg256#11,>c4=reg256#12
# asm 2: vaddpd <E4=%ymm5,<a106=%ymm10,>c4=%ymm11
# bytes: 6 uops: 1
.byte 0x3e
.byte 0x3e
...
# asm 1: vsubpd <a106=reg256#11,<c4=reg256#12,>c4=reg256#11
# asm 2: vsubpd <a106=%ymm10,<c4=%ymm11,>c4=%ymm10
# bytes: 5 uops: 1
vsubpd %ymm10,%ymm11,%ymm10

# qhasm:                                             4x E5 approx+= c4
# asm 1: vaddpd <c4=reg256#11,<E5=reg256#2,>E5=reg256#2
# asm 2: vaddpd <c4=%ymm10,<E5=%ymm1,>E5=%ymm1
# bytes: 5 uops: 1
vaddpd %ymm10,%ymm1,%ymm1

# qhasm:                                             4x E0 approx-= c0
# asm 1: vsubpd <c0=reg256#3,<E0=reg256#9,>E0=reg256#3
# asm 2: vsubpd <c0=%ymm2,<E0=%ymm8,>E0=%ymm2
# bytes: 5 uops: 1
.byte 0x3e
vsubpd %ymm2,%ymm8,%ymm2
# block pos: 4032 4064 uops: 6

# qhasm:                                             4x E2 approx-= c2
# asm 1: vsubpd <c2=reg256#10,<E2=reg256#8,>E2=reg256#8
# asm 2: vsubpd <c2=%ymm9,<E2=%ymm7,>E2=%ymm7
# bytes: 5 uops: 1
vsubpd %ymm9,%ymm7,%ymm7

# qhasm:                                             4x E4 approx-= c4
# asm 1: vsubpd <c4=reg256#11,<E4=reg256#6,>E4=reg256#6
# asm 2: vsubpd <c4=%ymm10,<E4=%ymm5,>E4=%ymm5
# bytes: 5 uops: 1
...
# asm 1: vaddpd <E3=reg256#4,<a85=reg256#13,>c3=reg256#14
# asm 2: vaddpd <E3=%ymm3,<a85=%ymm12,>c3=%ymm13
# bytes: 4 uops: 1
...
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm13,%ymm12
# block pos: 4097 4129 uops: 6

# qhasm:                                             4x E4 approx+= c3
# asm 1: vaddpd <c3=reg256#13,<E4=reg256#6,>E4=reg256#6
# asm 2: vaddpd <c3=%ymm12,<E4=%ymm5,>E4=%ymm5
# bytes: 5 uops: 1
vaddpd %ymm12,%ymm5,%ymm5

# qhasm: 					    4x E3 approx-= c3
# asm 1: vsubpd <c3=reg256#13,<E3=reg256#4,>E3=reg256#4
# asm 2: vsubpd <c3=%ymm12,<E3=%ymm3,>E3=%ymm3
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm3,%ymm3

# qhasm:                                           4x c5 = approx E5 * mem256[const1 - 128]
# asm 1: vmulpd -128(<const1=int64#8),<E5=reg256#2,>c5=reg256#13
# asm 2: vmulpd -128(<const1=%r10),<E5=%ymm1,>c5=%ymm12
# bytes: 6 uops: 1
vmulpd -128(%r10),%ymm1,%ymm12
...
# asm 1: vaddpd <c5=reg256#13,<E0=reg256#3,>E0=reg256#3
# asm 2: vaddpd <c5=%ymm12,<E0=%ymm2,>E0=%ymm2
# bytes: 5 uops: 1
...
# bytes: 5 uops: 1
vmulpd 32(%rax),%ymm12,%ymm12
# block pos: 4129 4160 uops: 6

# qhasm:                                           4x E5 approx-= c5
# asm 1: vsubpd <c5=reg256#13,<E5=reg256#2,>E5=reg256#2
# asm 2: vsubpd <c5=%ymm12,<E5=%ymm1,>E5=%ymm1
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm1,%ymm1

# qhasm:                                           4x c1 = approx E1 * mem256[const0 + 96]
# asm 1: vmulpd 96(<const0=int64#7),<E1=reg256#1,>c1=reg256#13
# asm 2: vmulpd 96(<const0=%rax),<E1=%ymm0,>c1=%ymm12
# bytes: 5 uops: 1
vmulpd 96(%rax),%ymm0,%ymm12

# qhasm:                                           4x c1 = round(c1)
# asm 1: vroundpd $8,<c1=reg256#13,>c1=reg256#13
# asm 2: vroundpd $8,<c1=%ymm12,>c1=%ymm12
# bytes: 6 uops: 1
vroundpd $8,%ymm12,%ymm12

# qhasm:                                           4x c1 approx*= mem256[const0 - 96]
# asm 1: vmulpd -96(<const0=int64#7),<c1=reg256#13,>c1=reg256#13
# asm 2: vmulpd -96(<const0=%rax),<c1=%ymm12,>c1=%ymm12
# bytes: 5 uops: 1
vmulpd -96(%rax),%ymm12,%ymm12

# qhasm:                                           4x E2 approx+= c1
# asm 1: vaddpd <c1=reg256#13,<E2=reg256#8,>E2=reg256#8
# asm 2: vaddpd <c1=%ymm12,<E2=%ymm7,>E2=%ymm7
# bytes: 5 uops: 1
vaddpd %ymm12,%ymm7,%ymm7

# qhasm:                                           4x E1 approx-= c1
# asm 1: vsubpd <c1=reg256#13,<E1=reg256#1,>E1=reg256#13
# asm 2: vsubpd <c1=%ymm12,<E1=%ymm0,>E1=%ymm12
# bytes: 5 uops: 1
vsubpd %ymm12,%ymm0,%ymm12
# block pos: 4160 4192 uops: 6

# qhasm:                                           4x E4 approx+= E5
# asm 1: vaddpd <E5=reg256#2,<E4=reg256#6,>E4=reg256#1
# asm 2: vaddpd <E5=%ymm1,<E4=%ymm5,>E4=%ymm0
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm1,%ymm5,%ymm0

# qhasm:                                           4x E2 approx+= E3
# asm 1: vaddpd <E3=reg256#4,<E2=reg256#8,>E2=reg256#2
# asm 2: vaddpd <E3=%ymm3,<E2=%ymm7,>E2=%ymm1
# bytes: 5 uops: 1
.byte 0x3e
vaddpd %ymm3,%ymm7,%ymm1

# qhasm:                                           4x E0 approx+= E1
# asm 1: vaddpd <E1=reg256#13,<E0=reg256#3,>E0=reg256#3
# asm 2: vaddpd <E1=%ymm12,<E0=%ymm2,>E0=%ymm2
# bytes: 5 uops: 1
vaddpd %ymm12,%ymm2,%ymm2
