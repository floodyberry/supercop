/* ==========   Reference Implementation of ELmD(6,0,1) ============= */
...
#define rd 6 // Denotes the no. of rounds of 1st layer AES encryption. 
...
/* ===================   ELmD(6,0,1) Authenticated Encryption Function =================== */
...
{
	u8 param[]={0x06,0,0,0x01,0x80,0,0,0}; 
...
/* ===================   ELmD(6,0,1) Verified Decryption Function =================== */
...
)
{
	...
	*mlen = clen - 24; 
	...
	/* ==========  Process checksum block  ============= */
	Is_final = 1;
	process_block(Delta_1, Delta_2, result, CS, W, 1, ENCRYPT, Is_final, MESSAGE); /* 2nd result was CS */
