...
@ crypto_aead/scream12v2/neon/tae.c -mcpu=cortex-a15 -mtune=cortex-a15
@ -mfpu=neon -mfloat-abi=hard -mthumb -mtls-dialect=gnu
@ -auxbase-strip crypto_aead/scream12v2/neon/tae.s -g -O3 -Wall -Wextra
...
crypto_aead_encrypt:
.LFB1882:
	.file 1 "crypto_aead/scream12v2/neon/tae.c"
	.loc 1 14 0
	.cfi_startproc
...
.LVL5:
	...
	ldrd	r0, [r8]	@, adlen
	.loc 1 20 0
	add	r5, r7, r4, lsl #4	@, checksum, tmp651, tmp405,
.LVL6:
.LBB16:
	.loc 1 26 0
	add	r4, sp, #608	@ tmp654,,
.LBE16:
	.loc 1 24 0
	orrs	r1, r0, r1	@,
	bne	.L104	@,
...
.LVL23:
	...
	bl	memcpy	@
.LVL24:
	ldr	sl, [sp, #1928]	@ prephitmp.49, mlen
	.loc 1 72 0
	str	r7, [sp, #56]	@ tmp651, %sfp
...
.LVL57:
	add	r0, r7, ip	@, tmp651, prephitmp.51
	add	r6, sp, #64	@ tmp655,,
.LVL58:
	ldr	lr, [sp, #1928]	@, mlen
	str	r0, [sp, #56]	@, %sfp
...
.Letext0:
	...
	.file 5 "crypto_aead/scream12v2/neon/tae.h"
...
.LASF55:
	.ascii	"crypto_aead/scream12v2/neon/tae.c\000"
.LASF32:
	.ascii	"mlen\000"
.LASF59:
	.ascii	"vst1q_u8\000"
