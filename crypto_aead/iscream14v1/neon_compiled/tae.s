...
@ crypto_aead/iscream14v1/neon/tae.c -mcpu=cortex-a15 -mtune=cortex-a15
@ -mfpu=neon -mfloat-abi=hard -mthumb -mtls-dialect=gnu
@ -auxbase-strip crypto_aead/iscream14v1/neon/tae.s -g -O3 -Wall -Wextra
...
crypto_aead_encrypt:
.LFB1882:
	.file 1 "crypto_aead/iscream14v1/neon/tae.c"
	.loc 1 16 0
	.cfi_startproc
...
.LVL5:
	...
	add	r5, r6, r4, lsl #4	@, checksum, tmp721, tmp430,
.LVL6:
.LBB16:
	.loc 1 28 0
	add	r4, sp, #608	@ tmp723,,
.LBE16:
	.loc 1 26 0
	orrs	r1, r2, r3	@,
	bne	.L186	@,
...
.Letext0:
	...
	.file 5 "crypto_aead/iscream14v1/neon/tae.h"
...
.LASF58:
	.ascii	"crypto_aead/iscream14v1/neon/tae.c\000"
.LASF61:
	.ascii	"vld1q_u8\000"
.LASF17:
