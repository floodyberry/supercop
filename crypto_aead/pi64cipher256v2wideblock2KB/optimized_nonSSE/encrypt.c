// Lightly optimized non-SSE version of the algorithm with wide block (N=128)
...
// bitrate is 2KB, capacity is 2KB -> state of the permutation function is 2048B long
...
#define RATE 2048     // Rate of the Internal State in Bytes 
#define W 8	       	  // Length of the binary words in bytes
#define N 128         // Number of chunks of the Internal State
