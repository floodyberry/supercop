// Lightly optimized non-SSE version of the algorithm with wide block (N=512)
...
// bitrate is 8KB, capacity is 8KB -> state of the permutation function is 16386B long
...
#define RATE 8192     // Rate of the Internal State in Bytes 
#define W 8	       	  // Length of the binary words in bytes
#define N 512         // Number of chunks of the Internal State
