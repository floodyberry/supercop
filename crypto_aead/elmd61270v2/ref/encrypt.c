/* ==========   Reference Implementation of ELmD(6,127,0) ============= */
...
/* ===================   ELmD(6,127,0) Authenticated Encryption Function =================== */
...
{
	u8 param[]={0x06,0,0x7f,0x80,0x80,0,0,0}; 
...
/* ===================   ELmD(6,127,0) Verified Decryption Function =================== */
