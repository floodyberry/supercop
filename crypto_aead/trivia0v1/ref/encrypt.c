/* PROGRAM FOR TriviA0v1, WHERE THE CIPHERTEXT DOES NOT INCLUDE ANY INTERMEDIATE TAG */
...
#define CONST_alpha_32 0x00400007              // The primitive polynomial in GF(2^32) 
#define CONST_beta_64 0x000000000000001B       // The primitive polynomial in GF(2^64)
#define PROC_CHECKSUM 1                        // Indicates process Checksum block.
...
#define CHUNK_SIZE 0x40000000		       // Indicates process checksum after 2^30 blocks(for TriviA-0 version)
#define MAX_IT 0x08000000                      // Intermediate Tag (if any) upto 2^27 blocks (2^30 bytes)
//#define CHUNK_SIZE 0x00000080		       // Indicates process checksum after 128 blocks(for TriviA-128 version) 

/* Will be used For TriviA-0 version */
#define CHUNK_SIZE_MSG 0x40000000              // Process atmost 2^30 blocks
#define IT 0   				       // Indicates no intermediate Tag (ITag)
#define param 0x0000000000000000	       // Fixed value of param	 
...
#define param 0x00800000                       // Fixed value of param
*/
