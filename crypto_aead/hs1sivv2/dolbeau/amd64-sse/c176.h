...
#define VEC4_QUARTERROUND(a,b,c,d) VEC4_QUARTERROUND_SHUFFLE(a,b,c,d)
  ...
  __m128i t_15;
    ...
    in12 = x[12];
    /* t_12 = _mm_broadcastd_epi32(_mm_cvtsi32_si128(in12)); */
...
#define ONEQUAD_TRANSPOSE_NOXOR_LAST(a,b,c,d)                                \
    {                                                                   \
      x_##a = _mm_add_epi32(x_##a, orig##a);                            \
      x_##b = _mm_add_epi32(x_##b, orig##b);                            \
      x_##c = _mm_add_epi32(x_##c, orig##c);                            \
    ...
    out+=16;
    ONEQUAD_TRANSPOSE_NOXOR_LAST(12,13,14,15);
    out-=48;
    
#undef ONEQUAD_TRANSPOSE_NOXOR
#undef ONEQUAD_TRANSPOSE_NOXOR_LAST
