/* ==========   Reference Implementation of ELmD(10,0,1) ============= */
...
#define rd 10 // Denotes the no. of rounds of AES encryption. 
...
/* ===================   ELmD(10,0,1) Authenticated Encryption Function =================== */
...
{
	u8 param[]={0x0a,0,0,0x01,0x80,0,0,0}; 
...
/* ===================   ELmD(10,0,1) Verified Decryption Function =================== */
