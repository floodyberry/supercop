/* ==========   Reference Implementation of ELmD(10,0,0) ============= */
...
/* ===================   ELmD(10,0,0) Authenticated Encryption Function =================== */
...
{
	u8 param[]={0x0a,0,0,0,0x80,0,0,0}; 
...
/* ===================   ELmD(10,0,0) Verified Decryption Function =================== */
