...
// Current version : $Date: 2016/02/01 13:09:43 $
//
...
/* custom version of chacha/20rnds generating 368 bytes, with no input message to XOR in */
...
static inline void hs1siv_chacha256(void *out, const unsigned outbytes, const unsigned char *iv, const void *user_key)
{
    ...
    /* BEWARE: this assume sizeof(hs1siv_ctx_t) == 368 */
...
#define ALL3HASH(s) ALL3HASH_SEQ(s)
...
#define ALL3HASHPOLYONLY(s)                     \
    ...
    for ( ; inbytes >= HS1_SIV_NH_LEN*4; inbytes -= HS1_SIV_NH_LEN*4, in += HS1_SIV_NH_LEN) {
      ...
      ALIGN32 uint64_t ia2[4][2];
      ALIGN32 uint64_t ia3[4][2];

          __m512i kv0  = _mm512_loadu_si512((const __m512i*)(nhkey+ 0)); // 1
          __m512i kv4  = _mm512_loadu_si512((const __m512i*)(nhkey+ 4)); // 1
          __m512i kv8  = _mm512_loadu_si512((const __m512i*)(nhkey+ 8)); // 1, 2
          __m512i kv12 = _mm512_loadu_si512((const __m512i*)(nhkey+12)); // 1, 2
          __m512i kv16 = _mm512_loadu_si512((const __m512i*)(nhkey+16)); // 2, 3
          __m512i kv20 = _mm512_loadu_si512((const __m512i*)(nhkey+20)); // 2, 3
          //__m512i kv24 = _mm512_loadu_si512((const __m512i*)(nhkey+24)); // 3
          //__m512i kv28 = _mm512_loadu_si512((const __m512i*)(nhkey+28)); // 3;
    ...
    if (inbytes != 0) {
        ...
        while (inbytes >= 16) {
          ...
          __m256i kv16 = _mm256_loadu_si256((const __m256i*)(nhkey+i+16));
          __m256i av0  = _mm256_add_epi32(inv0, kv0); /* A, B, C, D, E, F, G, H */
          __m256i av8  = _mm256_add_epi32(inv0, kv8);
          __m256i av16 = _mm256_add_epi32(inv0, kv16);
          ...
          __m256i av16lo64 = _mm256_unpacklo_epi32(av16, _mm256_setzero_si256());
          __m256i av16hi64 = _mm256_unpackhi_epi32(av16, _mm256_setzero_si256());
          __m256i p1 = _mm256_mul_epu32(av0lo64, av0hi64);
          __m256i p2 = _mm256_mul_epu32(av8lo64, av8hi64);
          __m256i p3 = _mm256_mul_epu32(av16lo64, av16hi64);
          ...
          a0_2 += ia[0]+ia[1];
          a1_2 += ia[2]+ia[3];
          _mm256_store_si256((__m256i*)ia, p3);
          a0_3 += ia[0]+ia[1];
          a1_3 += ia[2]+ia[3];
