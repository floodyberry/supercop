...
// Current version : $Date: 2016/01/30 18:27:18 $
//
...
#define ALL3HASHPOLYONLY(s)                     \
    ...
    for ( ; inbytes >= HS1_SIV_NH_LEN; inbytes -= HS1_SIV_NH_LEN, in += HS1_SIV_NH_LEN/4) {
      ...
      ALIGN32 uint64_t ia1[4];
        ...
        // assume HS1_SIV_NH_LEN == 64 -> 2 iterations -> full unroll, less scalar reduction
          ...
          __m128i kv16l = kv12h; // 2, 3
          __m128i kv16h = _mm_loadu_si128((const __m128i*)(nhkey+20)); // 2, 3
          __m128i kv20l = kv16h; // 2, 3
          __m128i kv20h = _mm_loadu_si128((const __m128i*)(nhkey+24)); // 2, 3
          __m128i kv24l = kv20h; // 3
          __m128i kv24h = _mm_loadu_si128((const __m128i*)(nhkey+28)); // 3
          __m128i kv28l = kv24h; // 3
          __m128i kv28h = _mm_loadu_si128((const __m128i*)(nhkey+32)); // 3
    ...
    if (inbytes != 0) {
        ...
        while (inbytes >= 16) {
          ...
          __m128i kv16l = _mm_loadu_si128((const __m128i*)(nhkey+i+16));
          __m128i kv16h = _mm_loadu_si128((const __m128i*)(nhkey+i+20));
          ...
          __m128i av16l = _mm_add_epi32(inv0, kv16l);
          __m128i av16h = _mm_add_epi32(inv0, kv16h);
          ...
          __m128i av16lo64l = _mm_unpacklo_epi32(av16l, _mm_setzero_si128());
          __m128i av16lo64h = _mm_unpacklo_epi32(av16h, _mm_setzero_si128());
          __m128i av16hi64l = _mm_unpackhi_epi32(av16l, _mm_setzero_si128());
          __m128i av16hi64h = _mm_unpackhi_epi32(av16h, _mm_setzero_si128());
          ...
          __m128i p3l = _mm_mul_epu32(av16lo64l, av16hi64l);
          __m128i p3h = _mm_mul_epu32(av16lo64h, av16hi64h);
          ...
          a0_2 += ia[0]+ia[1];
          a1_2 += ia[2]+ia[3];
          _mm_store_si128((__m128i*)(ia+0), p3l);
          _mm_store_si128((__m128i*)(ia+2), p3h);
          a0_3 += ia[0]+ia[1];
          a1_3 += ia[2]+ia[3];
