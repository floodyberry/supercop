...
#define SK_BYTES	crypto_dh_curve2251_relic_amd64_avx_SECRETKEYBYTES
#define PK_BYTES	crypto_dh_curve2251_relic_amd64_avx_PUBLICKEYBYTES
#define S_BYTES		crypto_dh_curve2251_relic_amd64_avx_BYTES
