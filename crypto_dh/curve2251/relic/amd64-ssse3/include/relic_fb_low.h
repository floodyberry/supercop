 ...
 *
 * @version $Id: relic_fb_low.h,v 1.1 2011/08/12 19:27:16 diego Exp $
 * @ingroup fb
 */
...
/**
 * Adds two double-precision digit vectors with embedded modular reduction.
 *
 * @param[out] c			- the result.
 * @param[in] a				- the first digit vector to add.
 * @param[in] b				- the second digit vector to add.
 */
void fb_add2_low(dig_t *c, dig_t *a, dig_t *b);
