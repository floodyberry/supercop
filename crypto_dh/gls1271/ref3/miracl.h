...
#define MR_STR_SZ 5
#define MR_WIN_SZ 4
#define MR_STR_SZ_2 3
#define MR_WIN_SZ_2 3
#else
#define MR_STR_SZ 11
#define MR_WIN_SZ 5
#define MR_STR_SZ_2 5
#define MR_WIN_SZ_2 4
#endif

/* max sizes for precomputed date for ecn2 points */

/* for a window size of 6? 
#define MR_STR_SZ_2P 41
#define MR_WIN_SZ_2P 6
*/

#define MR_STR_SZ_2P 11
#define MR_WIN_SZ_2P 5


/* If multi-addition is of m points, and s precomputed values are required, this is max of m*s (=4.11?) */
#define MR_MAX_M_T_S 44
...
extern void ecn2_get(ecn2 *,zzn2 *,zzn2 *,zzn2 *);
extern void ecn2_getxy(ecn2 *,zzn2 *,zzn2 *);
extern void ecn2_getx(ecn2 *,zzn2 *);
extern void ecn2_getz(ecn2 *,zzn2 *);
...
extern int ecn2_mul4_gls_v(_MIPT_ big *,ecn2 *,big *,ecn2 *,zzn2 *,ecn2 *);
...
extern int ecn2_mul2(_MIPT_ big,ecn2 *,big,ecn2 *,ecn2 *);
#ifndef MR_STATIC
