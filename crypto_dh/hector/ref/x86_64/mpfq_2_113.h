#ifndef SHIP64_MPFQ_2_113_H_
#define SHIP64_MPFQ_2_113_H_
...
int mpfq_2_113_inv(mpfq_2_113_field_ptr K UNUSED_VARIABLE, mpfq_2_113_dst_elt r, mpfq_2_113_src_elt s)
{
	...
	for(d = ib - ia ; ; ) {
	        if (d == 0) {
	                // dump_poly("a",128,64,a);
	                // dump_poly("b",128,64,b);
	                // dump_poly("u",128,64,u);
	                // dump_poly("v",128,64,v);
