...
/* multisquaring */
/* multi-squaring table lookup */
#define low_msq_stp(src,a64,b64,c64,d64,ids,idg,mtx)\
    idg = src[ids]<<1;\
    a64 = mtx[idg];\
    b64 = mtx[idg+1];\
    c64 = c64 ^ a64;\
...
/* [F_q  ] multi-squaring 015 */
void low_msq_015(__m128i *re_0, __m128i op00) {
    /* var */
    uint8_t ba[16];
    uint64_t t00, t01, ac0, ac1, idx;
    ...
    low_msq_stp(ba,t00,t01,ac0,ac1,1,idx,mtx_msq_015_001);
    low_msq_stp(ba,t00,t01,ac0,ac1,2,idx,mtx_msq_015_002);
    low_msq_stp(ba,t00,t01,ac0,ac1,3,idx,mtx_msq_015_003);

    low_msq_stp(ba,t00,t01,ac0,ac1,4,idx,mtx_msq_015_004);
    low_msq_stp(ba,t00,t01,ac0,ac1,5,idx,mtx_msq_015_005);
    low_msq_stp(ba,t00,t01,ac0,ac1,6,idx,mtx_msq_015_006);
    low_msq_stp(ba,t00,t01,ac0,ac1,7,idx,mtx_msq_015_007);

    low_msq_stp(ba,t00,t01,ac0,ac1,8,idx,mtx_msq_015_008);
    low_msq_stp(ba,t00,t01,ac0,ac1,9,idx,mtx_msq_015_009);
    low_msq_stp(ba,t00,t01,ac0,ac1,10,idx,mtx_msq_015_010);
    low_msq_stp(ba,t00,t01,ac0,ac1,11,idx,mtx_msq_015_011);

    low_msq_stp(ba,t00,t01,ac0,ac1,12,idx,mtx_msq_015_012);
    low_msq_stp(ba,t00,t01,ac0,ac1,13,idx,mtx_msq_015_013);
    low_msq_stp(ba,t00,t01,ac0,ac1,14,idx,mtx_msq_015_014);
    low_msq_stp(ba,t00,t01,ac0,ac1,15,idx,mtx_msq_015_015);

    /* result from regular to SSE register */
    *re_0 = _mm_set_epi64x(ac1, ac0);

    /* end */
    return;
}

/* [F_q  ] multi-squaring 030 */
void low_msq_030(__m128i *re_0, __m128i op00) {
    /* var */
    uint8_t ba[16];
    uint64_t t00, t01, ac0, ac1, idx;
    ...
    low_msq_stp(ba,t00,t01,ac0,ac1,1,idx,mtx_msq_030_001);
    low_msq_stp(ba,t00,t01,ac0,ac1,2,idx,mtx_msq_030_002);
    low_msq_stp(ba,t00,t01,ac0,ac1,3,idx,mtx_msq_030_003);

    low_msq_stp(ba,t00,t01,ac0,ac1,4,idx,mtx_msq_030_004);
    low_msq_stp(ba,t00,t01,ac0,ac1,5,idx,mtx_msq_030_005);
    low_msq_stp(ba,t00,t01,ac0,ac1,6,idx,mtx_msq_030_006);
    low_msq_stp(ba,t00,t01,ac0,ac1,7,idx,mtx_msq_030_007);

    low_msq_stp(ba,t00,t01,ac0,ac1,8,idx,mtx_msq_030_008);
    low_msq_stp(ba,t00,t01,ac0,ac1,9,idx,mtx_msq_030_009);
    low_msq_stp(ba,t00,t01,ac0,ac1,10,idx,mtx_msq_030_010);
    low_msq_stp(ba,t00,t01,ac0,ac1,11,idx,mtx_msq_030_011);

    low_msq_stp(ba,t00,t01,ac0,ac1,12,idx,mtx_msq_030_012);
    low_msq_stp(ba,t00,t01,ac0,ac1,13,idx,mtx_msq_030_013);
    low_msq_stp(ba,t00,t01,ac0,ac1,14,idx,mtx_msq_030_014);
    low_msq_stp(ba,t00,t01,ac0,ac1,15,idx,mtx_msq_030_015);
...
/* [F_q  ] multi-squaring 063 */
void low_msq_063(__m128i *re_0, __m128i op00) {
    /* var */
    uint8_t ba[16];
    uint64_t t00, t01, ac0, ac1, idx;
    ...
    low_msq_stp(ba,t00,t01,ac0,ac1,1,idx,mtx_msq_063_001);
    low_msq_stp(ba,t00,t01,ac0,ac1,2,idx,mtx_msq_063_002);
    low_msq_stp(ba,t00,t01,ac0,ac1,3,idx,mtx_msq_063_003);

    low_msq_stp(ba,t00,t01,ac0,ac1,4,idx,mtx_msq_063_004);
    low_msq_stp(ba,t00,t01,ac0,ac1,5,idx,mtx_msq_063_005);
    low_msq_stp(ba,t00,t01,ac0,ac1,6,idx,mtx_msq_063_006);
    low_msq_stp(ba,t00,t01,ac0,ac1,7,idx,mtx_msq_063_007);

    low_msq_stp(ba,t00,t01,ac0,ac1,8,idx,mtx_msq_063_008);
    low_msq_stp(ba,t00,t01,ac0,ac1,9,idx,mtx_msq_063_009);
    low_msq_stp(ba,t00,t01,ac0,ac1,10,idx,mtx_msq_063_010);
    low_msq_stp(ba,t00,t01,ac0,ac1,11,idx,mtx_msq_063_011);

    low_msq_stp(ba,t00,t01,ac0,ac1,12,idx,mtx_msq_063_012);
    low_msq_stp(ba,t00,t01,ac0,ac1,13,idx,mtx_msq_063_013);
    low_msq_stp(ba,t00,t01,ac0,ac1,14,idx,mtx_msq_063_014);
    low_msq_stp(ba,t00,t01,ac0,ac1,15,idx,mtx_msq_063_015);
...
void low_inv_bas(__m128i *re_0, __m128i op00) {
    ...
    low_msq_015(&a01, a00); /* 015 > 030 */
    low_mul_bas(&a00, a01, a00);

    low_msq_030(&a01, a00); /* 030 > 060 */
    low_mul_bas(&a00, a01, a00);

    low_sqr_003_bas(&a01, a00); /* 060 > 063 */
    low_mul_bas(&a00, a01, a03);

    low_msq_063(&a01, a00); /* 063 > 126 */
    low_mul_bas(&a00, a01, a00);
